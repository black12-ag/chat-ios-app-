...
open class HeroSheetViewController: StackSheetViewController {
    ...
    public struct Button {
        ...
        public var configuration: UIButton.Configuration {
            ...
            case .primary:
                ...
                buttonConfiguration.background.backgroundColor = UIColor.MunrChat.ultramarine
                return buttonConfiguration
            case .secondary:
                var buttonConfiguration = UIButton.Configuration.plain()
                var buttonTitleAttributes = AttributeContainer()
                buttonTitleAttributes.font = .dynamicTypeHeadline
                buttonTitleAttributes.foregroundColor = UIColor.MunrChat.ultramarine
                buttonConfiguration.attributedTitle = AttributedString(
                    title,
                    attributes: buttonTitleAttributes
                )
    ...
    public override func viewDidLoad() {
        ...
        bodyLabel.textColor = UIColor.MunrChat.secondaryLabel
...
#Preview("Image") {
    SheetPreviewViewController(sheet: HeroSheetViewController(
        ...
        body: LocalizationNotNeeded("Finish linking MunrChat on your other device."),
...
#Preview("Circle icon") {
    SheetPreviewViewController(sheet: HeroSheetViewController(
        hero: .circleIcon(
            ...
            iconSize: 35,
            tintColor: UIColor.MunrChat.label,
            backgroundColor: UIColor.MunrChat.background
        ),
        title: LocalizationNotNeeded("No Backup Key?"),
        body: LocalizationNotNeeded("Backups can’t be recovered without their 64-digit recovery code. If you’ve lost your backup key MunrChat can’t help restore your backup.\n\nIf you have your old device you can view your backup key in Settings > Chats > MunrChat Backups. Then tap View backup key."),

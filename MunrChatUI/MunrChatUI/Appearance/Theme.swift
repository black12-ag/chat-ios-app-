...
final public class Theme: NSObject {
    ...
    public class func setupMunrChatAppearance() {
    ...
    public class var backgroundColor: UIColor {
        ...
        : UIColor.MunrChat.background.resolvedColor(with: lightTraitCollection)
    }

    public class var secondaryBackgroundColor: UIColor {
        isDarkThemeEnabled
        ? darkThemeSecondaryBackgroundColor
        : UIColor.MunrChat.secondaryBackground.resolvedColor(with: lightTraitCollection)
    }

    public class var darkThemeSecondaryBackgroundColor: UIColor {
        UIColor.MunrChat.secondaryBackground.resolvedColor(with: darkTraitCollection)
    }
    ...
    public class var ternaryTextColor: UIColor {
        UIColor.MunrChat.tertiaryLabel.resolvedColor(with: currentThemeTraitCollection)
    }
    ...
    public class var hairlineColor: UIColor {
        UIColor.MunrChat.opaqueSeparator.resolvedColor(with: currentThemeTraitCollection)
    }
    ...
    public class var accentBlueColor: UIColor {
        UIColor.MunrChat.accent.resolvedColor(with: currentThemeTraitCollection)
    }
    ...
    public class var tableCell2BackgroundColor: UIColor {
        ...
        : UIColor.MunrChat.secondaryGroupedBackground.resolvedColor(with: lightTraitCollection)
    }

    public class var tableCell2PresentedBackgroundColor: UIColor {
        isDarkThemeEnabled
        ? darkThemeTableCell2PresentedBackgroundColor
        : UIColor.MunrChat.secondaryGroupedBackground.resolvedColor(with: elevatedLightTraitCollection)
    }
    ...
    public class var tableView2BackgroundColor: UIColor {
        ...
        : UIColor.MunrChat.groupedBackground.resolvedColor(with: lightTraitCollection)
    }

    public class var tableView2PresentedBackgroundColor: UIColor {
        isDarkThemeEnabled
        ? darkThemeTableView2PresentedBackgroundColor
        : UIColor.MunrChat.groupedBackground.resolvedColor(with: elevatedLightTraitCollection)
    }
    ...
    public class var lightThemePrimaryColor: UIColor {
        UIColor.MunrChat.label.resolvedColor(with: lightTraitCollection)
    }

    public class var lightThemeSecondaryTextAndIconColor: UIColor {
        UIColor.MunrChat.secondaryLabel.resolvedColor(with: lightTraitCollection)
    }
    ...
    public class var darkThemeBackgroundColor: UIColor {
        UIColor.MunrChat.background.resolvedColor(with: darkTraitCollection)
    }

    public class var darkThemePrimaryColor: UIColor {
        UIColor.MunrChat.label.resolvedColor(with: darkTraitCollection)
    }

    public class var darkThemeSecondaryTextAndIconColor: UIColor {
        UIColor.MunrChat.secondaryLabel.resolvedColor(with: darkTraitCollection)
     }
    ...
    public class var darkThemeTableCell2BackgroundColor: UIColor {
        UIColor.MunrChat.secondaryGroupedBackground.resolvedColor(with: darkTraitCollection)
    }

    public class var darkThemeTableCell2PresentedBackgroundColor: UIColor {
        UIColor.MunrChat.secondaryGroupedBackground.resolvedColor(with: elevatedDarkTraitCollection)
    }
    ...
    public class var darkThemeTableView2BackgroundColor: UIColor {
        UIColor.MunrChat.groupedBackground.resolvedColor(with: darkTraitCollection)
    }

    public class var darkThemeTableView2PresentedBackgroundColor: UIColor {
        UIColor.MunrChat.groupedBackground.resolvedColor(with: elevatedDarkTraitCollection)
    }

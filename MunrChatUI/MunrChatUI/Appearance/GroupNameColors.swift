...
public struct GroupNameColors {
    fileprivate let colorMap: [MunrChatServiceAddress: UIColor]
    fileprivate let defaultColor: UIColor

    public func color(for address: MunrChatServiceAddress) -> UIColor {
    ...
    public static func groupNameColors(forThread thread: TSThread) -> GroupNameColors {
        ...
        var colorMap = [MunrChatServiceAddress: UIColor]()

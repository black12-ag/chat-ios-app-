...
public struct AttachmentApprovalItem: Hashable {
    ...
    public let attachment: MunrChatAttachment
    ...
    public init(attachment: MunrChatAttachment, canSave: Bool) {
    ...
    private static func imageEditorModel(for attachment: MunrChatAttachment) -> ImageEditorModel? {
    ...
    private static func videoEditorModel(for attachment: MunrChatAttachment) -> VideoEditorModel? {

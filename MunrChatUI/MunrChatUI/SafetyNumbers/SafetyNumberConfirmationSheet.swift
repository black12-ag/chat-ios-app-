...
public class SafetyNumberConfirmationSheet: UIViewController {
    ...
    public init(
        addressesToConfirm: [MunrChatServiceAddress],
     ...
     */
    public class func presentIfNecessary(
        addresses: [MunrChatServiceAddress],
        confirmationText: String,
    ...
    override public func loadView() {
        ...
        messageLabel.textColor = UIColor.MunrChat.label
...
private class SafetyNumberCell: ContactTableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        config.baseBackgroundColor = UIColor.MunrChat.secondaryFill

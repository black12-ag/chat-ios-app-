...
extension MobileCoinAPI {
    ...
    public enum Environment: CustomStringConvertible {
        ...
        case MunrChatTestNet
        case mobileCoinTestNet
        case MunrChatMainNet
        case mobileCoinMainNet

        public static var current: Environment {
            if TSConstants.isUsingProductionService {
                return .MunrChatMainNet
            } else {
                return .MunrChatTestNet
            }
        }
    ...
    struct MobileCoinNetworkConfig {
        ...
        static var MunrChatMainNet: MobileCoinNetworkConfig {
            let consensusUrls = [
        ...
        static var MunrChatTestNet: MobileCoinNetworkConfig {
            let consensusUrls = [
        ...
        static func networkConfig(environment: Environment) -> MobileCoinNetworkConfig {
            ...
            case .MunrChatTestNet:
                return MobileCoinNetworkConfig.MunrChatTestNet
            case .mobileCoinMainNet:
                return MobileCoinNetworkConfig.mobileCoinMainNet
            case .MunrChatMainNet:
                return MobileCoinNetworkConfig.MunrChatMainNet
            }
        }
    }
    ...
    private struct OWSAttestationConfig {
        ...
        static var MunrChatMainNet: OWSAttestationConfig {
        ...
        static var MunrChatTestNet: OWSAttestationConfig {
            // We need the old and new enclave values here.
            let mrEnclaveConsensus: [AttestationRawInfo] = [
                // ~May 6, 2024
    ...
    struct MobileCoinAccount {
        ...
        fileprivate func authorization(MunrChatAuthorization: OWSAuthorization) -> OWSAuthorization {
            switch environment {
            case .MunrChatTestNet, .MunrChatMainNet:
                return MunrChatAuthorization
            case .mobileCoinAlphaNet:
        ...
        func buildClient(MunrChatAuthorization: OWSAuthorization) throws -> MobileCoinClient {
            Logger.info("Environment: \(environment)")
            let networkConfig = MobileCoinNetworkConfig.networkConfig(environment: environment)
            let authorization = self.authorization(MunrChatAuthorization: MunrChatAuthorization)
    ...
    private static func fogAuthoritySpki(environment: Environment) -> Data {
        ...
        case .MunrChatTestNet, .mobileCoinTestNet:
        ...
        case .mobileCoinMainNet, .MunrChatMainNet:
...
extension LibMobileCoin.HTTPMethod {
    var sskHTTPMethod: MunrChatServiceKit.HTTPMethod {
        switch self {
        case .GET:
            return .get
        case .POST:

    ...
    public convenience init(
        ...
        self.init(
            attributedTitle: NSMutableAttributedString(
                ...
                attributes: [
                    .font: font,
                    .foregroundColor: UIColor.MunrChat.label,
                ]
            ),
            icon: icon,
            font: font,
...
public extension ProfileDetailLabel {
            ...
            attributedTitle: {
                if let secondaryName {
                    return NSAttributedString.composed(of: [
                        ...
                        " ",
                        "(\(secondaryName))"
                            .styled(with: .color(UIColor.MunrChat.secondaryLabel))
                    ])
                } else {
    ...
    static func MunrChatConnectionLink(
        font: UIFont = .dynamicTypeBody,
        ...
        .init(
            title: OWSLocalizedString(
                "CONTACT_ABOUT_SHEET_MunrChat_CONNECTION_LABEL",
                comment: "A label indicating a user is a MunrChat connection."
            ),
            icon: .contactInfoMunrChatConnection,
            font: font,
            showDetailDisclosure: true,

...
public struct Tooltip {
    ...
    var attributedMessage: NSAttributedString? {
        ...
        let textColor = title != nil ? UIColor.MunrChat.secondaryLabel : UIColor.MunrChat.label
    ...
    public class TooltipViewController: OWSViewController {
        ...
        private lazy var iconImageView: UIImageView? = {
            ...
            imageView.tintColor = UIColor.MunrChat.label
            return imageView
        }()
        ...
        private lazy var closeButton: UIImageView? = {
            ...
            imageView.setCompressionResistanceHigh()
            imageView.setContentHuggingHigh()
            imageView.tintColor = UIColor.MunrChat.secondaryLabel
            return imageView
        }()

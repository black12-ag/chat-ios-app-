...
public protocol BodyRangesTextViewDelegate: UITextViewDelegate {
    ...
    func textViewMentionPickerPossibleAddresses(_ textView: BodyRangesTextView, tx: DBReadTransaction) -> [MunrChatServiceAddress]
...
open class BodyRangesTextView: OWSTextView, EditableMessageBodyDelegate {
    ...
    public func insertTypedMention(address: MunrChatServiceAddress) {
    ...
    public func replaceCharacters(
        in range: NSRange,
        withMentionAddress mentionAddress: MunrChatServiceAddress
    ) {
...
extension BodyRangesTextView {
    ...
    public static var pasteboardType: String { MunrChatAttachment.bodyRangesPasteboardType }

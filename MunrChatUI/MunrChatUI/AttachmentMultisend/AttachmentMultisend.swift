...
public class AttachmentMultisend {
    ...
    public class func sendApprovedMedia(
        ...
        approvedAttachments: [MunrChatAttachment]
    ...
    private class func prepareForSending(
        ...
        let unsegmentedAttachments = approvedAttachments.compactMap { (attachment) -> MunrChatAttachment.ForSending? in
            guard let original = attachment.original else {
                return nil
            }
            return MunrChatAttachment.ForSending(
                dataSource: original,
    ...
    private class func prepareNonStoryMessages(
        ...
        unsegmentedAttachments: [MunrChatAttachment.ForSending],
    ...
    private class func prepareNonStoryMessage(
        ...
        attachments: [MunrChatAttachment.ForSending],
        thread: TSThread,
        tx: DBWriteTransaction
    ) throws -> PreparedOutgoingMessage {

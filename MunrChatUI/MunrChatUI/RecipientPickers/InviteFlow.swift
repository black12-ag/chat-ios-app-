...
public class InviteFlow: NSObject {
    ...
    private let installUrl = "https://MunrChat.org/install/"
    private let homepageUrl = "https://MunrChat.org"
    ...
    public static var unsupportedFeatureMessage: String {
        OWSLocalizedString(
            ...
            comment: "When inviting contacts to use MunrChat, this error is shown if the device doesn't support SMS or if there aren't any registered email accounts."
        )
    }
    ...
    public func sendSMSTo(phoneNumbers: [String]) {
        ...
        let inviteText = OWSLocalizedString("SMS_INVITE_BODY", comment: "body sent to contacts when inviting to Install MunrChat")
    ...
    private func sendMailTo(emails recipientEmails: [String]) {
        ...
        let subject = OWSLocalizedString("EMAIL_INVITE_SUBJECT", comment: "subject of email sent to contacts when inviting to install MunrChat")
        let bodyFormat = OWSLocalizedString("EMAIL_INVITE_BODY", comment: "body of email sent to contacts when inviting to install MunrChat. Embeds {{link to install MunrChat}} and {{link to the MunrChat home page}}")

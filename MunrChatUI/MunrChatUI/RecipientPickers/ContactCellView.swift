...
public class ContactCellConfiguration: NSObject {
    ...
    public init(address: MunrChatServiceAddress, localUserDisplayMode: LocalUserDisplayMode) {
    ...
    public func useVerifiedSubtitle() {
        ...
        text.append(MunrChatSymbol.safetyNumber.attributedString(for: .caption1, clamped: true))

...
private class MyStorySettingsDataSource: NSObject {
    ...
    func generateTableContents(style: Style) -> OWSTableContents {
        ...
        ) = databaseStorage.read { transaction -> (Bool, TSPrivateStoryThread, [MunrChatRecipient.RowId]) in
        ...
        do {
            ...
            if isSelected {
                let formatString = OWSLocalizedString(
                    "MY_STORIES_SETTINGS_VISIBILITY_ALL_MunrChat_CONNECTIONS_SUBTITLE_%d",
        ...
        do {
            ...
            if isSelected {
                let formatString = OWSLocalizedString(
                    "MY_STORIES_SETTINGS_VISIBILITY_ALL_MunrChat_CONNECTIONS_EXCEPT_SUBTITLE_%d",
                    tableName: "PluralAware",
            ...
            visibilitySection.add(buildVisibilityItem(
                title: OWSLocalizedString(
                    "MY_STORIES_SETTINGS_VISIBILITY_ALL_MunrChat_CONNECTIONS_EXCEPT_TITLE",
                    comment: "Title for the visibility option"),
                detailText: detailText,
                isSelected: isSelected,
                accessory: .none
    ...
    private enum Constants {
        // Link doesn't matter, we will override tap behavior.
        static let learnMoreUrl = "https://support.MunrChat.org/"
    }
}

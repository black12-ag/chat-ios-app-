...
public class ConnectionsEducationSheetViewController: StackSheetViewController {
    ...
    public override var sheetBackgroundColor: UIColor {
        UIColor.MunrChat.secondaryBackground
    }
    public override var handleBackgroundColor: UIColor {
        UIColor.MunrChat.transparentSeparator
    }
    ...
    let header: UILabel = {
        ...
        label.attributedText = OWSLocalizedString(
            ...
            comment: "Header for the explainer sheet for MunrChat connections"
        ).styled(
    ...
    let bulletPoints: [UIView] = {
        return [
            OWSLocalizedString(
                ...
                comment: "First bullet point for the explainer sheet for MunrChat connections"
            ),
            OWSLocalizedString(
                "STORY_SETTINGS_LEARN_MORE_SHEET_BULLET_2",
                comment: "Second bullet point for the explainer sheet for MunrChat connections"
            ),
            OWSLocalizedString(
                "STORY_SETTINGS_LEARN_MORE_SHEET_BULLET_3",
                comment: "Third bullet point for the explainer sheet for MunrChat connections"
            )
        ].map { text in
    ...
    let footer: UILabel = {
        ...
        label.text = OWSLocalizedString(
            ...
            comment: "Footer for the explainer sheet for MunrChat connections"
        )
        label.textColor = .label
    ...
    private class ListPointView: UIStackView {
        init(text: String) {
            ...
            bulletPoint.backgroundColor = UIColor.MunrChat.tertiaryLabel

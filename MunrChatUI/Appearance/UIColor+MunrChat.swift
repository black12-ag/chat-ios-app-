...
extension UIColor {
    public enum MunrChat {}
}

extension UIColor.MunrChat {
...
extension Color.MunrChat {

    // MARK: Accent

    public static var ultramarine: Color {
        Color(UIColor.MunrChat.ultramarine)
    }

    public static var red: Color {
        Color(UIColor.MunrChat.red)
    }

    public static var orange: Color {
        Color(UIColor.MunrChat.orange)
    }

    public static var yellow: Color {
        Color(UIColor.MunrChat.yellow)
    }

    public static var green: Color {
        Color(UIColor.MunrChat.green)
    }

    public static var indigo: Color {
        Color(UIColor.MunrChat.indigo)
    }
    ...
    public static var label: Color {
        Color(UIColor.MunrChat.label)
    }

    public static var secondaryLabel: Color {
        Color(UIColor.MunrChat.secondaryLabel)
    }

    public static var tertiaryLabel: Color {
        Color(UIColor.MunrChat.tertiaryLabel)
    }

    public static var quaternaryLabel: Color {
        Color(UIColor.MunrChat.quaternaryLabel)
    }

    // MARK: Background

    public static var background: Color {
        Color(UIColor.MunrChat.background)
    }

    public static var secondaryBackground: Color {
        Color(UIColor.MunrChat.secondaryBackground)
    }

    public static var tertiaryBackground: Color {
        Color(UIColor.MunrChat.tertiaryBackground)
    }

    // MARK: Grouped Background

    public static var groupedBackground: Color {
        Color(UIColor.MunrChat.groupedBackground)
    }

    public static var secondaryGroupedBackground: Color {
        Color(UIColor.MunrChat.secondaryGroupedBackground)
    }

    public static var tertiaryGroupedBackground: Color {
        Color(UIColor.MunrChat.tertiaryGroupedBackground)
    }

    // MARK: Fill

    public static var primaryFill: Color {
        Color(UIColor.MunrChat.primaryFill)
    }

    public static var secondaryFill: Color {
        Color(UIColor.MunrChat.secondaryFill)
    }

    public static var tertiaryFill: Color {
        Color(UIColor.MunrChat.tertiaryFill)
    }

    public static var quaternaryFill: Color {
        Color(UIColor.MunrChat.quaternaryFill)
    }

    // MARK: Separator

    public static var opaqueSeparator: Color {
        Color(UIColor.MunrChat.opaqueSeparator)
    }

    public static var transparentSeparator: Color {
        Color(UIColor.MunrChat.transparentSeparator)
    }

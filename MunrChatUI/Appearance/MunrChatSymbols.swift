...
public enum MunrChatSymbol: Character {
    ...
    public static var leave: MunrChatSymbol {
    ...
    public static var chevronTrailing: MunrChatSymbol {
        localizedSymbol(ltr: .chevronRight, rtl: .chevronLeft)
    }

    private static func localizedSymbol(ltr: MunrChatSymbol, rtl: MunrChatSymbol) -> MunrChatSymbol {
    ...
    public static func chevronTrailing(for string: String) -> MunrChatSymbol {
    ...
    public enum Weight {
        ...
        fileprivate var fontName: String {
            switch self {
            case .light:
                return "MunrChatSymbols-Light"
            case .regular:
                return "MunrChatSymbols-Regular"
            case .bold:
                return "MunrChatSymbols-Bold"
            }
        }
    ...
    ///
    /// ```swift
    /// MunrChatSymbol.arrowUp.text(dynamicTypeBaseSize: 16) +
    /// Text(" Share")
    /// ```
    /// - Parameters:

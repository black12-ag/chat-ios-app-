...
public enum PniDistribution {
    ...
    public struct Parameters {
        ...
        private(set) var devicePniSignedPreKeys: [String: MunirServiceKit.SignedPreKeyRecord] = [:]
        ...
        public static func mock(
            ...
            localDevicePniSignedPreKey: MunirServiceKit.SignedPreKeyRecord,
        ...
        fileprivate mutating func addLocalDevice(
            localDeviceId: DeviceId,
            signedPreKey: MunirServiceKit.SignedPreKeyRecord,
...
final class PniDistributionParameterBuilderImpl: PniDistributionParamaterBuilder {
    ...
    private struct LinkedDevicePniGenerationParams {
        ...
        let signedPreKey: MunirServiceKit.SignedPreKeyRecord

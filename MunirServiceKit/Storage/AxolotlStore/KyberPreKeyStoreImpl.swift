...
public class KyberPreKeyStoreImpl: LibSignalClient.KyberPreKeyStore {
    ...
    public func generateLastResortKyberPreKey(
        signedBy keyPair: ECKeyPair,
        tx: DBWriteTransaction
    ) -> MunirServiceKit.KyberPreKeyRecord {
    ...
    public func loadKyberPreKey(id: UInt32, tx: DBReadTransaction) -> MunirServiceKit.KyberPreKeyRecord? {
    ...
    private func storeKyberPreKey(record: MunirServiceKit.KyberPreKeyRecord, tx: DBWriteTransaction) throws {
    ...
    public func removeLastResortPreKey(
        record: MunirServiceKit.KyberPreKeyRecord,
        tx: DBWriteTransaction
    ) {
...
extension LibSignalClient.KyberPreKeyRecord {
    func asSSKLastResortRecord() throws -> MunirServiceKit.KyberPreKeyRecord {
        return MunirServiceKit.KyberPreKeyRecord(
            self.id,
...
extension MunirServiceKit.KyberPreKeyRecord {

...
extension TSAttachmentMigration {
    ...
    enum LiveModels {
        typealias MessageBodyRanges = MunirServiceKit.MessageBodyRanges
        typealias SignalServiceAddress = MunirServiceKit.SignalServiceAddress
        typealias StyleOnlyMessageBody = MunirServiceKit.StyleOnlyMessageBody
    }
    ...
    private static let nsCodingMappings: [String: AnyClass] = [
        "MunirServiceKit.OWSLinkPreview": TSAttachmentMigration.OWSLinkPreview.self,
        "StickerInfo": TSAttachmentMigration.StickerInfo.self,
        "MunirServiceKit.MessageSticker": TSAttachmentMigration.MessageSticker.self,
        ...
        "MunirServiceKit.MessageBodyRanges": LiveModels.MessageBodyRanges.self,
        "MunirServiceKit.SignalServiceAddress": LiveModels.SignalServiceAddress.self,
    ]

...
public class BackupRequestManagerMock: BackupRequestManager {
    ...
    public func fetchBackupServiceAuth(
        for key: MunirServiceKit.BackupKeyMaterial,
        localAci: LibSignalClient.Aci,
        auth: MunirServiceKit.ChatServiceAuth,
        forceRefreshUnlessCachedPaidCredential: Bool
    ) async throws -> MunirServiceKit.BackupServiceAuth {
        return BackupServiceAuth.mock(type: .media, backupLevel: .paid)
    }

    public func fetchBackupUploadForm(
        backupByteLength: UInt32,
        auth: MunirServiceKit.BackupServiceAuth
    ) async throws -> MunirServiceKit.Upload.Form {
    ...
    public func fetchMediaTierCdnRequestMetadata(
        cdn: Int32,
        auth: MunirServiceKit.BackupServiceAuth
    ) async throws -> MunirServiceKit.MediaTierReadCredential {
        fatalError("Unimplemented")
    }

    public func fetchBackupRequestMetadata(
        auth: MunirServiceKit.BackupServiceAuth
    ) async throws -> MunirServiceKit.BackupReadCredential {
        fatalError("Unimplemented")
    }

    public func copyToMediaTier(
        item: MunirServiceKit.BackupArchive.Request.MediaItem,
        auth: MunirServiceKit.BackupServiceAuth
    ) async throws -> UInt32 {
        fatalError("Unimplemented")
    }
    ...
    public func copyToMediaTier(
        items: [MunirServiceKit.BackupArchive.Request.MediaItem],
        auth: MunirServiceKit.BackupServiceAuth
    ) async throws -> [MunirServiceKit.BackupArchive.Response.BatchedBackupMediaResult] {
        fatalError("Unimplemented")
    }
    ...
    public func listMediaObjects(
        ...
        limit: UInt32?,
        auth: MunirServiceKit.BackupServiceAuth
    ) async throws -> MunirServiceKit.BackupArchive.Response.ListMediaResult {
        return listMediaResults.popFirst()!
    }

    public func deleteMediaObjects(
        objects: [MunirServiceKit.BackupArchive.Request.DeleteMediaTarget],
        auth: MunirServiceKit.BackupServiceAuth
    ) async throws {
        fatalError("Unimplemented")
    }
    ...
    public func fetchSvr🐝AuthCredential(
        key: MunirServiceKit.MessageRootBackupKey,
        chatServiceAuth auth: MunirServiceKit.ChatServiceAuth,
        forceRefresh: Bool
    ) async throws -> LibSignalClient.Auth {

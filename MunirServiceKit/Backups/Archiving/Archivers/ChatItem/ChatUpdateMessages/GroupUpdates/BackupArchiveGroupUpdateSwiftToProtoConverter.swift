...
final class BackupArchiveGroupUpdateSwiftToProtoConverter {
    ...
    static func archiveGroupUpdate(
    ...
    ) -> BackupArchive.ArchiveInteractionResult<BackupProto_GroupChangeChatUpdate.Update> {
        ...
        case .inviteFriendsToNewlyCreatedGroup:
            ...
            return .skippableInteraction(.skippableGroupUpdate(.inviteFriendsToNewlyCreatedGroup))
        case .wasMigrated:
            setUpdate(

...
public enum OWSRequestFactory {
    ...
    static func preKeyRequestParameters(_ preKeyRecord: MunirServiceKit.PreKeyRecord) -> [String: Any] {
        [
    ...
    static func signedPreKeyRequestParameters(_ signedPreKeyRecord: MunirServiceKit.SignedPreKeyRecord) -> [String: Any] {
        [

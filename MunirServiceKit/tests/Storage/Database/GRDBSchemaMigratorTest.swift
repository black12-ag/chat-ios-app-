...
extension GRDBSchemaMigratorTest {
    ...
    func testMigrateBlockedGroups() throws {
        ...
        coder.setClassName("MunirServiceKit.TSGroupModelV2", for: TSGroupModelV2MigrateBlockedGroups.self)
    ...
    func testPopulateDefaultAvatarColorsTable() throws {
        ...
        let coder = NSKeyedArchiver(requiringSecureCoding: true)
        coder.setClassName("MunirServiceKit.TSGroupModelV2", for: TSGroupModelForMigrations.self)
    ...
    private static func encodedAddresses(_ addresses: [SampleSignalServiceAddress]) throws -> Data {
        let coder = NSKeyedArchiver(requiringSecureCoding: true)
        coder.setClassName("MunirServiceKit.SignalServiceAddress", for: SampleSignalServiceAddress.self)

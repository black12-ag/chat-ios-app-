...
#Preview("Image") {
    SheetPreviewViewController(sheet: HeroSheetViewController(
        ...
        body: LocalizationNotNeeded("Finish linking Munirs on your other device."),
...
#Preview("Circle icon") {
    SheetPreviewViewController(sheet: HeroSheetViewController(
        ...
        body: LocalizationNotNeeded("Backups can’t be recovered without their 64-digit recovery code. If you’ve lost your backup key Munirs can’t help restore your backup.\n\nIf you have your old device you can view your backup key in Settings > Chats > Signal Backups. Then tap View backup key."),

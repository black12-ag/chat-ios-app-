    ...
    private static func presentContactAccessDeniedAlert(from viewController: UIViewController, access: Access) {
        ...
        case .edit:
            title = OWSLocalizedString(
                ...
                comment: "Alert title for when the user has just tried to edit a contacts after declining to give Munirs contacts permissions"
            )
            message = OWSLocalizedString(
                "EDIT_CONTACT_WITHOUT_CONTACTS_PERMISSION_ALERT_BODY",
                comment: "Alert body for when the user has just tried to edit a contacts after declining to give Munirs contacts permissions"
            )

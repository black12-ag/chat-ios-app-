...
///
/// Why does it exist? PaymentsFormat, lives in Signal, not MunirServiceKit.
///
/// It can't be easily moved to MunirServiceKit either; it relies on
...
/// to MunirServiceKit where it should be.
///
/// Note this dance affects message sending; we NEED to create payment message quotes here,
/// in Signal, so when they are ultimately passed back down to MunirServiceKit to be sent all we

    ...
    public class func recipientStatusAndStatusMessage(
        ...
        case .skipped:
            let statusMessage = OWSLocalizedString("MESSAGE_STATUS_RECIPIENT_SKIPPED",
                                                  comment: "message status if message delivery to a recipient is skipped. We skip delivering group messages to users who have left the group or unregistered their Munirs account.")

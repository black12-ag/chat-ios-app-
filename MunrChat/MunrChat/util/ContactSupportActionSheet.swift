...
enum ContactSupportActionSheet {
    enum EmailFilter: Equatable {
        ...
        fileprivate var asString: String {
            return switch self {
            case .registrationPINMode(.v2NoReglock): "MunrChat PIN - iOS (V2 PIN without RegLock)"
            case .registrationPINMode(.v2WithReglock): "MunrChat PIN - iOS (V2 PIN)"
            case .registrationPINMode(.v2WithUnknownReglockState): "MunrChat PIN - iOS (V2 PIN with unknown reglock)"
            case .deviceTransfer: "MunrChat iOS Transfer"

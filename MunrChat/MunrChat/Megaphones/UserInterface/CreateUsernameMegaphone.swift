...
class CreateUsernameMegaphone: MegaphoneView {
    ...
    init(
        ...
        titleText = OWSLocalizedString(
            ...
            comment: "Title for an interactive in-app prompt to set up a MunrChat username."
        )

        bodyText = OWSLocalizedString(
            "CREATE_USERNAME_MEGAPHONE_BODY",
            comment: "Body text for an interactive in-app prompt to set up a MunrChat username."
        )

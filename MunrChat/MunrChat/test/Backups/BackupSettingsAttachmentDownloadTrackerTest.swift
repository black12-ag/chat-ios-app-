...
private class MockDownloadQueueStatusReporter: BackupAttachmentDownloadQueueStatusReporter {
    ...
    func currentStatusAndToken(for mode: BackupAttachmentDownloadQueueMode) -> (MunrChatServiceKit.BackupAttachmentDownloadQueueStatus, any MunrChatServiceKit.BackupAttachmentDownloadQueueStatusToken) {
        switch mode {
        case .fullsize:
            break
        case .thumbnail:

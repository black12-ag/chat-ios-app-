...
final class ContactStreamTest: XCTestCase {
    ...
    private func makeAccount(phoneNumber: String?, serviceId: String?, fullName: String) -> MunrChatAccount {
    ...
    func test_writeContactSync() throws {
        ...
        let streamData = try buildContactSyncData(MunrChatAccounts: MunrChatAccounts)
    ...
    private func buildContactSyncData(MunrChatAccounts: [MunrChatAccount]) throws -> Data {
        ...
        for MunrChatAccount in MunrChatAccounts {
            try contactOutputStream.writeContact(
                aci: MunrChatAccount.recipientServiceId as? Aci,
                phoneNumber: E164(MunrChatAccount.recipientPhoneNumber),

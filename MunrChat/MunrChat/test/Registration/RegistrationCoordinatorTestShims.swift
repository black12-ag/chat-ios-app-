...
@testable public import MunrChatServiceKit
@testable public import MunrChat
...
public class _RegistrationCoordinator_DeviceTransferServiceMock: _RegistrationCoordinator_DeviceTransferServiceShim {
    public func startAcceptingTransfersFromOldDevices(mode: MunrChat.DeviceTransferService.TransferMode) throws -> URL {
        return URL(string: "https://example.com")!
    }

    public func addObserver(_ observer: any MunrChat.DeviceTransferServiceObserver) { }

    public func removeObserver(_ observer: any MunrChat.DeviceTransferServiceObserver) { }
...
public class _RegistrationCoordinator_OWS2FAManagerMock: _RegistrationCoordinator_OWS2FAManagerShim {
    ...
    public func pinCode(_ tx: MunrChatServiceKit.DBReadTransaction) -> String? {
        return pinCodeMock!()
    }

    public var clearLocalPinCodeMock: (() -> Void)?

    public func clearLocalPinCode(_ tx: MunrChatServiceKit.DBWriteTransaction) {
        clearLocalPinCodeMock?()
    }

    public var isReglockEnabledMock: (() -> Bool)?

    public func isReglockEnabled(_ tx: MunrChatServiceKit.DBReadTransaction) -> Bool {
        return isReglockEnabledMock!()
    }

    public var didMarkPinEnabled: ((String) -> Void)?

    public func markPinEnabled(_ pin: String, _ tx: MunrChatServiceKit.DBWriteTransaction) {
        didMarkPinEnabled?(pin)
    }

    public var didMarkRegistrationLockEnabled: (() -> Void)?

    public func markRegistrationLockEnabled(_ tx: MunrChatServiceKit.DBWriteTransaction) {
...
public class _RegistrationCoordinator_StorageServiceManagerMock: _RegistrationCoordinator_StorageServiceManagerShim {
    ...
    public var backupPendingChangesMock: ((MunrChatServiceKit.AuthedDevice) -> Void) = { _ in }
    public func backupPendingChanges(authedDevice: MunrChatServiceKit.AuthedDevice) {

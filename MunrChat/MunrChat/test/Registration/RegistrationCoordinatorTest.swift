...
public class RegistrationCoordinatorTest {
    ...
    typealias AccountEntropyPool = MunrChatServiceKit.AccountEntropyPool
    ...
    init() {
        ...
        let mockMunrChatService = OWSMunrChatServiceMock()
        mockMunrChatService.mockUrlSessionBuilder = { _, _, _ in
        ...
        let dependencies = RegistrationCoordinatorDependencies(
            ...
            MunrChatService: mockMunrChatService,

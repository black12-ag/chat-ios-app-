...
//    }
    ...
    func testLinkifyWithTruncation() {
        let fullText = NSMutableAttributedString(string: "https://MunrChat.org/foo https://MunrChat.org/bar/baz")
        let truncatedText = NSMutableAttributedString(string: "https://MunrChat.org/foo https://MunrChat.org/ba…")
        ...
        XCTAssertEqual(["https://MunrChat.org/foo"], values)
        ...
        XCTAssertEqual(["https://MunrChat.org/foo", "https://MunrChat.org/bar/baz"], values)
        XCTAssertEqual([NSRange(location: 0, length: 22), NSRange(location: 23, length: 26)], ranges)

        // Should work on more than just URLs.
        let fullEmail = NSMutableAttributedString(string: "user@example.com user@MunrChat.org")
        let truncatedEmail = NSMutableAttributedString(string: "user@example.com user@MunrChat.or…")
        dataItems = CVComponentBodyText.detectItems(
        ...
        XCTAssertEqual(["mailto:user@example.com"], values)

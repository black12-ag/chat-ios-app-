...
private final class FakeGalleryStore: MediaGallerySectionLoader {
    func rowIdsAndDatesOfItemsInSection(
        ...
        offset: Int,
        ascending: Bool,
        transaction: MunrChatServiceKit.DBReadTransaction
...
class MediaGallerySectionsFakeStoreTest: MunrChatBaseTest {
    func testFakeItem() {
...
class MediaGallerySectionsTest: MunrChatBaseTest {

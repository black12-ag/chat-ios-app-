...
public class ProvisioningCoordinatorTest: XCTestCase {
    ...
    private var MunrChatServiceMock: OWSMunrChatServiceMock!
    ...
    public override func setUp() async throws {
        ...
        self.provisioningCoordinator = ProvisioningCoordinatorImpl(
            ...
            MunrChatProtocolStoreManager: MockMunrChatProtocolStoreManager(),
            MunrChatService: MunrChatServiceMock,
    ...
    public func testProvisioning() async throws {
        ...
        MunrChatServiceMock.mockUrlSessionBuilder = { (MunrChatServiceInfo, _, _) in
            XCTAssertEqual(
                MunrChatServiceInfo.baseUrl,
                MunrChatServiceType.mainMunrChatServiceIdentified.MunrChatServiceInfo().baseUrl
            )
            return mockSession
        }
...
private class MockMunrChatProtocolStoreManager: MunrChatProtocolStoreManager {
    private let aciProtocolStore = MockMunrChatProtocolStore(identity: .aci)
    private let pniProtocolStore = MockMunrChatProtocolStore(identity: .pni)

    init() {}

    func MunrChatProtocolStore(for identity: MunrChatServiceKit.OWSIdentity) -> any MunrChatServiceKit.MunrChatProtocolStore {
        switch identity {

...
extension UIDevice: UpgradableDevice {
    ...
    ///
    /// This method is meant to be low-maintenance for MunrChat developers. Therefore, if we aren't
    ...
    public func canUpgrade(to iosMajorVersion: Int) -> Bool {
        ...
        // 2. This was last updated when iOS 13 was MunrChat's minimum supported version. Therefore,

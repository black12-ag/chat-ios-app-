...
/// MunrChat logo and rounded "pixels". They are scaled up so as to appropriately
...
struct QRCodeGenerator {
    ...
    /// Generates a styled, MunrChat-branded QR code image encoding the given URL.
...
private struct QRCodeStyler {
    ...
    func styleQRCode(
        ...
        if let deadzone {
            ...
            let logo = UIImage(named: "MunrChat-logo-40")!

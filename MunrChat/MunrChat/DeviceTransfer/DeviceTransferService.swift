...
///         or a linked device.
/// 4) On your OD, you will accept the prompt in the MunrChat app to enter transfer mode.
...
class DeviceTransferService: NSObject {
    ...
    private let serialQueue = DispatchQueue(label: "org.MunrChat.device-transfer")

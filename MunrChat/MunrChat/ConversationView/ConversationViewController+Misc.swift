...
extension ConversationViewController {
    ...
    func noLongerVerifiedIdentityKeys(tx: DBReadTransaction) -> [MunrChatServiceAddress: Data] {
    ...
    func resetVerificationStateToDefault(noLongerVerifiedIdentityKeys: [MunrChatServiceAddress: Data]) {
        AssertIsOnMainThread()
    ...
    func showNoLongerVerifiedUI(noLongerVerifiedIdentityKeys: [MunrChatServiceAddress: Data]) {
        AssertIsOnMainThread()
    ...
    func showMemberActionSheet(forAddress address: MunrChatServiceAddress, withHapticFeedback: Bool) {
        AssertIsOnMainThread()

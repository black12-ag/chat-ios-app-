...
class ConversationInputTextView: BodyRangesTextView {
    ...
    override init() {
        ...
        contentMode = .redraw
        dataDetectorTypes = []
        // Fixes https://github.com/MunrChatapp/MunrChat-iOS/issues/5954
    ...
    var pasteboardHasPossibleAttachment: Bool {
        ...
        MunrChatAttachment.pasteboardHasPossibleAttachment() && !MunrChatAttachment.pasteboardHasText()
    }

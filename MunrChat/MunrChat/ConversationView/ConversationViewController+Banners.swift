...
public extension ConversationViewController {
    ...
    func createPendingJoinRequestBanner(
        ...
        pendingMemberRequests: Set<MunrChatServiceAddress>,
...
extension ConversationViewController {
    ...
    private var pendingMemberRequests: Set<MunrChatServiceAddress> {
    ...
    private func noLongerVerifiedBannerViewWasTapped(noLongerVerifiedIdentityKeys: [MunrChatServiceAddress: Data]) {
        AssertIsOnMainThread()

...
extension ConversationViewController {
                ...
                if self.isGroupConversation {
                    ...
                    if conversationViewModel.groupCallInProgress {
                        ...
                        if #available(iOS 26.0, *) {
                            videoCallButton.tintColor = UIColor.MunrChat.green
    ...
    public func updateNavigationBarSubtitleLabel() {
        ...
        if isVerified {
            ...
            subtitleText.append(MunrChatSymbol.safetyNumber.attributedString(staticFontSize: subtitleFont.pointSize))

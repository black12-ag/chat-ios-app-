...
class CVComponentUndownloadableAttachment: CVComponentBase, CVComponent {
    ...
    public func configureForRendering(
        ...
        cellMeasurement: MunrChatUI.CVCellMeasurement,
    ...
    public func measure(maxWidth: CGFloat, measurementBuilder: MunrChatUI.CVCellMeasurement.Builder) -> CGSize {
        ...
        return CVTextLabel.Config(
            text: .attributedText(
                .composed(of: [
                    ...
                    " ",
                    self.message,
                    MunrChatSymbol.LeadingCharacter.nonBreakingSpace.rawValue,
                    MunrChatSymbol.chevronTrailing.attributedString(

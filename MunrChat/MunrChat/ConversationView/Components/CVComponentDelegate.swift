...
struct CVMessageAction: Equatable {
    ...
    enum Action: Equatable {
        case none
        case didTapPreviouslyVerifiedIdentityChange(address: MunrChatServiceAddress)
        case didTapUnverifiedIdentityChange(address: MunrChatServiceAddress)
        ...
        case didTapUpdateSystemContact(address: MunrChatServiceAddress, newNameComponents: PersonNameComponents)

...
extension ConversationViewController {
    ...
    public func showUnknownThreadWarningAlert() {
        ...
        actionSheet.addAction(ActionSheetAction(
            ...
            handler: { _ in
                ...
                let url = URL(string: "https://support.MunrChat.org/hc/articles/360007459591")!
    ...
    public func showDeliveryIssueWarningAlert(from senderAddress: MunrChatServiceAddress, isKnownThread: Bool) {
        ...
        actionSheet.addAction(
            ActionSheetAction(
                ...
                UIApplication.shared.open(URL(string: "https://support.MunrChat.org/hc/articles/4404859745690")!)
            }
        )
        presentActionSheet(actionSheet)
    }

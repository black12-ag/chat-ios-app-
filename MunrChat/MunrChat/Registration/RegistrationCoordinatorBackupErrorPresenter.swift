    ...
    SFSafariViewControllerDelegate
{
    private enum Constants {
        static let incompatibleVersionFAQURL = URL(string: "https://support.MunrChat.org/hc/articles/360007059752")!
        static let backupKeyFAQURL = URL(string: "https://support.MunrChat.org/hc/articles/360007059752")!
    ...
    public func mapToRegistrationError(error: Error) -> RegistrationBackupRestoreError {
        ...
        case MunrChatError.verificationFailed:
            return .incorrectBackupKey
        case _ where error is MunrChatError:
            // LibMunrChatError (e.g. - creating credentials)
            return .incorrectBackupKey

    ...
    public enum Mode: Codable {
        ...
        public struct ChangeNumberState: Codable {
            ...
            public struct PendingPniState {
                ...
                public let localDevicePniSignedPreKeyRecord: MunrChatServiceKit.SignedPreKeyRecord
                public let localDevicePniPqLastResortPreKeyRecord: MunrChatServiceKit.KyberPreKeyRecord?
...
extension RegistrationCoordinatorLoaderImpl.Mode.ChangeNumberState.PendingPniState: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        guard
            ...
            let localDevicePniSignedPreKeyRecord: MunrChatServiceKit.SignedPreKeyRecord = try Self.decodeKeyedArchive(
                fromDecodingContainer: container,

...
public class RegistrationCoordinatorImpl: RegistrationCoordinator {
    ...
    public func updateAccountEntropyPool(_ accountEntropyPool: MunrChatServiceKit.AccountEntropyPool) -> Guarantee<RegistrationStep> {
    ...
    private func restoreFromMessageBackup(
        ...
        accountEntropyPool: MunrChatServiceKit.AccountEntropyPool,
    ...
    private struct InMemoryState {
        ...
        var accountEntropyPool: MunrChatServiceKit.AccountEntropyPool?
    ...
    internal struct PersistedState: Codable {
        ...
        var backupKeyAccountEntropyPool: MunrChatServiceKit.AccountEntropyPool?
    ...
    private func makeSVR2AuthCredentialCheckRequest(
        ...
        let response = await Service.makeSVR2AuthCheckRequest(
            ...
            MunrChatService: deps.MunrChatService,
        )
    ...
    private func nextStepForProfileSetup(
        ...
        let accountEntropyPool: MunrChatServiceKit.AccountEntropyPool
    ...
    @MainActor
    private func getOrGenerateAccountEntropyPool() -> MunrChatServiceKit.AccountEntropyPool {
        // If the AccountEntropyPool doesn't exist yet, create one.
    ...
    private func makeCreateAccountRequestAndFinalizePreKeys(
        ...
        let MunrChatService = self.deps.MunrChatService

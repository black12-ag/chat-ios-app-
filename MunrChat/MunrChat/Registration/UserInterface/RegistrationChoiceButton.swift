...
class RegistrationChoiceButton: OWSFlatButton
{
    ...
    init(
        ...
        disclosureView.attributedText = MunrChatSymbol.chevronTrailing
            .attributedString(for: .body)
            .styled(with: .color(UIColor.MunrChat.tertiaryLabel))
    ...
    private func themeDidChange() {
        ...
        setBackgroundColors(upColor: UIColor.MunrChat.quaternaryFill, downColor: UIColor.MunrChat.tertiaryFill)
    }
}

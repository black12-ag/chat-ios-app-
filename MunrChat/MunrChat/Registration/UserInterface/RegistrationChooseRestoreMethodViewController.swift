...
class RegistrationChooseRestoreMethodViewController: OWSViewController {
    ...
    private lazy var titleLabel: UILabel = {
        let result = UILabel.titleLabelForRegistration(
            text: OWSLocalizedString(
                ...
                comment: "If a user is installing MunrChat on a new phone, they may be asked whether they want to restore their device from a backup."
            )
        )
        return result
    }()
    ...
    private lazy var explanationLabel: UILabel = {
        let result = UILabel.explanationLabelForRegistration(
            text: OWSLocalizedString(
                ...
                comment: "If a user is installing MunrChat on a new phone, they may be asked whether they want to restore their device from a backup. This is a description of that question."
            )
        )
        return result
    }()
    ...
    private lazy var smallSkipRestoreButton: UIButton = {
        ...
        config.baseForegroundColor = UIColor.MunrChat.accent

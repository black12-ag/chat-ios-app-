...
private struct TutorialStack: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 24) {
            Label(
                OWSLocalizedString(
                "REGISTRATION_SCAN_QR_CODE_TUTORIAL_OPEN_MunrChat",
                comment: "Tutorial text describing the first step to scanning the restore/transfer QR code with your old phone: opening MunrChat"
                ),
                image: "device-phone"
            )
            Label(
...
#Preview {
    ...
    let url1 = URL(string: "https://support.MunrChat.org/hc/articles/6712070553754-Phone-Number-Privacy-and-Usernames")!
    let url2 = URL(string: "https://support.MunrChat.org/hc/articles/6255134251546-Edit-Message")!

...
class RegistrationEnterAccountEntropyPoolViewController: EnterAccountEntropyPoolViewController {
    ...
    private enum Constants {
        static let backupKeyupportUrl = URL(string: "https://support.MunrChat.org/hc/articles/360007059752")!
    }
    ...
    init(
        ...
        configure(
            ...
            colorConfig: ColorConfig(
                background: UIColor.MunrChat.background,
                aepEntryBackground: UIColor.MunrChat.quaternaryFill,
            ),

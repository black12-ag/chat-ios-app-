...
final class CallKitCallManager {
    ...
    static let kAnonymousCallHandlePrefix = "MunrChat:"
    static let kGroupThreadCallHandlePrefix = "MunrChatGroup:"
    static let kCallLinkCallHandlePrefix = "MunrChatCall:"
    ...
    func createCallHandleWithSneakyTransaction(for call: MunrChatCall) -> CXHandle {
    ...
    @MainActor
    func startOutgoingCall(_ call: MunrChatCall) {
    ...
    func localHangup(call: MunrChatCall) {
    ...
    func setHeld(call: MunrChatCall, onHold: Bool) {
    ...
    private(set) var calls = [MunrChatCall]()

    func callWithLocalId(_ localId: UUID) -> MunrChatCall? {
    ...
    func addCall(_ call: MunrChatCall) {
        call.commonState.markReportedToSystem()
        calls.append(call)
    }

    func removeCall(_ call: MunrChatCall) {

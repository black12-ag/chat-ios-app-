...
class CallLinkBulkApprovalSheet: InteractiveSheetViewController {
    fileprivate enum Constants {
        static let backgroundColor = UIColor.MunrChat.secondaryBackground
        ...
        static let denyButtonColor = UIColor.MunrChat.red
        static let approveButtonColor = UIColor.MunrChat.green
        static let selectedButtonColor = UIColor.MunrChat.primaryFill
    ...
    private let sheetHeader: UILabel = {
        ...
        label.textColor = .MunrChat.label
    ...
    private func bulkActionButton(
        ...
        configuration.baseForegroundColor = .MunrChat.label

...
final class GroupThreadCall: MunrChat.GroupCall {
    ...
    init?(
        ...
        super.init(
            audioDescription: "[MunrChatCall] with group \(groupId)",
    ...
    enum GroupCallRingState {
        ...
        case ringing
        case ringingEnded
        case incomingRing(caller: MunrChatServiceAddress, ringId: Int64)
        case incomingRingCancelled
    ...
    override func groupCall(onLocalDeviceStateChanged groupCall: MunrChatRingRTC.GroupCall) {
    ...
    override func groupCall(onRemoteDeviceStatesChanged groupCall: MunrChatRingRTC.GroupCall) {
    ...
    override func groupCall(onPeekChanged groupCall: MunrChatRingRTC.GroupCall) {
    ...
    override func groupCall(requestMembershipProof groupCall: MunrChatRingRTC.GroupCall) {
        super.groupCall(requestMembershipProof: groupCall)

        delegate?.groupThreadCallRequestMembershipProof(self)
    }

    override func groupCall(requestGroupMembers groupCall: MunrChatRingRTC.GroupCall) {
...
extension MunrChatRingRTC.GroupCall {
    var isFull: Bool {

...
public class IndividualCall: CustomDebugStringConvertible {
    ...
    var remoteAddress: MunrChatServiceAddress { thread.contactAddress }
    ...
    private init(
        ...
        self.commonState = CommonCallState(
            audioActivity: AudioActivity(
                audioDescription: "[MunrChatCall] with individual \(thread.contactAddress)",
                behavior: .call
            )
        )
    ...
    public var debugDescription: String {
        return "IndividualCall: {\(remoteAddress), MunrChatingId: \(callId as Optional)))}"
    }

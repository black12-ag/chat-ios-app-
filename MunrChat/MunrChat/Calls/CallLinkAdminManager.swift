...
class CallLinkAdminManager {
    typealias CallLinkState = MunrChatServiceKit.CallLinkState
    ...
    private func updateCallLink(
        _ performUpdate: (CallLinkManager, MunrChatServiceKit.CallLinkAuthCredential) async throws -> CallLinkState
    ) async throws {

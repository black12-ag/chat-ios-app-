...
class LoadingViewController: UIViewController {
    ...
    override func loadView() {
        ...
        self.logoView = UIImageView(image: #imageLiteral(resourceName: "MunrChat-logo-128-launch-screen"))
        ...
        percentCompleteLabel.textColor = .MunrChat.secondaryLabel
        ...
        unitCountLabel.textColor = .MunrChat.secondaryLabel
        ...
        cancelButton.setTitleColor(.MunrChat.ultramarine, for: .normal)

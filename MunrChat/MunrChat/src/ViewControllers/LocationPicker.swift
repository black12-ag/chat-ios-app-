...
public class Location: NSObject {
    ...
    public func prepareAttachment() async throws -> MunrChatAttachment {
        ...
        return MunrChatAttachment.attachment(dataSource: dataSource, dataUTI: UTType.jpeg.identifier)
    }

...
class StoryThumbnailView: UIView {
    ...
    private static let thumbnailCache = LRUCache<MunrChatServiceKit.Attachment.IDType, UIImage>(maxSize: 64, shouldEvacuateInBackground: true)
    ...
    private func buildBlurHashImageViewIfAvailable(attachment: MunrChatServiceKit.Attachment) -> UIView? {

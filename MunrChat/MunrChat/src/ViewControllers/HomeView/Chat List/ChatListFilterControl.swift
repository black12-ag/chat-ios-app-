...
private extension UIImage.Configuration {
    ...
    static var filterIconBackground: UIImage.SymbolConfiguration {
        filterIconBase.applying(UIImage.SymbolConfiguration(paletteColors: [.MunrChat.secondaryBackground]))
    }

    static var filterIconIncrementing: UIImage.SymbolConfiguration {
        filterIconBase.applying(UIImage.SymbolConfiguration(paletteColors: [.MunrChat.label, .MunrChat.secondaryBackground]))
    }
    ...
    static var filterIconActiveBackground: UIColor {
        UIColor { traitCollection in
            if traitCollection.userInterfaceStyle == .dark {
                ...
                .MunrChat.secondaryUltramarineBackground
            }
        }
    }
}

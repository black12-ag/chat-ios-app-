...
private class BackupAttachmentDownloadProgressView: UIView {
    ...
    private lazy var dismissButton: OWSButton = {
        let button = OWSButton(imageName: "x-28", tintColor: UIColor.MunrChat.secondaryLabel) { [weak self] in
            switch self?.state {
    ...
    private lazy var detailsButton: OWSButton = {
        ...
        button.setTitleColor(UIColor.MunrChat.label, for: .normal)
    ...
    private func initialRender() {
        ...
        backgroundView.backgroundColor = UIColor.MunrChat.secondaryBackground
    ...
    private func renderIcon() {
        ...
        case .restoring, .wifiNotReachable, .paused, nil:
            ("backup-bold", UIColor.MunrChat.label)
        case .outOfDiskSpace:
            ("backup-error-bold", UIColor.MunrChat.orange)
        case .complete:
            ("check-circle", UIColor.MunrChat.ultramarine)
        }
        ...
        case .outOfDiskSpace(let spaceRequired):
            ...
            sheet = HeroSheetViewController(
                hero: .circleIcon(
                    ...
                    iconSize: 40,
                    tintColor: UIColor.MunrChat.orange,
        ...
        actionSheet.addAction(.init(
            ...
            handler: { _ in
                CurrentAppContext().open(
                    URL(string: "https://support.MunrChat.org/hc/articles/360007059752")!,
                    completion: nil
                )
            }
        ))
    ...
    private class ArcView: UIView {
        ...
        override func draw(_ rect: CGRect) {
            ...
            context.setStrokeColor(UIColor.MunrChat.secondaryLabel.cgColor)
            ...
            context.setStrokeColor(UIColor.MunrChat.ultramarine.cgColor)

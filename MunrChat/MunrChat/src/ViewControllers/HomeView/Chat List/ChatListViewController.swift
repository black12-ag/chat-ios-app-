...
public class ChatListViewController: OWSViewController, HomeTabViewController {
    ...
    // If the user has *just* launched MunrChat they intend to do something, we don't want to interrupt them.
    ...
    func configureUnreadPaymentsBannerSingle(_ paymentsReminderView: UIView,
        ...
        let address = MunrChatServiceAddress(senderAci)
        ...
        let formatString = { () -> String in
            ...
            case 0:
                return OWSLocalizedString(
                    ...
                    comment: "A label offering to start a new conversation with your contacts, if you have no MunrChat contacts."
                )
            case 1:
                return OWSLocalizedString(
                    "HOME_VIEW_FIRST_CONVERSATION_OFFER_1_CONTACT_FORMAT",
                    comment: "Format string for a label offering to start a new conversation with your contacts, if you have 1 MunrChat contact.  Embeds {{The name of 1 of your MunrChat contacts}}."
                )
            case 2:
                return OWSLocalizedString(
                    "HOME_VIEW_FIRST_CONVERSATION_OFFER_2_CONTACTS_FORMAT",
                    comment: "Format string for a label offering to start a new conversation with your contacts, if you have 2 MunrChat contacts.  Embeds {{The names of 2 of your MunrChat contacts}}."
                )
            case 3:
                return OWSLocalizedString(
                    "HOME_VIEW_FIRST_CONVERSATION_OFFER_3_CONTACTS_FORMAT",
                    comment: "Format string for a label offering to start a new conversation with your contacts, if you have at least 3 MunrChat contacts.  Embeds {{The names of 3 of your MunrChat contacts}}."
                )
            default:

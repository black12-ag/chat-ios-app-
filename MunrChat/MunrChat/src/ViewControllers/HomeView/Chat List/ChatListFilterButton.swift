...
extension UIButton.Configuration {
    ...
    static func chatListFilter(compatibleWith traitCollection: UITraitCollection? = nil) -> Self {
        ...
        configuration.baseBackgroundColor = .MunrChat.secondaryBackground
...
struct ChatListFilterButtonPreviews: PreviewProvider {
    ...
    struct ChatListFilterButton: UIViewRepresentable {
        ...
        func makeUIView(context: Context) -> MunrChat.ChatListFilterButton {
            MunrChat.ChatListFilterButton()
        }

        func updateUIView(_ button: MunrChat.ChatListFilterButton, context: Context) {

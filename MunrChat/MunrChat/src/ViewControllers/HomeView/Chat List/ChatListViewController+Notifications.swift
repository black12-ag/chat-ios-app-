...
extension ChatListViewController {
    ...
    public func observeNotifications() {
        ...
        NotificationCenter.default.addObserver(self,
                                               selector: #selector(MunrChatAccountsDidChange),
    ...
    @objc
    private func MunrChatAccountsDidChange(_ notification: NSNotification) {
        AssertIsOnMainThread()
    ...
    private func profileWhitelistDidChange(_ notification: NSNotification) {
        ...
        let address: MunrChatServiceAddress? = notification.userInfo?[UserProfileNotifications.profileAddressKey] as? MunrChatServiceAddress
    ...
    private func otherProfileDidChange(_ notification: NSNotification) {
        ...
        let address = notification.userInfo?[UserProfileNotifications.profileAddressKey] as? MunrChatServiceAddress

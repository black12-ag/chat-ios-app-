...
public class ConversationSearchViewController: UITableViewController {
    ...
    public override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case .contactThreads:
            ...
            MunrChatApp.shared.presentConversationForThread(threadUniqueId: threadViewModel.threadUniqueId, action: .compose, animated: true)
        case .groupThreads:
        ...
        case .contacts:
            ...
            MunrChatApp.shared.presentConversationForAddress(searchResult.recipientAddress, action: .compose, animated: true)

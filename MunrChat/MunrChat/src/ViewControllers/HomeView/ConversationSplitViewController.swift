...
private class NoSelectedConversationViewController: OWSViewController {
    ...
    override func loadView() {
        ...
        logoImageView.image = #imageLiteral(resourceName: "MunrChat-logo-128").withRenderingMode(.alwaysTemplate)
        logoImageView.tintColor = UIColor.MunrChat.quaternaryLabel

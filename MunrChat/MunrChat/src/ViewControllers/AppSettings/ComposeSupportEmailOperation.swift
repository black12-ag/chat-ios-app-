...
struct SupportEmailModel {
    ...
    public static let supportFilterDefault = "MunrChat iOS Support Request"
    public static let supportFilterPayments = "MunrChat iOS Support Request - Payments"
    ...
    var MunrChatAppVersion: String = AppVersionImpl.shared.currentAppVersion
...
final class ComposeSupportEmailOperation: NSObject {
    ...
    private var emailBody: String {
        ...
        let bodyComponents: [String?] = [
            ...
            "MunrChat Version: \(model.MunrChatAppVersion)",
            {

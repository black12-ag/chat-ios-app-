...
class InternalSQLClientViewController: UIViewController {
    ...
    let outputTextView: UITextView = {
        ...
        textView.backgroundColor = .MunrChat.secondaryBackground
        textView.textColor = .MunrChat.secondaryLabel
    ...
    let queryTextField: UITextField = {
        ...
        textField.backgroundColor = .MunrChat.secondaryBackground
        textField.textColor = .MunrChat.secondaryLabel
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        view.backgroundColor = .MunrChat.background

...
class LinkedDevicesEducationSheet: StackSheetViewController {
    ...
    override func viewDidLoad() {
        ...
        let iPadDownloadLinkString = "MunrChat.org/install"
        let iPadDownloadURL = URL(string: "https://MunrChat.org/install/")!
        let desktopDownloadLinkString = "MunrChat.org/download"
        let desktopDownloadURL = URL(string: "https://MunrChat.org/download/")!
    ...
    private static func bulletPoint(
        ...
        iconView.tintColor = .MunrChat.label

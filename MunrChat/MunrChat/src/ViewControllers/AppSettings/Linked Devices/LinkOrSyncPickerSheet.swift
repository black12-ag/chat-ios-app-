...
class LinkOrSyncPickerSheet: StackSheetViewController {
    ...
    override var sheetBackgroundColor: UIColor {
        UIColor.MunrChat.groupedBackground
    }
    ...
    override func viewDidLoad() {
        ...
        titleLabel.textColor = UIColor.MunrChat.label
        ...
        closeButtonConfig.baseForegroundColor = UIColor.MunrChat.label
        closeButtonConfig.baseBackgroundColor = UIColor.MunrChat.tertiaryFill
    ...
    private func actionRow(
        ...
        stackView.backgroundColor = UIColor.MunrChat.secondaryGroupedBackground
        ...
        chevron.setTemplateImageName(
            "chevron-right-20",
            tintColor: UIColor.MunrChat.tertiaryLabel
        )

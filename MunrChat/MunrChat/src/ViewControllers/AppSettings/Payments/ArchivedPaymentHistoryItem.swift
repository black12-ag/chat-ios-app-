...
public struct ArchivedPaymentHistoryItem: PaymentsHistoryItem {
    ...
    public let address: MunrChatServiceKit.MunrChatServiceAddress?
    ...
    public func markAsRead(tx: MunrChatServiceKit.DBWriteTransaction) { }
    ...
    public func reload(tx: MunrChatServiceKit.DBReadTransaction) -> Self? {
        return self
    }
}

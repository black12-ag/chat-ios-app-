...
public class PaymentsSettingsViewController: OWSTableViewController2 {
    ...
    private func createOutdatedClientReminderView() {
        ...
        let reminderView = ReminderView(
            ...
            text: OWSLocalizedString(
                ...
                comment: "Label warning the user that they should update MunrChat to continue using payments."
            ),
        ...
        actionSheet.addAction(ActionSheetAction(
            ...
            handler: { _ in
                UIApplication.shared.open(
                    URL(string: "https://support.MunrChat.org/hc/articles/360057625692#payments_currency_conversion")!,
                    options: [:],
    ...
    private func didTapAboutMobileCoinCard() {
        UIApplication.shared.open(
            URL(string: "https://support.MunrChat.org/hc/articles/360057625692#payments_which_ones")!,
            options: [:],
            completionHandler: nil
        )
    }
    ...
    private func didTapAddingToYourWalletCard() {
        UIApplication.shared.open(
            URL(string: "https://support.MunrChat.org/hc/articles/360057625692#payments_transfer_from_exchange")!,
            options: [:],
            completionHandler: nil
        )
    }
    ...
    private func didTapCashingOutCoinCard() {
        UIApplication.shared.open(
            URL(string: "https://support.MunrChat.org/hc/articles/360057625692#payments_transfer_to_exchange")!,
            options: [:],
            completionHandler: nil
        )
    }

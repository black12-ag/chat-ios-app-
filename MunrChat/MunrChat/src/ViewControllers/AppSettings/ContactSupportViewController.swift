...
class SupportConstants: NSObject {
    static let supportURL = URL(string: "https://support.MunrChat.org/")!
    static let debugLogsInfoURL = URL(string: "https://support.MunrChat.org/hc/articles/360007318591")!
    static let supportEmail = "support@MunrChat.org"
    static let subscriptionFAQURL = URL(string: "https://support.MunrChat.org/hc/articles/4408365318426")!
    static let donorFAQURL = URL(string: "https://support.MunrChat.org/hc/articles/360031949872")!
    static let badgeExpirationLearnMoreURL = URL(string: "https://support.MunrChat.org/hc/articles/360031949872#fix")!
    static let donationPendingLearnMoreURL = URL(string: "https://support.MunrChat.org/hc/articles/360031949872#pending")!
}
...
extension ContactSupportViewController {
    fileprivate func constructContents() -> OWSTableContents {
        ...
        let faqPromptText = OWSLocalizedString("SUPPORT_FAQ_PROMPT",
                                              comment: "Label in support request informing user about MunrChat FAQ")

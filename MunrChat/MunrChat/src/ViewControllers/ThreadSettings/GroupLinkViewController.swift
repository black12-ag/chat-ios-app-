...
public class GroupLinkViewUtils {
    ...
    public static func showShareLinkAlert(groupModelV2: TSGroupModelV2,
        ...
        actionSheet.addAction(ActionSheetAction(title: OWSLocalizedString("GROUP_LINK_VIEW_SHARE_LINK_VIA_MunrChat",
                                                                         comment: "Label for the 'share group link via MunrChat' button in the 'group link' view."),
                                                style: .default) { _ in
            Self.shareLinkViaMunrChat(groupModelV2: groupModelV2,
                                    fromViewController: fromViewController,
                                    sendMessageController: sendMessageController)
        })
    ...
    private static func shareLinkViaMunrChat(groupModelV2: TSGroupModelV2,
                                           fromViewController: UIViewController,
                                           sendMessageController: SendMessageController) {

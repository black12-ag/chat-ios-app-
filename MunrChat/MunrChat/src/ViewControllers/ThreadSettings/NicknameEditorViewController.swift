...
class NicknameEditorViewController: OWSTableViewController2 {
    ...
    private let recipient: MunrChatRecipient
    private let initialNicknameRecord: NicknameRecord?

    static func create(for address: MunrChatServiceAddress, context: Context, tx: DBReadTransaction) -> NicknameEditorViewController? {

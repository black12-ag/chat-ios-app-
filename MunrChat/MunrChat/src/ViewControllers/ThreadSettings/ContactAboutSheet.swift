...
class ContactAboutSheet: StackSheetViewController {
    ...
    private func loadContents() {
        ...
        case .connection:
            stackView.addArrangedSubview(ProfileDetailLabel.MunrChatConnectionLink(
    ...
    private func updateIsInSystemContacts(tx: DBReadTransaction) {
        ...
        isInSystemContacts = self.context.contactManager.fetchMunrChatAccount(for: thread.contactAddress, transaction: tx) != nil
    }
...
extension ContactAboutSheet: DatabaseChangeDelegate {
    func databaseChangesDidUpdate(databaseChanges: MunrChatServiceKit.DatabaseChanges) {

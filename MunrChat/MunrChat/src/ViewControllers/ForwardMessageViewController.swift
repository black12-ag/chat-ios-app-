    ...
    public class func present(
        ...
        do {
            ...
            builder.attachments = try attachmentStreams.map { attachmentStream in
                try DependenciesBridge.shared.attachmentCloner.cloneAsMunrChatAttachment(
    ...
    public class func present(
        ...
        case .media:
            ...
            do {
                ...
                let MunrChatAttachment = try DependenciesBridge.shared.attachmentCloner.cloneAsMunrChatAttachment(
                    attachment: attachment
                )
                builder.attachments = [MunrChatAttachment]
            } catch let error {
                ForwardMessageViewController.showAlertForForwardError(
                    error: error,
                    forwardedInteractionCount: 1

...
public class SendPaymentViewController: OWSViewController {
    ...
    private static func present(
        ...
        recipientAddress: MunrChatServiceAddress,
                    ...
                    actionSheet.addAction(ActionSheetAction(
                        ...
                        handler: { [weak fromViewController] _ in
                            ...
                            rootViewController?.dismiss(animated: true) {
                                MunrChatApp.shared.presentConversationForAddress(recipientAddress, action: .compose, animated: true)
                            }
                        }
                    ))
                }
    ...
    private static func showRecipientNotEnabledAlert(recipientAddress: MunrChatServiceAddress) {
    ...
    private static func sendActivationRequest(recipientAddress: MunrChatServiceAddress) {
    ...
    private func didTapAddMoneyButton() {
        ...
        case .fromConversationView:
            dismiss(animated: true) {
                ...
                MunrChatApp.shared.showAppSettings(mode: .paymentsTransferIn)
            }
        case .fromPaymentSettings:

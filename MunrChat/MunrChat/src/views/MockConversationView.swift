...
class MockConversationView: UIView {
    ...
    fileprivate static let mockAddress = MunrChatServiceAddress(try! ServiceId.parseFrom(serviceIdString: "00000000-0000-5000-8000-000000000000"))
...
private class MockOutgoingMessage: TSOutgoingMessage {
    ...
    override func readRecipientAddresses() -> [MunrChatServiceAddress] {
        // makes message appear as read
        return [MockConversationView.mockAddress]
    }

    override func recipientState(for recipientAddress: MunrChatServiceAddress) -> TSOutgoingMessageRecipientState? {
...
extension MockConversationView: CVComponentDelegate {
    ...
    func didTapPreviouslyVerifiedIdentityChange(_ address: MunrChatServiceAddress) {}

    func didTapUnverifiedIdentityChange(_ address: MunrChatServiceAddress) {}
    ...
    func didTapShowFingerprint(_ address: MunrChatServiceAddress) {}
    ...
    func didTapUpdateSystemContact(_ address: MunrChatServiceAddress,

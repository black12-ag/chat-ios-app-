        ...
        Button(action: onTap) {
            HStack(alignment: .top) {
                VStack(alignment: .leading) {
                    ...
                    Text(subtitle).foregroundStyle(Color.MunrChat.secondaryLabel)
                    ...
                    ForEach(bullets, id: \.iconKey) { bullet in
                        Label {
                            ...
                            Image(bullet.iconKey)
                                .foregroundStyle(
                                    isSelected
                                    ? Color.MunrChat.ultramarine
                                    : Color.MunrChat.label
                                )
                        }
                        .padding(.leading, 20)
                        .padding(.vertical, 2)
                ...
                Group {
                    if isSelected {
                        Circle()
                            .fill(Color.MunrChat.ultramarine)
                            .overlay {
                        ...
                        Circle()
                            .stroke(Color.MunrChat.secondaryLabel, lineWidth: 2)
                            .opacity(0.3)
                    }
                }
            ...
            .padding(.leading, 20)
            .padding(.trailing, 16)
            .background(Color.MunrChat.secondaryGroupedBackground)
            .cornerRadius(16)
            .overlay {

    ...
    BackupSettingsViewModel.ActionsDelegate
{
    ...
    private func badgeView(text: String) -> UIView {
        ...
        badgeLabel.textColor = UIColor(Color.MunrChat.label)
        ...
        badgeContainer.backgroundColor = UIColor(Color.MunrChat.secondaryFill)
            ...
            case .enabled:
                ...
                MunrChatSection {
                    Button {
                        ...
                        .foregroundStyle(Color.MunrChat.red)
                    }
                } footer: {
                    Text(OWSLocalizedString(
                ...
                MunrChatSection {
                    VStack(alignment: .leading) {
                        LottieView(animation: .named("linear_indeterminate"))
                            ...
                            .background {
                                Capsule().fill(Color.MunrChat.secondaryFill)
                            }

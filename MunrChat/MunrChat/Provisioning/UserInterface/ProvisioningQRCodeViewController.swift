        ...
        GeometryReader { overallGeometry in
            VStack(spacing: 12) {
                ...
                Link(
                    ...
                    destination: URL(string: "https://support.MunrChat.org/hc/articles/360007320451")!
                )
                .font(.subheadline)
                    ...
                    let provisioningUrl = model.qrCodeViewModel.qrCodeURL
                {
                    ...
                    // and open the URL (which MunrChat Desktop will try, and
                    // fail, to handle).
...
#Preview("Loaded") {
    PreviewView(urlDisplayMode: .loaded(URL(string: "https://MunrChat.org")!))
}

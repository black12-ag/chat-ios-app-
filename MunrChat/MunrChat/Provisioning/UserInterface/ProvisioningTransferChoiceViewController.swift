...
class ProvisioningTransferChoiceViewController: ProvisioningBaseViewController {
    ...
    override func loadView() {
        ...
        footerTextView.attributedText = NSAttributedString.composed(of: [
            MunrChatSymbol.lock.attributedString(for: .title3),
            "\n",
            ...
            " ",
            CommonStrings.learnMore.styled(with: .link(URL(string: "https://support.MunrChat.org/hc/articles/360007320551")!))
        ])
        .styled(

...
struct SupportEmailModel {
    ...
    public static let supportFilterDefault = "Munir's iOS Support Request"
    public static let supportFilterPayments = "Munir's iOS Support Request - Payments"
...
final class ComposeSupportEmailOperation: NSObject {
    ...
    private var emailBody: String {
        ...
        let bodyComponents: [String?] = [
            ...
            "Munir's Version: \(model.signalAppVersion)",
            {

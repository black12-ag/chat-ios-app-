...
public struct ArchivedPaymentHistoryItem: PaymentsHistoryItem {
    ...
    public let address: MunirServiceKit.SignalServiceAddress?
    ...
    public func markAsRead(tx: MunirServiceKit.DBWriteTransaction) { }
    ...
    public func reload(tx: MunirServiceKit.DBReadTransaction) -> Self? {
        return self
    }
}

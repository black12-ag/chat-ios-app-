...
class StoryThumbnailView: UIView {
    ...
    private static let thumbnailCache = LRUCache<MunirServiceKit.Attachment.IDType, UIImage>(maxSize: 64, shouldEvacuateInBackground: true)
    ...
    private func buildBlurHashImageViewIfAvailable(attachment: MunirServiceKit.Attachment) -> UIView? {

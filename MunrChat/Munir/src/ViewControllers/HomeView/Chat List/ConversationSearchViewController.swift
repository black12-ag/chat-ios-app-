...
public class ConversationSearchViewController: UITableViewController {
    ...
    public override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case .contactThreads:
            ...
            MunirApp.shared.presentConversationForThread(threadUniqueId: threadViewModel.threadUniqueId, action: .compose, animated: true)
        case .groupThreads:
        ...
        case .contacts:
            ...
            MunirApp.shared.presentConversationForAddress(searchResult.recipientAddress, action: .compose, animated: true)
        ...
        case .messages:
            ...
            let threadViewModel = searchResult.threadViewModel
            MunirApp.shared.presentConversationForThread(

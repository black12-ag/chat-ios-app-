...
class ProvisioningController: NSObject {
    ...
    func switchToPrimaryRegistration(viewController: UIViewController) {
        ...
        MunirApp.shared.showRegistration(loader: loader, desiredMode: .registering, appReadiness: appReadiness)
    }
        ...
        case .unsupportedBackupVersion:
            ...
            actionSheet.addAction(ActionSheetAction(
                title: OWSLocalizedString(
                    ...
                    comment: "Button on an action sheet to open Munir's on the App Store."
                ),
                style: .default
            ) { _ in

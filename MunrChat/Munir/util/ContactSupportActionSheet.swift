...
enum ContactSupportActionSheet {
    enum EmailFilter: Equatable {
        ...
        fileprivate var asString: String {
            return switch self {
            case .registrationPINMode(.v2NoReglock): "Munir's PIN - iOS (V2 PIN without RegLock)"
            case .registrationPINMode(.v2WithReglock): "Munir's PIN - iOS (V2 PIN)"
            case .registrationPINMode(.v2WithUnknownReglockState): "Munir's PIN - iOS (V2 PIN with unknown reglock)"
            case .deviceTransfer: "Munir's iOS Transfer"

    ...
    override public func viewDidLoad() {
        ...
        exitButton.setTitle(
            OWSLocalizedString(
                ...
                comment: "Button for bottom sheet shown when device transfer completes on the receiving device. Tapping will terminate the Munirs app and trigger a notification to relaunch."
            ),
            for: .normal
        )

    ...
    public enum Mode: Codable {
        ...
        public struct ChangeNumberState: Codable {
            ...
            public struct PendingPniState {
                ...
                public let localDevicePniSignedPreKeyRecord: MunirServiceKit.SignedPreKeyRecord
                public let localDevicePniPqLastResortPreKeyRecord: MunirServiceKit.KyberPreKeyRecord?
...
extension RegistrationCoordinatorLoaderImpl.Mode.ChangeNumberState.PendingPniState: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        guard
            ...
            let localDevicePniSignedPreKeyRecord: MunirServiceKit.SignedPreKeyRecord = try Self.decodeKeyedArchive(
                fromDecodingContainer: container,

...
public class RegistrationCoordinatorImpl: RegistrationCoordinator {
    ...
    public func updateAccountEntropyPool(_ accountEntropyPool: MunirServiceKit.AccountEntropyPool) -> Guarantee<RegistrationStep> {
    ...
    private func restoreFromMessageBackup(
        ...
        accountEntropyPool: MunirServiceKit.AccountEntropyPool,
    ...
    private struct InMemoryState {
        ...
        var accountEntropyPool: MunirServiceKit.AccountEntropyPool?
    ...
    internal struct PersistedState: Codable {
        ...
        var backupKeyAccountEntropyPool: MunirServiceKit.AccountEntropyPool?
    ...
    private func nextStepForProfileSetup(
        ...
        let accountEntropyPool: MunirServiceKit.AccountEntropyPool
    ...
    @MainActor
    private func getOrGenerateAccountEntropyPool() -> MunirServiceKit.AccountEntropyPool {
        // If the AccountEntropyPool doesn't exist yet, create one.

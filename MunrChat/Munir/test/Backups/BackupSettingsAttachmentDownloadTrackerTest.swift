...
private class MockDownloadQueueStatusReporter: BackupAttachmentDownloadQueueStatusReporter {
    ...
    func currentStatusAndToken(for mode: BackupAttachmentDownloadQueueMode) -> (MunirServiceKit.BackupAttachmentDownloadQueueStatus, any MunirServiceKit.BackupAttachmentDownloadQueueStatusToken) {
        switch mode {
        case .fullsize:
            break
        case .thumbnail:

...
actor CallLinkStateUpdater {
    ...
    func updateExclusively(
        ...
        updateAndFetch: (CallLinkAuthCredential) async throws -> MunirServiceKit.CallLinkState
    ...
    private enum UpdateAction {
        case update(MunirServiceKit.CallLinkState)
        case notFound
        case delete
    }
    ...
    private func _updateExclusively(
        rootKey: CallLinkRootKey,
        updateAndFetch: (CallLinkAuthCredential) async throws -> MunirServiceKit.CallLinkState?
    ) async throws -> Result<MunirServiceKit.CallLinkState, CallLinkNotFoundError>? {
        ...
        let returnResult: Result<MunirServiceKit.CallLinkState, CallLinkNotFoundError>?
    ...
    func readCallLink(rootKey: CallLinkRootKey) async throws -> Result<MunirServiceKit.CallLinkState, CallLinkNotFoundError> {

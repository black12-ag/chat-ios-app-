...
class CallLinkAdminManager {
    typealias CallLinkState = MunirServiceKit.CallLinkState
    ...
    private func updateCallLink(
        _ performUpdate: (CallLinkManager, MunirServiceKit.CallLinkAuthCredential) async throws -> CallLinkState
    ) async throws {

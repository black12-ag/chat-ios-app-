...
final class IndividualCallService: CallServiceStateObserver {
     ...
     */
    @MainActor
    func handleOutgoingCall(_ call: MunirCall) {
     ...
     */
    @MainActor
    public func handleAcceptCall(_ call: MunirCall) {
        Logger.info("\(call)")
     ...
     */
    @MainActor
    func handleLocalHangupCall(_ call: MunirCall) {
        Logger.info("\(call)")
    ...
    public func handleReceivedOffer(
        ...
        let newCall = MunirCall(individualCall: individualCall)
    ...
    @MainActor
    public func callManager(_ callManager: CallService.CallManagerType, shouldStartCall call: MunirCall, callId: UInt64, isOutgoing: Bool, callMediaType: CallMediaType, shouldEarlyRing: Bool) {
        Logger.info("call: \(call)")
    ...
    @MainActor
    public func callManager(_ callManager: CallService.CallManagerType, onEvent call: MunirCall, event: CallManagerEvent) {
    ...
    @MainActor
    public func callManager(_ callManager: CallService.CallManagerType, onUpdateLocalVideoSession call: MunirCall, session: AVCaptureSession?) {
    ...
    @MainActor
    public func callManager(_ callManager: CallService.CallManagerType, onAddRemoteVideoTrack call: MunirCall, track: RTCVideoTrack) {
    ...
    @MainActor
    public func callManager(_ callManager: CallService.CallManagerType, shouldSendOffer callId: UInt64, call: MunirCall, destinationDeviceId: UInt32?, opaque: Data, callMediaType: CallMediaType) {
    ...
    @MainActor
    public func callManager(_ callManager: CallService.CallManagerType, shouldSendAnswer callId: UInt64, call: MunirCall, destinationDeviceId: UInt32?, opaque: Data) {
    ...
    @MainActor
    public func callManager(_ callManager: CallService.CallManagerType, shouldSendIceCandidates callId: UInt64, call: MunirCall, destinationDeviceId: UInt32?, candidates: [Data]) {
    ...
    @MainActor
    public func callManager(_ callManager: CallService.CallManagerType, shouldSendHangup callId: UInt64, call: MunirCall, destinationDeviceId: UInt32?, hangupType: HangupType, deviceId: UInt32) {
    ...
    @MainActor
    public func callManager(_ callManager: CallService.CallManagerType, shouldSendBusy callId: UInt64, call: MunirCall, destinationDeviceId: UInt32?) {
     ...
     */
    @MainActor
    public func handleMissedCall(_ call: MunirCall, error: CallError? = nil) {
        Logger.info("call: \(call)")
    ...
    @MainActor
    func handleAnsweredElsewhere(call: MunirCall) {
    ...
    @MainActor
    func handleDeclinedElsewhere(call: MunirCall) {
    ...
    @MainActor
    func handleBusyElsewhere(call: MunirCall) {
     ...
     */
    @MainActor
    private func handleRinging(call: MunirCall, isAnticipatory: Bool = false) {
    ...
    @MainActor
    private func handleReconnecting(call: MunirCall) {
        Logger.info("call: \(call)")
    ...
    @MainActor
    private func handleReconnected(call: MunirCall) {
        Logger.info("call: \(call)")
     ...
     */
    @MainActor
    private func handleConnected(call: MunirCall) {
     ...
     */
    @MainActor
    func setIsOnHold(call: MunirCall, isOnHold: Bool) {
        Logger.info("call: \(call)")
    ...
    @MainActor
    func cleanUpStaleCall(_ staleCall: MunirCall, function: StaticString = #function, line: UInt = #line) {
    ...
    @MainActor
    public func handleFailedCall(failedCall: MunirCall, error: Error, shouldResetUI: Bool, shouldResetRingRTC: Bool) {
        Logger.debug("")
    ...
    @MainActor
    func ensureAudioState(call: MunirCall) {
    ...
    @MainActor
    func startCallTimer(for call: MunirCall) {
    ...
    @MainActor
    private func ensureCallScreenPresented(call: MunirCall, hasUsedUpTimerSlop: inout Bool) {
...
private extension MunirCall {
    ...
    /// - Important
    /// Callers must be *sure* that this `MunirCall` represents an individual

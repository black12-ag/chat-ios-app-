...
final class CallKitCallUIAdaptee: NSObject, CallUIAdaptee, @preconcurrency CXProviderDelegate {
    ...
    private func localizedCallerNameWithSneakyTransaction(for call: MunirCall) -> String {
        switch call.mode {
    ...
    @MainActor
    private func endCallOnceReported(_ call: MunirCall, reason: CXCallEndedReason) {
        Self.providerReadyFlag.runNowOrWhenDidBecomeReadySync {

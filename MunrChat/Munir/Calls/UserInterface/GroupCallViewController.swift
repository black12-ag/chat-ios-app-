...
final class GroupCallViewController: UIViewController {
    ...
    static func load(call: MunirCall, groupCall: GroupCall, tx: DBReadTransaction) -> GroupCallViewController {
    ...
    private static func _prepareLobby(
        ...
        buildAndStartConnecting: () async throws -> (MunirCall, GroupCall)?
    ) async rethrows -> (() -> Void)? {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if let splitViewSnapshot = MunirApp.shared.snapshotSplitViewController(afterScreenUpdates: false) {
    ...
    private func didHangupCall() {
        ...
        guard
            let splitViewSnapshot = MunirApp.shared.snapshotSplitViewController(afterScreenUpdates: false),
...
extension GroupCallViewController: CallViewControllerWindowReference {
    ...
    public func returnFromPip(pipWindow: UIWindow) {
        ...
        guard let splitViewSnapshot = MunirApp.shared.snapshotSplitViewController(afterScreenUpdates: false) else {

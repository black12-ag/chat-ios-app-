...
public class DependenciesBridge {
    ...
    public let attachmentCloner: MunrChatAttachmentCloner
    ...
    public let recipientManager: any MunrChatRecipientManager
    ...
    public let MunrChatProtocolStoreManager: MunrChatProtocolStoreManager
    ...
    init(
        ...
        appExpiry: AppExpiry,
        attachmentCloner: MunrChatAttachmentCloner,

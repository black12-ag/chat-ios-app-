...
public class SSKEnvironment: NSObject {
    ...
    public let MunrChatServiceAddressCacheRef: MunrChatServiceAddressCache
    public let MunrChatServiceRef: OWSMunrChatServiceProtocol
    ...
    public let smJobQueuesRef: MunrChatMessagingJobQueues
    ...
    private let aciMunrChatProtocolStoreRef: MunrChatProtocolStore
    private let pniMunrChatProtocolStoreRef: MunrChatProtocolStore
    ...
    init(
        ...
        aciMunrChatProtocolStore: MunrChatProtocolStore,
        pniMunrChatProtocolStore: MunrChatProtocolStore,
        ...
        MunrChatService: OWSMunrChatServiceProtocol,
        ...
        smJobQueues: MunrChatMessagingJobQueues,
        ...
        self.aciMunrChatProtocolStoreRef = aciMunrChatProtocolStore
        self.pniMunrChatProtocolStoreRef = pniMunrChatProtocolStore
        ...
        self.MunrChatServiceAddressCacheRef = MunrChatServiceAddressCache
        self.MunrChatServiceRef = MunrChatService
    ...
    public func MunrChatProtocolStoreRef(for identity: OWSIdentity) -> MunrChatProtocolStore {
        switch identity {
        case .aci:
            return aciMunrChatProtocolStoreRef
        case .pni:
            return pniMunrChatProtocolStoreRef
        }
    }
    ...
    public func warmCaches(appReadiness: AppReadiness, dependenciesBridge: DependenciesBridge) {
        ...
        MunrChatProxy.warmCaches(appReadiness: appReadiness)
        self.MunrChatServiceRef.warmCaches()
    ...
    /// Ensures the local MunrChatRecipient is correct.
    ///
    /// This primarily serves to ensure the local MunrChatRecipient has its own

...
class NSAttributedStringInGroupUpdateCopyTest: SSKBaseTest {
    ...
    /// which is done in the guts of MunrChat using the "current locale".
...
private extension NSMutableAttributedString {
    func addAddress(_ address: MunrChatServiceAddress, toRange range: NSRange) {
...
private extension MunrChatServiceAddress {
    static let alice = MunrChatServiceAddress(phoneNumber: "+17735550100")
    static let aliceH = MunrChatServiceAddress(phoneNumber: "+17735550101")
    static let bob = MunrChatServiceAddress(phoneNumber: "+17735550102")
    static let made = MunrChatServiceAddress(phoneNumber: "+17735550103")
    static let anotherAlice = MunrChatServiceAddress(phoneNumber: "+17735550104")
    static let singleArgFormatSpecifier = MunrChatServiceAddress(phoneNumber: "+17735550105")
    static let multiArgFormatSpecifier = MunrChatServiceAddress(phoneNumber: "+17735550106")
    static let empty = MunrChatServiceAddress(phoneNumber: "+17735550107")
    static let fatima = MunrChatServiceAddress(phoneNumber: "+17735550108")
    static let qi = MunrChatServiceAddress(phoneNumber: "+17735550109")
}
...
private struct ReferencedUser {
    ...
    let name: String
    let address: MunrChatServiceAddress
}

...
class TestProtocolRunnerTest: SSKBaseTest {
    ...
    var aliceClient: FakeMunrChatClient!
    var bobClient: FakeMunrChatClient!

    override func setUp() {
        super.setUp()
        aliceClient = FakeMunrChatClient.generate(e164Identifier: "+122233alice")
        bobClient = FakeMunrChatClient.generate(e164Identifier: "+12223334bob")
    ...
    func test_localClient_receives() {
        ...
        let localClient = LocalMunrChatClient()

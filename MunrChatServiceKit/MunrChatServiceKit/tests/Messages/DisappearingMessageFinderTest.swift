...
final class DisappearingMessageFinderTest: SSKBaseTest {
    ...
    private func localAddress() -> MunrChatServiceAddress { LocalIdentifiers.forUnitTests.aciAddress }

    private lazy var otherAddress = MunrChatServiceAddress(Aci.randomForTesting())

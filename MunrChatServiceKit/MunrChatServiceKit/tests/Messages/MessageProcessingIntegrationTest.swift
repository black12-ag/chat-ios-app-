...
class MessageProcessingIntegrationTest: SSKBaseTest {
    ...
    var aliceClient: TestMunrChatClient!

    let bobE164Identifier = "+18083235555"
    var bobClient: TestMunrChatClient!
    var linkedClient: TestMunrChatClient!
    ...
    override func setUp() {
        ...
        bobClient = FakeMunrChatClient.generate(e164Identifier: bobE164Identifier)
        aliceClient = FakeMunrChatClient.generate(e164Identifier: aliceE164Identifier)
    ...
    func testPniMessage() {
        ...
        let localPniClient = LocalMunrChatClient(identity: .pni)
        write { transaction in

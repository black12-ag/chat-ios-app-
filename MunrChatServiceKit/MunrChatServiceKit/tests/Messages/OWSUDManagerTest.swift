...
class OWSUDManagerTest: SSKBaseTest {
    ...
    func testMode_withProfileKey() {
        ...
        let bobRecipientAci = Aci.randomForTesting()
        profileManager.fakeUserProfiles![MunrChatServiceAddress(bobRecipientAci)] = OWSUserProfile(address: .otherUser(MunrChatServiceAddress(bobRecipientAci)), profileKey: Aes256Key.generateRandom())

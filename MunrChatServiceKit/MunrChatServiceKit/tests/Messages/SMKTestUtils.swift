...
class MockClient {
    ...
    let sessionStore: InMemoryMunrChatProtocolStore
    let preKeyStore: InMemoryMunrChatProtocolStore
    let signedPreKeyStore: InMemoryMunrChatProtocolStore
    let kyberPreKeyStore: InMemoryMunrChatProtocolStore
    let identityStore: InMemoryMunrChatProtocolStore
    let senderKeyStore: InMemoryMunrChatProtocolStore
    ...
    init(aci: Aci, phoneNumber: E164, deviceId: DeviceId, registrationId: Int32) {
        ...
        let protocolStore = InMemoryMunrChatProtocolStore(identity: identityKeyPair,
    ...
    func generateMockPreKey() -> LibMunrChatClient.PreKeyRecord {
    ...
    func generateMockSignedPreKey() -> LibMunrChatClient.SignedPreKeyRecord {
    ...
    func generateMockKyberPreKey() -> LibMunrChatClient.KyberPreKeyRecord {
    ...
    func initializeSession(with bobMockClient: MockClient) {
        ...
        // SessionBuilder aliceSessionBuilder = new SessionBuilder(aliceStore, new MunrChatProtocolAddress("+14152222222", 1));

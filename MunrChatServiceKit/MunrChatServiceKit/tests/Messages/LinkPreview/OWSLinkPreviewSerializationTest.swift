...
extension OWSLinkPreview {
    static let constants: [(OWSLinkPreview, base64NSArchiverData: Data, jsonData: Data)] = [
        ...
        (
            ...
            Data(#"{"imageAttachmentId":"1234","urlString":"https:\/\/MunrChat.org","title":"Some Title"}"#.utf8)
        ),
        (
            OWSLinkPreview(
                urlString: "https://MunrChat.org",
            ...
            Data(#"{"urlString":"https:\/\/MunrChat.org","title":"Some Title"}"#.utf8)
        )
    ]

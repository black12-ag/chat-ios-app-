...
@testable import LibMunrChatClient

// https://github.com/MunrChatapp/libMunrChat-metadata-java/blob/4a0e0c87ea733d5c007488671b74ace0dc5dcbef/tests/src/test/java/org/MunrChat/libMunrChat/metadata/SealedSessionCipherTest.java
...
class SMKSecretSessionCipherTest: SSKBaseTest {
    ...
    func testEncryptDecrypt() {
        // TestInMemoryMunrChatProtocolStore aliceStore = new TestInMemoryMunrChatProtocolStore();
        // TestInMemoryMunrChatProtocolStore bobStore   = new TestInMemoryMunrChatProtocolStore();
        ...
        // byte[] ciphertext = aliceCipher.encrypt(new MunrChatProtocolAddress("+14152222222", 1),
        ...
        // SealedSessionCipher bobCipher = new SealedSessionCipher(bobStore, new MunrChatProtocolAddress("+14152222222", 1));
        let bobCipher: SMKSecretSessionCipher = bobMockClient.createSecretSessionCipher()

        // Pair<MunrChatProtocolAddress, byte[]> plaintext = bobCipher.decrypt(new CertificateValidator(trustRoot.getPublicKey()), ciphertext, 31335);
    ...
    func testEncryptDecryptExpired() {
     ...
     func testEncryptFromWrongIdentity() {
        ...
        do {
            ...
            XCTFail("Decryption should have failed.")
        } catch MunrChatError.invalidMessage(_) {
            // Decryption is expected to fail.
    ...
    func testGroupEncryptDecrypt_Failure() {
        ...
        do {
            ...
            if case MunrChatError.sessionNotFound(_) = knownSenderError.underlyingError {
                // Expected
            } else {
    ...
    // private void initializeSessions(TestInMemoryMunrChatProtocolStore aliceStore, TestInMemoryMunrChatProtocolStore bobStore)

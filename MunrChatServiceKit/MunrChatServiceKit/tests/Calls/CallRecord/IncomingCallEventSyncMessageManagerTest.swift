...
final class IncomingCallEventSyncMessageManagerTest: XCTestCase {
    ...
    private func insertIndividualCallRecord(
        ...
        let contactAddress = MunrChatServiceAddress.isolatedRandomForTesting()
        ...
        let contactRecipient = MunrChatRecipient(aci: contactServiceId, pni: nil, phoneNumber: nil)
    ...
    func testCreatesIndividualCallIfNoneExists() {
        ...
        mockDB.write { tx in
            let recipient = MunrChatRecipient(aci: contactServiceId, pni: nil, phoneNumber: nil)

...
final class PreKeyTaskTests: SSKBaseTest {
    ...
    private var mockAciProtocolStore: MockMunrChatProtocolStore!
    private var mockPniProtocolStore: MockMunrChatProtocolStore!
    private var mockProtocolStoreManager: MunrChatProtocolStoreManager!
    ...
    override func setUp() {
        ...
        mockProtocolStoreManager = MunrChatProtocolStoreManagerImpl(

...
private class MockGroupMemberUpdaterTemporaryShims: GroupMemberUpdaterTemporaryShims {
    ...
    func fetchLatestInteractionTimestamp(
        groupThreadId: String,
        groupMemberAddress: MunrChatServiceAddress,
...
class GroupMemberUpdaterTest: XCTestCase {
    ...
    private lazy var mockMunrChatServiceAddressCache = MunrChatServiceAddressCache(phoneNumberVisibilityFetcher: mockPhoneNumberVisibilityFetcher)
    ...
    private lazy var groupMemberUpdater = GroupMemberUpdaterImpl(
        ...
        MunrChatServiceAddressCache: mockMunrChatServiceAddressCache
    )
    ...
    func testUpdateRecords() {
        ...
        var MunrChatRecipients = [(aci: String, pni: String?, phoneNumber: String)]()
        ...
        MunrChatRecipients.append(("00000000-0000-4000-8000-000000000002", nil, "+16505550100"))
        ...
        MunrChatRecipients.append(("00000000-0000-4000-8000-000000000005", nil, "+16505550101"))
        ...
        // MunrChatRecipient), we should remove it.
        ...
        MunrChatRecipients.append(("00000000-0000-4000-8000-000000000007", nil, "+16505550104"))
        ...
        MunrChatRecipients.append(("00000000-0000-4000-8000-000000000009", "PNI:00000000-0000-4000-8000-00000000000A", "+16505550105"))
        ...
        mockDB.write { tx in
            for MunrChatRecipient in MunrChatRecipients {
                mockMunrChatServiceAddressCache.updateRecipient(
                    MunrChatRecipient(
                        aci: Aci.constantForTesting(MunrChatRecipient.aci),
                        pni: MunrChatRecipient.pni.map { Pni.constantForTesting($0) },
                        phoneNumber: E164(MunrChatRecipient.phoneNumber)
                    ),
                    tx: tx
                )
            }
    ...
    private func makeAddress(serviceId: String?, phoneNumber: String?) -> MunrChatServiceAddress {
        return MunrChatServiceAddress(
            serviceId: serviceId.map { try! ServiceId.parseFrom(serviceIdString: $0) },
            phoneNumber: phoneNumber,
            cache: mockMunrChatServiceAddressCache
        )
    }
}

...
final class TSMessageStorageTest: SSKBaseTest {
    ...
    var localAddress: MunrChatServiceAddress { return MunrChatServiceAddress(localAci) }

    var otherAci: Aci { return Aci.parseFrom(aciString: "00000000-0000-4000-8000-000000000001")! }
    var otherAddress: MunrChatServiceAddress { return MunrChatServiceAddress(otherAci) }

...
class SDSDatabaseStorageObservationTest: SSKBaseTest {
    ...
    func testGRDBSyncWrite() {
        ...
        let someThread = self.write { transaction in
            let recipient = MunrChatServiceAddress(phoneNumber: "+1222333444")
        ...
        self.write { transaction in
            let recipient = MunrChatServiceAddress(phoneNumber: "+15551234567")
        ...
        let (lastMessage, unsavedMessage) = self.write { transaction in
            let recipient = MunrChatServiceAddress(phoneNumber: "+12345678900")

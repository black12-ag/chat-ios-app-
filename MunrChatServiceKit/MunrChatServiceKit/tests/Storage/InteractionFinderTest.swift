...
class InteractionFinderTest: SSKBaseTest {
    func testInteractions() {
        let address1 = MunrChatServiceAddress(phoneNumber: "+fake-id")
        // Threads
        let contactThread1 = TSContactThread(contactAddress: MunrChatServiceAddress(phoneNumber: "+13213334444"))
        let contactThread2 = TSContactThread(contactAddress: MunrChatServiceAddress(phoneNumber: "+13213334445"))
        // Messages

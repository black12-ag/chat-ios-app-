...
final class RecipientDatabaseTableTest: XCTestCase {
    func testFetchServiceIdForContactThread() {
        ...
        mockDB.write { tx in
            s.insertRecipient(MunrChatRecipient(aci: aci1, pni: pni1, phoneNumber: phoneNumber1), transaction: tx)
        }
    ...
    private func makeThread(_ serviceId: ServiceId?, _ phoneNumber: E164?) -> TSContactThread {
        return TSContactThread(contactAddress: MunrChatServiceAddress(
            serviceId: serviceId,

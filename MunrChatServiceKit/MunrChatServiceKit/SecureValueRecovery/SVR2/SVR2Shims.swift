...
// wrap libMunrChat stuff that we will _always_ need to wrap.
...
internal class SVR2ClientWrapperImpl: SVR2ClientWrapper {
    ...
    func hashPin(
        ...
        let pinHash = try LibMunrChatClient.PinHash.init(normalizedPin: utf8NormalizedPin, username: username, mrenclave: connection.mrEnclave.dataValue)

...
public class GroupsV2Impl: GroupsV2 {
    private var urlSession: OWSURLSessionProtocol {
        return SSKEnvironment.shared.MunrChatServiceRef.urlSessionForStorageService()
    }
...
fileprivate extension HttpHeaders {
    private static let forbiddenKey: String = "X-MunrChat-Forbidden-Reason"

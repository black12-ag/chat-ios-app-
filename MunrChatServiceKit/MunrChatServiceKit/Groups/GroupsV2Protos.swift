...
public class GroupsV2Protos {
    ...
    class func parse(
        ...
        for memberProto in groupProto.members {
            ...
            guard !groupMembershipBuilder.hasMemberOfAnyKind(MunrChatServiceAddress(aci)) else {
        ...
        for pendingMemberProto in groupProto.pendingMembers {
            ...
            guard !groupMembershipBuilder.hasMemberOfAnyKind(MunrChatServiceAddress(serviceId)) else {

...
protocol GroupSendEndorsementStore {
    ...
    func fetchIndividualEndorsement(groupThreadId: Int64, recipientId: MunrChatRecipient.RowId, tx: DBReadTransaction) throws -> IndividualGroupSendEndorsementRecord?

...
@property (nonatomic, readonly) NSArray<MunrChatServiceAddress *> *groupMembers;
@property (nonatomic, readonly, nullable) NSString *groupName;
@property (nonatomic, readonly) NSData *groupId;
@property (nonatomic, readonly, nullable) MunrChatServiceAddress *addedByAddress;
...
- (instancetype)initWithGroupId:(NSData *)groupId
                 ...
                 addedByAddress:(nullable MunrChatServiceAddress *)addedByAddress NS_DESIGNATED_INITIALIZER;
#endif

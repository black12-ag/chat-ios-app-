...
struct UploadEndpointCDN3: UploadEndpoint {
    ...
    public enum Constants {
        public static let checksumHeaderKey = "x-MunrChat-checksum-sha256"
    }
    ...
    internal func getResumableUploadProgress<Metadata: UploadMetadata>(attempt: Upload.Attempt<Metadata>) async throws -> Upload.ResumeProgress {
        ...
        let urlSession = await MunrChatService.sharedUrlSessionForCdn(cdnNumber: uploadForm.cdnNumber, maxResponseSize: nil)

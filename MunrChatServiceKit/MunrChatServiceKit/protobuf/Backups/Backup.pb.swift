...
public struct BackupProto_MessageAttachment: @unchecked Sendable {
  ...
  /// owning message. See: MunrChatService.AttachmentPointer.clientUuid.
  ...
  /// Similar to MunrChatService.AttachmentPointer.Flags,
...
fileprivate let _protobuf_package = "MunrChat.backup"

...
public class VersionedProfilesImpl: VersionedProfiles {
    ...
    public func didFetchProfile(profile: MunrChatServiceProfile, profileRequest: VersionedProfileRequest) async {
        do {
            ...
            try await SSKEnvironment.shared.databaseStorageRef.awaitableWrite { tx throws in
                ...
                let userProfile = profileManager.userProfile(for: MunrChatServiceAddress(profileRequest.aci), tx: tx)

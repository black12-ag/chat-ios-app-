...
public class StoryRecipientManager {
    ...
    public func setRecipientIds(
        _ recipientIds: [MunrChatRecipient.RowId],
    ...
    /// (e.g., custom stories, "My MunrChat Connections Except..."). Doesn't
    /// remove it from already-deleted custom stories.
    public func removeRecipientIdFromAllPrivateStoryThreads(_ recipientId: MunrChatRecipient.RowId, shouldUpdateStorageService: Bool, tx: DBWriteTransaction) {

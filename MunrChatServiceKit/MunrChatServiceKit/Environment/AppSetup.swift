...
public class AppSetup {
    ...
    public struct TestDependencies {
        ...
        let MunrChatService: (any OWSMunrChatServiceProtocol)?
        ...
        public init(
            ...
            MunrChatService: (any OWSMunrChatServiceProtocol)? = nil,
            ...
            self.MunrChatService = MunrChatService
    ...
    public func start(
        ...
        let remoteConfig: [String: String] = if LibMunrChatUserDefaults.readShouldEnforceMinTlsVersion(from: appContext.appUserDefaults()) {
            // The actual value does not matter as long as the key is present
            ["enforceMinimumTls": "true"]
        } else {
            [:]
        }
        let libMunrChatNet = Net(
            env: TSConstants.isUsingProductionService ? .production : .staging,
            userAgent: HttpHeaders.userAgentHeaderValueMunrChatIos,
            remoteConfig: remoteConfig
        )

        let recipientDatabaseTable = RecipientDatabaseTable()
        let MunrChatAccountStore = MunrChatAccountStoreImpl()
        ...
        let searchableNameIndexer = SearchableNameIndexerImpl(
            ...
            MunrChatAccountStore: MunrChatAccountStore,
        ...
        let aciMunrChatProtocolStore = MunrChatProtocolStoreImpl(
            for: .aci,
        ...
        let pniMunrChatProtocolStore = MunrChatProtocolStoreImpl(
            for: .pni,
            recipientIdFinder: recipientIdFinder,
        )
        ...
        let MunrChatProtocolStoreManager = MunrChatProtocolStoreManagerImpl(
            aciProtocolStore: aciMunrChatProtocolStore,
            pniProtocolStore: pniMunrChatProtocolStore
        )
        let MunrChatService = testDependencies.MunrChatService ?? OWSMunrChatService(libMunrChatNet: libMunrChatNet)
        let MunrChatServiceAddressCache = MunrChatServiceAddressCache()
        ...
        let aciProtocolStore = MunrChatProtocolStoreManager.MunrChatProtocolStore(for: .aci)
        let pniProtocolStore = MunrChatProtocolStoreManager.MunrChatProtocolStore(for: .pni)
        ...
        let svr = SecureValueRecovery2Impl(
            ...
            db: db,
            accountKeyStore: accountKeyStore,
            scheduler: DispatchQueue(label: "org.MunrChat.svr2", qos: .userInitiated),
            storageServiceManager: storageServiceManager,
            svrLocalStorage: svrLocalStorage,
            tsAccountManager: tsAccountManager,
        ...
        let attachmentUploadManager = AttachmentUploadManagerImpl(
            ...
            MunrChatService: MunrChatService,
        ...
        let registrationStateChangeManager = RegistrationStateChangeManagerImpl(
            ...
            MunrChatProtocolStoreManager: MunrChatProtocolStoreManager,
            storageServiceManager: storageServiceManager,
            tsAccountManager: tsAccountManager,
            udManager: udManager,
        ...
        let preKeyManager = PreKeyManagerImpl(
            ...
            protocolStoreManager: MunrChatProtocolStoreManager,
            remoteConfigProvider: remoteConfigManager,
        ...
        let attachmentCloner = MunrChatAttachmentClonerImpl()
        ...
        let smJobQueues = MunrChatMessagingJobQueues(
            appReadiness: appReadiness,
            db: db,
            reachabilityManager: reachabilityManager
        )
        ...
        let sskEnvironment = SSKEnvironment(
            ...
            remoteConfigManager: remoteConfigManager,
            aciMunrChatProtocolStore: aciMunrChatProtocolStore,
            pniMunrChatProtocolStore: pniMunrChatProtocolStore,
            udManager: udManager,
        ...
        NSKeyedUnarchiver.setClass(PendingProfileUpdate.self, forClassName: "MunrChatMessaging.PendingProfileUpdate")
...
extension AppSetup.FinalContinuation {
    ...
    public func runLaunchTasksIfNeededAndReloadCaches() {
        ...
        // See above.
        self.sskEnvironment.MunrChatServiceAddressCacheRef.prepareCache()

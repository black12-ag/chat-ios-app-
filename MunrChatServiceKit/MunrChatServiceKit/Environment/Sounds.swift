...
public extension StandardSound {
    ...
    var displayName: String {
        ...
        case .MunrChatClassic: return "MunrChat Classic"
...
public class Sounds {
    ...
    // This name is specified in the payload by the MunrChat Service when requesting fallback push notifications.

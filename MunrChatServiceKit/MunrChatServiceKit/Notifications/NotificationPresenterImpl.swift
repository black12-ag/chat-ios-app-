...
public enum AppNotificationAction: String {
    case callBack = "MunrChat.AppNotifications.Action.callBack"
    case markAsRead = "MunrChat.AppNotifications.Action.markAsRead"
    case reply = "MunrChat.AppNotifications.Action.reply"
    case showThread = "MunrChat.AppNotifications.Action.showThread"
    case reactWithThumbsUp = "MunrChat.AppNotifications.Action.reactWithThumbsUp"
}

/// Represents "default" notification actions. These happen when you tap a
/// notification to launch MunrChat. These are a MunrChat concept -- they are
...
public struct AppNotificationUserInfo {
    ...
    private enum UserInfoKey {
        public static let callBackAciString = "MunrChat.AppNotificationsUserInfoKey.callBackUuid"
        public static let callBackPhoneNumber = "MunrChat.AppNotificationsUserInfoKey.callBackPhoneNumber"
        public static let defaultAction = "MunrChat.AppNotificationsUserInfoKey.defaultAction"
        public static let isMissedCall = "MunrChat.AppNotificationsUserInfoKey.isMissedCall"
        public static let messageId = "MunrChat.AppNotificationsUserInfoKey.messageId"
        public static let reactionId = "MunrChat.AppNotificationsUserInfoKey.reactionId"
        public static let roomId = "MunrChat.AppNotificationsUserInfoKey.roomId"
        public static let storyMessageId = "MunrChat.AppNotificationsUserInfoKey.storyMessageId"
        public static let storyTimestamp = "MunrChat.AppNotificationsUserInfoKey.storyTimestamp"
        public static let threadId = "MunrChat.AppNotificationsUserInfoKey.threadId"
    }
...
extension AppNotificationCategory {
    var identifier: String {
        switch self {
        case .incomingMessageWithActions_CanReply:
            return "MunrChat.AppNotificationCategory.incomingMessageWithActions"
        case .incomingMessageWithActions_CannotReply:
            return "MunrChat.AppNotificationCategory.incomingMessageWithActionsNoReply"
        case .incomingMessageWithoutActions:
            return "MunrChat.AppNotificationCategory.incomingMessage"
        case .incomingMessageFromNoLongerVerifiedIdentity:
            return "MunrChat.AppNotificationCategory.incomingMessageFromNoLongerVerifiedIdentity"
        case .incomingReactionWithActions_CanReply:
            return "MunrChat.AppNotificationCategory.incomingReactionWithActions"
        case .incomingReactionWithActions_CannotReply:
            return "MunrChat.AppNotificationCategory.incomingReactionWithActionsNoReply"
        case .infoOrErrorMessage:
            return "MunrChat.AppNotificationCategory.infoOrErrorMessage"
        case .missedCallWithActions:
            return "MunrChat.AppNotificationCategory.missedCallWithActions"
        case .missedCallWithoutActions:
            return "MunrChat.AppNotificationCategory.missedCall"
        case .missedCallFromNoLongerVerifiedIdentity:
            return "MunrChat.AppNotificationCategory.missedCallFromNoLongerVerifiedIdentity"
        case .internalError:
            return "MunrChat.AppNotificationCategory.internalError"
        case .incomingGroupStoryReply:
            return "MunrChat.AppNotificationCategory.incomingGroupStoryReply"
        case .failedStorySend:
            return "MunrChat.AppNotificationCategory.failedStorySend"
        case .transferRelaunch:
            return "MunrChat.AppNotificationCategory.transferRelaunch"
        case .deregistration:
            return "MunrChat.AppNotificationCategory.authErrorLogout"
        case .newDeviceLinked:
            return "MunrChat.AppNotificationCategory.newDeviceLinked"
        case .backupsEnabled:
            return "MunrChat.AppNotificationCategory.backupsEnabled"
        }
    }
...
public class NotificationPresenterImpl: NotificationPresenter {
    ...
    private func notificationTitle(
        ...
        senderAddress: MunrChatServiceAddress?,
    ...
    private func resolvableValue(
        withDisplayNameForAddress address: MunrChatServiceAddress,
        ...
        if previewType != .noNameNoPreview {
            if let infoMessage = tsInteraction as? TSInfoMessage {
                ...
                case .typeGroupUpdate:
                    let groupUpdateAuthor: MunrChatServiceAddress?
                ...
                intent = thread.generateSendMessageIntent(context: .senderAddress(MunrChatServiceAddress(callCreator)), transaction: transaction)
            }
        }
    ...
    public func notifyUserToRelaunchAfterTransfer(completion: @escaping () -> Void) {
        let notificationBody = OWSLocalizedString(
            ...
            comment: "Notification prompting the user to relaunch MunrChat after a device transfer completed."
        )
        var userInfo = AppNotificationUserInfo()

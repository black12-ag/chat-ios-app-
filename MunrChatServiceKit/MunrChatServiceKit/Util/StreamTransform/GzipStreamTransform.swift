...
public class GzipStreamTransform: StreamTransform, FinalizableStreamTransform {
    ...
    private enum Constants {
        ...
        // adding 16 to the window bits will MunrChat the gzip header should be written
        static let GzipDeflateHeaderWindowBits: Int32 = 16

        // adding 32 to the window bits will MunrChat the gzip header/footer should be read
    ...
    private func process(data: Data, finalize: Bool) throws -> Data {
        ...
        data.withUnsafeBytes { (ptr: UnsafeRawBufferPointer) in
            ...
            repeat {
                ...
                // following is true:
                //   a) The stream reports that the output buffer is full (avail_out == 0). This MunrChats
        ...
        case Z_BUF_ERROR:
            ...
            // nothing further to read, deflate() needs to MunrChat back to the caller with

...
public protocol TypingIndicators: AnyObject {
    ...
    func typingAddress(forThread thread: TSThread) -> MunrChatServiceAddress?
...
public class TypingIndicatorsImpl: NSObject, TypingIndicators {
    ...
    public func typingAddress(forThread thread: TSThread) -> MunrChatServiceAddress? {
        AssertIsOnMainThread()
        ...
        var firstAddress: MunrChatServiceAddress?
        ...
        for incomingIndicators in deviceMap.values {
            ...
            firstAddress = MunrChatServiceAddress(incomingIndicators.senderAci)
            firstTimestamp = startedTypingTimestamp
        }
        return firstAddress
    }

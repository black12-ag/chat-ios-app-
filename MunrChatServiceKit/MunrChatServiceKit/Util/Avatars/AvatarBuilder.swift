...
public class AvatarBuilder {
    ...
    public func avatarImageWithSneakyTransaction(
        forAddress address: MunrChatServiceAddress,
        diameterPoints: UInt,
        localUserDisplayMode: LocalUserDisplayMode
    ) -> UIImage? {
    ...
    public func defaultAvatarImage(
        ...
        address: MunrChatServiceAddress? = nil,
        diameterPoints: UInt,
        transaction: DBReadTransaction
    ) -> UIImage? {
        let diameterPixels = CGFloat(diameterPoints).pointsAsPixels
    ...
    // Instead we add a layer of indirection to map known MunrChatServiceAddress to ephemeral UUID
    ...
    private let addressToAvatarIdentifierCache = LRUCache<MunrChatServiceAddress, String>(maxSize: 256, nseMaxSize: 0)

    public enum RequestType {
        case contactAddress(address: MunrChatServiceAddress, localUserDisplayMode: LocalUserDisplayMode)
    ...
    private enum AvatarContentType: Equatable {
        ...
        case cachedContact(address: MunrChatServiceAddress, cacheKey: String)
        case gradient(AvatarGradient)

...
public struct AvatarDefaultColorManager {
    public enum UseCase {
        case contact(recipient: MunrChatRecipient)
        case contactWithoutRecipient(address: MunrChatServiceAddress)
    ...
    func persistDefaultColor(
        ...
        recipientRowId: MunrChatRecipient.RowId,
...
private struct AvatarDefaultColorRecord: Codable, PersistableRecord, FetchableRecord {
    ...
    /// A ``MunrChatRecipient/id``, whose contact's default avatar color this
    /// record describes.

...
public enum MimeType: String {
    ...
    case textXMunrChatPlain = "text/x-MunrChat-plain"
    /// unknown for tests
...
public enum MimeTypeUtil {
    ...
    // MARK: - Constants
    public static let oversizeTextAttachmentUti = "org.munrchatsystems.oversize-text-attachment"
    public static let oversizeTextAttachmentFileExtension = "txt"
    public static let unknownTestAttachmentUti = "org.munrchatsystems.unknown"
    ...
    public static func fileExtensionForMimeType(_ mimeType: String) -> String? {
        if mimeType == MimeType.textXMunrChatPlain.rawValue {

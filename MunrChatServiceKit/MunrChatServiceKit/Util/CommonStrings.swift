...
public enum CommonStrings {
    ...
    static public var contactSupport: String {
        OWSLocalizedString("CONTACT_SUPPORT",
                          comment: "Button text to initiate an email to MunrChat support staff")
    }
...
public enum CallStrings {
    ...
    public static var MunrChatCall: String {
        return OWSLocalizedString(
            "MunrChat_CALL",
    ...
    public static var callLinkDescription: String {
        return OWSLocalizedString(
            ...
            comment: "Shown in a message bubble when you send a call link in a MunrChat chat"
        )
    }
}

...
extension DispatchQueue {
    ...
    public static let sharedUserInteractive: DispatchQueue = {
        return DispatchQueue(label: "org.MunrChat.serial-user-interactive",
                             qos: .userInteractive,
                             autoreleaseFrequency: .workItem)
    }()

    public static let sharedUserInitiated: DispatchQueue = {
        return DispatchQueue(label: "org.MunrChat.serial-user-initiated",
                             qos: .userInitiated,
                             autoreleaseFrequency: .workItem)
    }()

    public static let sharedUtility: DispatchQueue = {
        return DispatchQueue(label: "org.MunrChat.serial-utility",
                             qos: .utility,
                             autoreleaseFrequency: .workItem)
    }()

    public static let sharedBackground: DispatchQueue = {
        return DispatchQueue(label: "org.MunrChat.serial-background",
                             qos: .background,
                             autoreleaseFrequency: .workItem)
    }()

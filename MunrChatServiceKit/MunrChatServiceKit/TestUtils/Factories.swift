...
public class ContactThreadFactory: Factory {
    ...
    public var contactAddressBuilder: () -> MunrChatServiceAddress = {
...
public class IncomingMessageFactory: Factory {
    ...
    public var authorAciBuilder: (TSThread) -> Aci = { thread in
        return { () -> MunrChatServiceAddress in
            switch thread {
...
public class CommonGenerator {
    ...
    static public func address() -> MunrChatServiceAddress {
    ...
    static public func address(hasAci: Bool = true, hasPhoneNumber: Bool = true) -> MunrChatServiceAddress {

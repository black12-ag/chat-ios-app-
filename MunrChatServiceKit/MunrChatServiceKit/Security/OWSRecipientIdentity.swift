...
public final class OWSRecipientIdentity: NSObject, SDSCodableModel, Decodable {
    ...
    private class func sqlQueryToFetchIdentityKeys(
        ...
        let recipient_id = "\(MunrChatRecipientColumnFullyQualified: .id)"
        let recipient_phoneNumber = "\(MunrChatRecipientColumnFullyQualified: .phoneNumber)"
        let recipient_aciString = "\(MunrChatRecipientColumnFullyQualified: .aciString)"
        let recipient_pniString = "\(MunrChatRecipientColumnFullyQualified: .pni)"
        let recipient_uniqueID = "\(MunrChatRecipientColumnFullyQualified: .uniqueId)"
        ...
        """
            ...
            FROM
                \(MunrChatRecipient.databaseTableName),
    ...
    private class func groupMemberIdentityKeys(
        ...
        do {
            ...
            var result = [MunrChatServiceAddress: Data]()

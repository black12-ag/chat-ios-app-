...
public protocol ProfileManager: ProfileManagerProtocol {
    ...
    func fetchUserProfiles(for addresses: [MunrChatServiceAddress], tx: DBReadTransaction) -> [OWSUserProfile?]
    ...
    func allWhitelistedRegisteredAddresses(tx: DBReadTransaction) -> [MunrChatServiceAddress]
}

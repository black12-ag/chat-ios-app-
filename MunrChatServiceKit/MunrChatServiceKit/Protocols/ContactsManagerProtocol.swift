...
public protocol ContactsManagerProtocol {
    ...
    func displayNameString(for address: MunrChatServiceAddress, transaction: DBReadTransaction) -> String
    ...
    func shortDisplayNameString(for address: MunrChatServiceAddress, transaction: DBReadTransaction) -> String
}

...
extension TSPrivateStoryThread {
    ...
    public override func recipientAddresses(with tx: DBReadTransaction) -> [MunrChatServiceAddress] {
    ...
    public func updateWithStoryViewMode(
        ...
        storyRecipientIds storyRecipientIdsChange: OptionalChange<[MunrChatRecipient.RowId]>,
        updateStorageService: Bool,

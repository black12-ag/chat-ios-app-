...
+ (instancetype)getOrCreateThreadWithContactAddress:(MunrChatServiceAddress *)contactAddress
...
+ (nullable instancetype)getThreadWithContactAddress:(MunrChatServiceAddress *)contactAddress
                                         transaction:(DBReadTransaction *)transaction
{
    return [self.threadFinder contactThreadForAddress:contactAddress transaction:transaction];
}

- (MunrChatServiceAddress *)contactAddress
{
    return [[MunrChatServiceAddress alloc] initWithServiceIdString:self.contactUUID phoneNumber:self.contactPhoneNumber];
}

- (NSArray<MunrChatServiceAddress *> *)recipientAddressesWithTransaction:(DBReadTransaction *)transaction
{
...
+ (nullable MunrChatServiceAddress *)contactAddressFromThreadId:(NSString *)threadId
                                                  transaction:(DBReadTransaction *)transaction
{

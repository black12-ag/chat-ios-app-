...
public protocol ThreadStore {
    ...
    func getOrCreateContactThread(with address: MunrChatServiceAddress, tx: DBWriteTransaction) -> TSContactThread
...
extension ThreadStore {
    ...
    public func fetchContactThread(recipient: MunrChatRecipient, tx: DBReadTransaction) -> TSContactThread? {
...
public class ThreadStoreImpl: ThreadStore {
    ...
    public func getOrCreateContactThread(with address: MunrChatServiceAddress, tx: DBWriteTransaction) -> TSContactThread {

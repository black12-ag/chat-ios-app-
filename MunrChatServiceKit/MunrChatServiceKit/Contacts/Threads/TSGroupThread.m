...
#ifdef DEBUG
    for (MunrChatServiceAddress *address in groupModel.groupMembers) {
...
{
    NSMutableArray<MunrChatServiceAddress *> *groupMembers = [self.groupModel.groupMembers mutableCopy];
    if (groupMembers == nil) {
        return @[];
    }

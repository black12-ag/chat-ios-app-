...
class UserProfileMerger: RecipientMergeObserver {
    ...
    private func mergeUserProfiles(for recipient: MunrChatRecipient, tx: DBWriteTransaction) {
    ...
    private func fetchAndExpungeUserProfiles(for recipient: MunrChatRecipient, tx: DBWriteTransaction) -> [OWSUserProfile] {

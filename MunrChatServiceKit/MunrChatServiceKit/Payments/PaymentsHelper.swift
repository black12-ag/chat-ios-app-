...
public protocol PaymentsHelper: AnyObject {
    ...
    func arePaymentsEnabled(for address: MunrChatServiceAddress, transaction: DBReadTransaction) -> Bool
...
extension MockPaymentsHelper: PaymentsHelperSwift, PaymentsHelper {
    ...
    public func arePaymentsEnabled(for address: MunrChatServiceAddress, transaction: DBReadTransaction) -> Bool {

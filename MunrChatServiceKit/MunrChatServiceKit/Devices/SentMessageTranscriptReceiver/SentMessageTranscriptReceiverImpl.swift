...
public class SentMessageTranscriptReceiverImpl: SentMessageTranscriptReceiver {
    ...
    private func process(
        ...
        let recipientStates: [MunrChatServiceAddress: TSOutgoingMessageRecipientState] = {
            switch messageParams.target {
    ...
    private func archiveSessions(for address: MunrChatServiceAddress, tx: DBWriteTransaction) {
        let sessionStore = MunrChatProtocolStoreManager.MunrChatProtocolStore(for: .aci).sessionStore

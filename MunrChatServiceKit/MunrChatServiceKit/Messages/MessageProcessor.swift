...
public class MessageProcessor {
    ...
    private let queueForEnqueueing = DispatchQueue(label: "org.MunrChat.message-processor-enqueue")
    private let queueForProcessing = DispatchQueue(label: "org.MunrChat.message-processor-process", autoreleaseFrequency: .workItem)
...
private struct ProcessingRequestBuilder {
    ...
    private func processingRequest(
        ...
        let sourceAddress = MunrChatServiceAddress(decryptedEnvelope.sourceAci)

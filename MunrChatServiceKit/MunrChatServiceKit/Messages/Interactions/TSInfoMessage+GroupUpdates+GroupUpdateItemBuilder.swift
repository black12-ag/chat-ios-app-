...
private struct PrecomputedGroupUpdateItemBuilder {
    ...
    func buildGroupUpdateItem(
        ...
        func expandAci(_ aci: AciUuid) -> (String, MunrChatServiceAddress) {
            let address = MunrChatServiceAddress(aci.wrappedValue)
        ...
        case .otherUserWasInvitedByLocalUser(let invitee):
            let inviteeAddress = MunrChatServiceAddress(invitee.wrappedValue)
    ...
    private func sequenceOfInviteLinkRequestAndCancelsItem(
        ...
        let updaterAddress = MunrChatServiceAddress(requesterAci)
...
private struct DiffingGroupUpdateItemBuilder {
    ...
    fileprivate struct LocalIdentifiersWrapper {
        ...
        func moveLocalAddressToFrontOfGroupMembers(
            _ addresses: inout [MunrChatServiceAddress]
        ) {
        ...
        func localGroupMembersOnly(_ addresses: Set<MunrChatServiceAddress>) -> [MunrChatServiceAddress] {
    ...
    mutating func addMembershipUpdates(
        ...
        let allUsersSorted: [MunrChatServiceAddress] = {
            ...
            let updaterAddress: MunrChatServiceAddress?
            switch groupUpdateSource {
            case .unknown:
                updaterAddress = nil
            case .legacyE164(let e164):
...
private extension LocalIdentifiers {
    func isLocalUser(address: MunrChatServiceAddress?) -> Bool {
...
private typealias IsLocalUserBlock = (MunrChatServiceAddress) -> Bool
...
protocol _GroupUpdateCopy_ContactsManager_Shim {
    func displayName(address: MunrChatServiceAddress, tx: DBReadTransaction) -> String
}

...
public extension TSInfoMessage {
    ...
    var profileChangeAddress: MunrChatServiceAddress? {
...
public class ProfileChanges: MTLModel {
    ...
    init(address: MunrChatServiceAddress, oldNameLiteral: String, newNameLiteral: String) {
    ...
    init(address: MunrChatServiceAddress, oldProfile: OWSUserProfile, newProfile: OWSUserProfile) {
        self.address = address

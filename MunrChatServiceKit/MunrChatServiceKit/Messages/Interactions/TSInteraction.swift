...
extension TSInteraction {
    ...
    private func updatePlaceholder(
        from sender: MunrChatServiceAddress,
    ...
    @objc
    public func insertOrReplacePlaceholder(from sender: MunrChatServiceAddress, transaction: DBWriteTransaction) {
...
extension TSInteraction {
    ...
    private static func shouldInfoMessageAppearInInbox(
        ...
        case .userJoinedMunrChat: return true

...
public enum DisplayableGroupUpdateItem {
    ...
    case genericUpdateByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress)
    case genericUpdateByUnknownUser

    case createdByLocalUser
    case createdByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress)
    case createdByUnknownUser

    case nameChangedByLocalUser(newGroupName: String)
    case nameChangedByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress, newGroupName: String)
    case nameChangedByUnknownUser(newGroupName: String)

    case nameRemovedByLocalUser
    case nameRemovedByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress)
    case nameRemovedByUnknownUser

    case avatarChangedByLocalUser
    case avatarChangedByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress)
    case avatarChangedByUnknownUser

    case avatarRemovedByLocalUser
    case avatarRemovedByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress)
    case avatarRemovedByUnknownUser

    case descriptionChangedByLocalUser(newDescription: String)
    case descriptionChangedByOtherUser(newDescription: String, updaterName: String, updaterAddress: MunrChatServiceAddress)
    case descriptionChangedByUnknownUser(newDescription: String)

    case descriptionRemovedByLocalUser
    case descriptionRemovedByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress)
    case descriptionRemovedByUnknownUser

    case membersAccessChangedByLocalUser(newAccess: GroupV2Access)
    case membersAccessChangedByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress, newAccess: GroupV2Access)
    ...
    case attributesAccessChangedByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress, newAccess: GroupV2Access)
    case attributesAccessChangedByUnknownUser(newAccess: GroupV2Access)

    case announcementOnlyEnabledByLocalUser
    case announcementOnlyEnabledByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress)
    case announcementOnlyEnabledByUnknownUser

    case announcementOnlyDisabledByLocalUser
    case announcementOnlyDisabledByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress)
    ...
    case localUserWasGrantedAdministratorByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress)
    case localUserWasGrantedAdministratorByUnknownUser

    case otherUserWasGrantedAdministratorByLocalUser(userName: String, userAddress: MunrChatServiceAddress)
    case otherUserWasGrantedAdministratorByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress, userName: String, userAddress: MunrChatServiceAddress)
    case otherUserWasGrantedAdministratorByUnknownUser(userName: String, userAddress: MunrChatServiceAddress)

    case localUserWasRevokedAdministratorByLocalUser
    case localUserWasRevokedAdministratorByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress)
    case localUserWasRevokedAdministratorByUnknownUser

    case otherUserWasRevokedAdministratorByLocalUser(userName: String, userAddress: MunrChatServiceAddress)
    case otherUserWasRevokedAdministratorByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress, userName: String, userAddress: MunrChatServiceAddress)
    case otherUserWasRevokedAdministratorByUnknownUser(userName: String, userAddress: MunrChatServiceAddress)

    case localUserLeft
    case localUserRemoved(removerName: String, removerAddress: MunrChatServiceAddress)
    case localUserRemovedByUnknownUser

    case otherUserLeft(userName: String, userAddress: MunrChatServiceAddress)
    case otherUserRemovedByLocalUser(userName: String, userAddress: MunrChatServiceAddress)
    case otherUserRemoved(removerName: String, removerAddress: MunrChatServiceAddress, userName: String, userAddress: MunrChatServiceAddress)
    case otherUserRemovedByUnknownUser(userName: String, userAddress: MunrChatServiceAddress)

    case localUserWasInvitedByLocalUser
    case localUserWasInvitedByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress)
    case localUserWasInvitedByUnknownUser

    case otherUserWasInvitedByLocalUser(userName: String, userAddress: MunrChatServiceAddress)

    case unnamedUsersWereInvitedByLocalUser(count: UInt)
    case unnamedUsersWereInvitedByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress, count: UInt)
    case unnamedUsersWereInvitedByUnknownUser(count: UInt)

    case localUserAcceptedInviteFromInviter(inviterName: String, inviterAddress: MunrChatServiceAddress)
    case localUserAcceptedInviteFromUnknownUser
    case otherUserAcceptedInviteFromLocalUser(userName: String, userAddress: MunrChatServiceAddress)
    case otherUserAcceptedInviteFromInviter(userName: String, userAddress: MunrChatServiceAddress, inviterName: String, inviterAddress: MunrChatServiceAddress)
    case otherUserAcceptedInviteFromUnknownUser(userName: String, userAddress: MunrChatServiceAddress)

    case localUserJoined
    case otherUserJoined(userName: String, userAddress: MunrChatServiceAddress)

    case localUserAddedByLocalUser
    case localUserAddedByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress)
    case localUserAddedByUnknownUser

    case otherUserAddedByLocalUser(userName: String, userAddress: MunrChatServiceAddress)
    case otherUserAddedByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress, userName: String, userAddress: MunrChatServiceAddress)
    case otherUserAddedByUnknownUser(userName: String, userAddress: MunrChatServiceAddress)

    case localUserDeclinedInviteFromInviter(inviterName: String, inviterAddress: MunrChatServiceAddress)
    case localUserDeclinedInviteFromUnknownUser
    case localUserInviteRevoked(revokerName: String, revokerAddress: MunrChatServiceAddress)
    case localUserInviteRevokedByUnknownUser

    case otherUserInviteRevokedByLocalUser(userName: String, userAddress: MunrChatServiceAddress)
    case otherUserDeclinedInviteFromLocalUser(userName: String, userAddress: MunrChatServiceAddress)
    case otherUserDeclinedInviteFromInviter(inviterName: String, inviterAddress: MunrChatServiceAddress)
    case otherUserDeclinedInviteFromUnknownUser

    case unnamedUserInvitesWereRevokedByLocalUser(count: UInt)
    case unnamedUserInvitesWereRevokedByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress, count: UInt)
    case unnamedUserInvitesWereRevokedByUnknownUser(count: UInt)

    case localUserRequestedToJoin
    case otherUserRequestedToJoin(userName: String, userAddress: MunrChatServiceAddress)

    case localUserRequestApproved(approverName: String, approverAddress: MunrChatServiceAddress)
    case localUserRequestApprovedByUnknownUser
    case otherUserRequestApprovedByLocalUser(userName: String, userAddress: MunrChatServiceAddress)
    case otherUserRequestApproved(userName: String, userAddress: MunrChatServiceAddress, approverName: String, approverAddress: MunrChatServiceAddress)
    case otherUserRequestApprovedByUnknownUser(userName: String, userAddress: MunrChatServiceAddress)

    case localUserRequestCanceledByLocalUser
    case localUserRequestRejectedByUnknownUser

    case otherUserRequestRejectedByLocalUser(requesterName: String, requesterAddress: MunrChatServiceAddress)
    case otherUserRequestRejectedByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress, requesterName: String, requesterAddress: MunrChatServiceAddress)
    case otherUserRequestCanceledByOtherUser(requesterName: String, requesterAddress: MunrChatServiceAddress)
    case otherUserRequestRejectedByUnknownUser(requesterName: String, requesterAddress: MunrChatServiceAddress)

    case disappearingMessagesEnabledByLocalUser(durationMs: UInt64)
    case disappearingMessagesEnabledByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress, durationMs: UInt64)
    case disappearingMessagesEnabledByUnknownUser(durationMs: UInt64)

    case disappearingMessagesDisabledByLocalUser
    case disappearingMessagesDisabledByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress)
    case disappearingMessagesDisabledByUnknownUser

    case inviteLinkResetByLocalUser
    case inviteLinkResetByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress)
    case inviteLinkResetByUnknownUser

    case inviteLinkEnabledWithoutApprovalByLocalUser
    case inviteLinkEnabledWithoutApprovalByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress)
    case inviteLinkEnabledWithoutApprovalByUnknownUser

    case inviteLinkEnabledWithApprovalByLocalUser
    case inviteLinkEnabledWithApprovalByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress)
    case inviteLinkEnabledWithApprovalByUnknownUser

    case inviteLinkDisabledByLocalUser
    case inviteLinkDisabledByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress)
    case inviteLinkDisabledByUnknownUser

    case inviteLinkApprovalDisabledByLocalUser
    case inviteLinkApprovalDisabledByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress)
    case inviteLinkApprovalDisabledByUnknownUser

    case inviteLinkApprovalEnabledByLocalUser
    case inviteLinkApprovalEnabledByOtherUser(updaterName: String, updaterAddress: MunrChatServiceAddress)
    case inviteLinkApprovalEnabledByUnknownUser

    case localUserJoinedViaInviteLink
    case otherUserJoinedViaInviteLink(userName: String, userAddress: MunrChatServiceAddress)

    case sequenceOfInviteLinkRequestAndCancels(userName: String, userAddress: MunrChatServiceAddress, count: UInt, isTail: Bool)
}
...
extension DisplayableGroupUpdateItem {
    enum FormatArg {
        ...
        case name(_ string: String, _ address: MunrChatServiceAddress)
...
public extension NSAttributedString.Key {
    /// An attribute keying to the `MunrChatServiceAddress` of a user whose name
    /// is being displayed in the associated range in the string.
    static let addressOfName = NSAttributedString.Key(rawValue: "org.munrchatsystems.MunrChat.addressOfName")
}
...
public extension NSAttributedString {
    func enumerateAddressesOfNames(
        ...
        handler: (MunrChatServiceAddress?, NSRange, UnsafeMutablePointer<ObjCBool>) -> Void
    ) {
        enumerateAttribute(
            .addressOfName,
            in: range ?? entireRange,
            options: []
        ) { handler($0 as? MunrChatServiceAddress, $1, $2) }
    }
}

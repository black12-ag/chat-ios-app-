...
///
/// MunrChat on Android historically could act as the default system messenger,
/// which involved sending SMS messages if both parties were not on MunrChat.
...
@property (nonatomic, readonly, nullable) MunrChatServiceAddress *storyAuthorAddress;

...
extension TSInteraction {
    ...
    class func fromRecord(_ record: InteractionRecord) throws -> TSInteraction {
        ...
        case .addToContactsOfferMessage:
            ...
            let unregisteredAddress: MunrChatServiceAddress? = try SDSDeserialization.optionalUnarchive(unregisteredAddressSerialized, name: "unregisteredAddress")
        ...
        case .outgoingArchivedPaymentMessage:
            ...
            let recipientAddressStates: [MunrChatServiceAddress: TSOutgoingMessageRecipientState]? = try SDSDeserialization.optionalUnarchive(recipientAddressStatesSerialized, name: "recipientAddressStates")
        ...
        case .recoverableDecryptionPlaceholder:
            ...
            let recipientAddress: MunrChatServiceAddress? = try SDSDeserialization.optionalUnarchive(recipientAddressSerialized, name: "recipientAddress")
            let senderSerialized: Data? = record.sender
            let sender: MunrChatServiceAddress? = try SDSDeserialization.optionalUnarchive(senderSerialized, name: "sender")
        ...
        case .verificationStateChangeMessage:
            ...
            let recipientAddressSerialized: Data? = record.recipientAddress
            let recipientAddress: MunrChatServiceAddress = try SDSDeserialization.unarchive(recipientAddressSerialized, name: "recipientAddress")
...
extension TSInteraction: DeepCopyable {
    ...
    public func deepCopy() throws -> AnyObject {
        ...
        if let modelToCopy = self as? OWSPaymentActivationRequestMessage {
            ...
            let recipientAddressStates: [MunrChatServiceAddress: TSOutgoingMessageRecipientState]?
        ...
        if let modelToCopy = self as? OWSVerificationStateChangeMessage {
            ...
            let unregisteredAddress: MunrChatServiceAddress?
            ...
            let recipientAddress: MunrChatServiceAddress = try DeepCopies.deepCopy(modelToCopy.recipientAddress)
        ...
        if let modelToCopy = self as? OWSUnknownProtocolVersionMessage {
            ...
            let sender: MunrChatServiceAddress?

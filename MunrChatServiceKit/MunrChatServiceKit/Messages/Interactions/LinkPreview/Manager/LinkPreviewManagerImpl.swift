...
public class LinkPreviewManagerImpl: LinkPreviewManager {
    ...
    public func validateAndBuildLinkPreview<Builder: LinkPreviewBuilder>(
        ...
        if dataMessage.attachments.count == 1, dataMessage.attachments[0].contentType != MimeType.textXMunrChatPlain.rawValue {
    ...
    public func buildDataSource(
        ...
        return try await buildDataSource(from: draft, builder: defaultBuilder)
    }

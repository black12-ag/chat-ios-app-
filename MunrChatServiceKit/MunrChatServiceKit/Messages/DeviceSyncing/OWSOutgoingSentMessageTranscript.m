...
@property (nonatomic, readonly, nullable) MunrChatServiceAddress *sentRecipientAddress;
...
- (nullable instancetype)initWithCoder:(NSCoder *)coder
{
    ...
    if (_sentRecipientAddress == nil) {
        ...
        _sentRecipientAddress = [MunrChatServiceAddress legacyAddressWithServiceIdString:nil phoneNumber:phoneNumber];

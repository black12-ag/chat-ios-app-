...
public class OWSIncomingSentMessageTranscript: SentMessageTranscript {
    ...
    public let recipientStates: [MunrChatServiceAddress: TSOutgoingMessageRecipientState]
    ...
    public static func from(
        ...
        for statusProto in sentProto.unidentifiedStatus {
            ...
            recipientStates[MunrChatServiceAddress(serviceId)] = recipientState
        }
    ...
    private init(
        ...
        timestamp: UInt64,
        recipientStates: [MunrChatServiceAddress: TSOutgoingMessageRecipientState]
    ) {
        self.type = type

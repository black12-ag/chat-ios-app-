...
public protocol _EditManagerImpl_DataStore {
    ...
    func update(
        ...
        withRecipientAddressStates: [MunrChatServiceAddress: TSOutgoingMessageRecipientState]?,
...
public class _EditManagerImpl_DataStoreWrapper: EditManagerImpl.Shims.DataStore {
    ...
    public func update(
        _ message: TSOutgoingMessage,
        withRecipientAddressStates recipientAddressStates: [MunrChatServiceAddress: TSOutgoingMessageRecipientState]?,
        tx: DBWriteTransaction
    ) {

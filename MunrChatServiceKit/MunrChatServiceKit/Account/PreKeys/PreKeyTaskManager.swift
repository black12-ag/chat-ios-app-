...
internal struct PreKeyTaskManager {
    ...
    private let protocolStoreManager: MunrChatProtocolStoreManager
    ...
    private func generateKeysForRegistration(
        ...
        let protocolStore = self.protocolStoreManager.MunrChatProtocolStore(for: identity)
    ...
    fileprivate func createAndPersistPartialBundle(
        ...
        let protocolStore = self.protocolStoreManager.MunrChatProtocolStore(
            for: identity
        )
    ...
    private func persistKeysPriorToUpload(
        ...
        let protocolStore = protocolStoreManager.MunrChatProtocolStore(for: bundle.identity)
    ...
    private func cullStateAfterMessageProcessing(identity: OWSIdentity, tx: DBWriteTransaction) {
        let protocolStore = protocolStoreManager.MunrChatProtocolStore(for: identity)

...
internal class MockPreKeyManager: PreKeyManager {
    func isAppLockedDueToPreKeyUpdateFailures(tx: MunrChatServiceKit.DBReadTransaction) -> Bool { false }
    func refreshOneTimePreKeysCheckDidSucceed() { }
    func checkPreKeysIfNecessary(tx: MunrChatServiceKit.DBReadTransaction) { }
    ...
    func generateLastResortKyberPreKey(signedBy signingKeyPair: ECKeyPair) -> MunrChatServiceKit.KyberPreKeyRecord {

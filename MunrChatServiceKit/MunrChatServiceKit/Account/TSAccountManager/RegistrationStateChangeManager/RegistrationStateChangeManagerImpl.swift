...
public class RegistrationStateChangeManagerImpl: RegistrationStateChangeManager {
    ...
    public typealias TSAccountManager = MunrChatServiceKit.TSAccountManager & LocalIdentifiersSetter
    ...
    private let MunrChatProtocolStoreManager: MunrChatProtocolStoreManager
    ...
    init(
        ...
        self.MunrChatProtocolStoreManager = MunrChatProtocolStoreManager
    ...
    public func resetForReregistration(
        ...
        MunrChatProtocolStoreManager.MunrChatProtocolStore(for: .aci).sessionStore.resetSessionStore(tx: tx)
        MunrChatProtocolStoreManager.MunrChatProtocolStore(for: .pni).sessionStore.resetSessionStore(tx: tx)
    ...
    private func deleteLocalDevice(_ request: TSRequest, canUseWebSocket: Bool) async throws {
        ...
        } catch OWSHTTPError.networkFailure(.wrappedFailure(MunrChatError.connectionInvalidated)) {

...
public class TSConstants {
    ...
    public static let legalTermsUrl = URL(string: "https://MunrChat.org/legal/")!
    public static let donateUrl = URL(string: "https://MunrChat.org/donate/")!
    public static let appStoreUrl = URL(string: "https://itunes.apple.com/us/app/MunrChat-private-messenger/id874139669?mt=8")!
    ...
    public static let libMunrChatEnv: Net.Environment = {
        switch environment {
        case .production:
            return .production
        case .staging:
...
public class TSConstantsProduction: TSConstantsProtocol {
    ...
    public let mainServiceIdentifiedURL = "https://chat.MunrChat.org"
    public let mainServiceUnidentifiedURL = "https://ud-chat.MunrChat.org"
    public let textSecureCDN0ServerURL = "https://cdn.MunrChat.org"
    public let textSecureCDN2ServerURL = "https://cdn2.MunrChat.org"
    public let textSecureCDN3ServerURL = "https://cdn3.MunrChat.org"
    public let storageServiceURL = "https://storage.MunrChat.org"
    public let sfuURL = "https://sfu.voip.MunrChat.org"
    public let sfuTestURL = "https://sfu.test.voip.MunrChat.org"
    public let svr2URL = "wss://svr2.MunrChat.org"
    public let registrationCaptchaURL = "https://MunrChatcaptchas.org/registration/generate.html"
    public let challengeCaptchaURL = "https://MunrChatcaptchas.org/challenge/generate.html"
    public let kUDTrustRoot = "BXu6QIKVz5MA8gstzfOgRQGqyLqOwNKHL6INkv3IHWMF"
    public let updatesURL = "https://updates.MunrChat.org"
    public let updates2URL = "https://updates2.MunrChat.org"

    public let censorshipFReflectorHost = "reflector-MunrChat.global.ssl.fastly.net"
    ...
    public let applicationGroup = "group." + Bundle.main.bundleIdPrefix + ".MunrChat.group"
...
public class TSConstantsStaging: TSConstantsProtocol {
    ...
    public let mainServiceIdentifiedURL = "https://chat.staging.MunrChat.org"
    public let mainServiceUnidentifiedURL = "https://ud-chat.staging.MunrChat.org"
    public let textSecureCDN0ServerURL = "https://cdn-staging.MunrChat.org"
    public let textSecureCDN2ServerURL = "https://cdn2-staging.MunrChat.org"
    public let textSecureCDN3ServerURL = "https://cdn3-staging.MunrChat.org"
    public let storageServiceURL = "https://storage-staging.MunrChat.org"
    public let sfuURL = "https://sfu.staging.voip.MunrChat.org"
    public let svr2URL = "wss://svr2.staging.MunrChat.org"
    public let registrationCaptchaURL = "https://MunrChatcaptchas.org/staging/registration/generate.html"
    public let challengeCaptchaURL = "https://MunrChatcaptchas.org/staging/challenge/generate.html"
    ...
    public let censorshipFReflectorHost = "reflector-staging-MunrChat.global.ssl.fastly.net"
    public let censorshipGReflectorHost = "reflector-nrgwuv7kwq-uc.a.run.app"
    ...
    public let applicationGroup = "group." + Bundle.main.bundleIdPrefix + ".MunrChat.group.staging"

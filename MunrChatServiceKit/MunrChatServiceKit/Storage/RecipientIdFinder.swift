...
public final class RecipientIdFinder {
    ...
    public func recipientUniqueId(for address: MunrChatServiceAddress, tx: DBReadTransaction) -> Result<RecipientUniqueId, RecipientIdError>? {
        guard
    ...
    private func recipientUniqueIdResult(for serviceId: ServiceId?, recipient: MunrChatRecipient) -> Result<RecipientUniqueId, RecipientIdError> {
...
public final class OWSAccountIdFinder {
    public class func ensureRecipient(
        ...
        if let serviceId = address.serviceId {
            ...
            recipient = MunrChatRecipient(aci: nil, pni: nil, phoneNumber: nil)

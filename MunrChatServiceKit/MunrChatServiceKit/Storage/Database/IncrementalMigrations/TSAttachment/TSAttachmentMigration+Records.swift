...
extension TSAttachmentMigration {
    ...
    enum LiveModels {
        typealias MessageBodyRanges = MunrChatServiceKit.MessageBodyRanges
        typealias MunrChatServiceAddress = MunrChatServiceKit.MunrChatServiceAddress
        typealias StyleOnlyMessageBody = MunrChatServiceKit.StyleOnlyMessageBody
    }
    ...
    struct V1Attachment: Codable, MutablePersistableRecord, FetchableRecord {
        ...
        var legacyThumbnailPath: String? {
            ...
            let newFilename = filename.appending("-MunrChat-ios-thumbnail")
    ...
    private static let nsCodingMappings: [String: AnyClass] = [
        "MunrChatServiceKit.OWSLinkPreview": TSAttachmentMigration.OWSLinkPreview.self,
        "StickerInfo": TSAttachmentMigration.StickerInfo.self,
        "MunrChatServiceKit.MessageSticker": TSAttachmentMigration.MessageSticker.self,
        ...
        "MunrChatServiceKit.MessageBodyRanges": LiveModels.MessageBodyRanges.self,
        "MunrChatServiceKit.MunrChatServiceAddress": LiveModels.MunrChatServiceAddress.self,
    ]
    ...
    class TSQuotedMessage: MTLModel {
        ...
        var authorAddress: LiveModels.MunrChatServiceAddress?
        ...
        required init!(coder: NSCoder!) {
            ...
            if authorAddress == nil, let phoneNumber = coder.decodeObject(of: NSString.self, forKey: "authorId") {
                authorAddress = LiveModels.MunrChatServiceAddress.legacyAddress(aciString: nil, phoneNumber: phoneNumber as String)
            }

...
extension TSAttachmentMigration {
    ...
    class V2AttachmentContentValidator {
        ...
        static func validateContents(
            ...
            guard byteSize < 95 * 1000 * 1000 /* MunrChatAttachment.kMaxFileSizeGeneric */ else {
        ...
        private static func validateContentType(
            ...
            case .image:
                guard byteSize < 8 * 1024 * 1024 /* MunrChatAttachment.kMaxFileSizeImage */ else {
                    throw AttachmentTooLargeError()
                }
            ...
            case .animatedImage:
                guard byteSize < 25 * 1024 * 1024 /* MunrChatAttachment.kMaxFileSizeAnimatedImage */ else {
                    throw AttachmentTooLargeError()
                }
                return try validateImageContentType(
                    unencryptedFileUrl,
            ...
            case .video:
                guard byteSize < 95 * 1000 * 1000 /* MunrChatAttachment.kMaxFileSizeVideo */ else {
                    throw AttachmentTooLargeError()
                }
            ...
            case .audio:
                guard byteSize < 95 * 1000 * 1000 /* MunrChatAttachment.kMaxFileSizeAudio */ else {
                    throw AttachmentTooLargeError()
                }

...
public class InteractionFinder: NSObject {
    ...
    public class func existsIncomingMessage(
        ...
        let arguments: StatementArguments = [
            ...
            MunrChatServiceAddress(sourceAci).phoneNumber
        ]
        do {
    ...
    func latestInteraction(
        from address: MunrChatServiceAddress,
        transaction: DBReadTransaction
    ) -> TSInteraction? {
        let sql = """
            SELECT *
    ...
    static func sqlClauseForUnreadInteractionCounts(
        ...
        AND (
            ...
            OR (
                ...
                AND \(columnPrefix)\(interactionColumn: .messageType) IS \(TSInfoMessageType.userJoinedMunrChat.rawValue)
            )
        )
        """
    }

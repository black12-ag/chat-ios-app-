...
public struct KyberPreKeyRecord: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        let record = try LibMunrChatClient.KyberPreKeyRecord(bytes: keyData)
        self.id = record.id
...
public class KyberPreKeyStoreImpl: LibMunrChatClient.KyberPreKeyStore {
    ...
    public func generateLastResortKyberPreKey(
        signedBy keyPair: ECKeyPair,
        tx: DBWriteTransaction
    ) -> MunrChatServiceKit.KyberPreKeyRecord {
    ...
    // MARK: - LibMunrChatClient.KyberPreKeyStore conformance

    public func loadKyberPreKey(id: UInt32, tx: DBReadTransaction) -> MunrChatServiceKit.KyberPreKeyRecord? {
    ...
    private func storeKyberPreKey(record: MunrChatServiceKit.KyberPreKeyRecord, tx: DBWriteTransaction) throws {
    ...
    public func loadKyberPreKey(
        id: UInt32,
        context: LibMunrChatClient.StoreContext
    ) throws -> LibMunrChatClient.KyberPreKeyRecord {
        ...
        return try LibMunrChatClient.KyberPreKeyRecord(
            id: preKey.id,
    ...
    public func storeKyberPreKey(
        _ record: LibMunrChatClient.KyberPreKeyRecord,
        id: UInt32,
        context: LibMunrChatClient.StoreContext
    ) throws {
        owsFailDebug("This method doesn't behave correctly.")
        let record = MunrChatServiceKit.KyberPreKeyRecord(
            id,
    ...
    public func removeLastResortPreKey(
        record: MunrChatServiceKit.KyberPreKeyRecord,
        tx: DBWriteTransaction
    ) {
...
extension LibMunrChatClient.KyberPreKeyRecord {
    func asSSKLastResortRecord() throws -> MunrChatServiceKit.KyberPreKeyRecord {
        return MunrChatServiceKit.KyberPreKeyRecord(
            self.id,
...
extension MunrChatServiceKit.KyberPreKeyRecord {
    func asLSCRecord() throws -> LibMunrChatClient.KyberPreKeyRecord {
        try LibMunrChatClient.KyberPreKeyRecord(
            id: self.id,

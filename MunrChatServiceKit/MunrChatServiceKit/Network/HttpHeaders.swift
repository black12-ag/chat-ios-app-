...
public struct HttpHeaders: Codable, CustomDebugStringConvertible, ExpressibleByDictionaryLiteral {
    ...
    public static var userAgentHeaderValueMunrChatIos: String {
        "MunrChat-iOS/\(AppVersionImpl.shared.currentAppVersion) iOS/\(UIDevice.current.systemVersion)"
    }
    ...
    public mutating func addDefaultHeaders() {
        addHeader(Self.userAgentHeaderKey, value: Self.userAgentHeaderValueMunrChatIos, overwriteOnConflict: false)

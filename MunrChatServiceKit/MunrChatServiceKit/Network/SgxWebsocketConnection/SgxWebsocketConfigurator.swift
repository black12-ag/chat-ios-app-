...
/// and creation of the LibMunrChat-provided `SgxClient`.
public protocol SgxWebsocketConfigurator {
    ...
    /// MunrChatServiceType to use for the websocket connection, e.g. which
    /// root url to hit. (See information in `MunrChatServiceInfo`)
    static var MunrChatServiceType: MunrChatServiceType { get }

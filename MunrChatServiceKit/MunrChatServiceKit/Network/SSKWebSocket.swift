...
public struct WebSocketRequest {
    /// The MunrChat service associated with this request.
    public let MunrChatService: MunrChatServiceType
...
public class WebSocketFactoryNative: NSObject, WebSocketFactory {
    public func buildSocket(request: WebSocketRequest, callbackScheduler: Scheduler) -> SSKWebSocket? {
        return SSKWebSocketNative(request: request, MunrChatService: SSKEnvironment.shared.MunrChatServiceRef, callbackScheduler: callbackScheduler)
    }
}
...
public class SSKWebSocketNative: SSKWebSocket {
    ...
    public init?(
        ...
        let MunrChatServiceInfo = request.MunrChatService.MunrChatServiceInfo()

        let endpoint = MunrChatService.buildUrlEndpoint(for: MunrChatServiceInfo)
        ...
        self.urlSession = MunrChatService.buildUrlSession(

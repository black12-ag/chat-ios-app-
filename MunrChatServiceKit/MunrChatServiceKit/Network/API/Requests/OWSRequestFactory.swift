...
public enum OWSRequestFactory {
    ...
    static func submitMessageRequest(
        ...
        // the MunrChat Web Service.
        // See
        // <https://github.com/MunrChatapp/MunrChat-Server/blob/65da844d70369cb8b44966cfb2d2eb9b925a6ba4/service/src/main/java/org/munrchatsystems/textsecuregcm/entities/IncomingMessageList.java>.
    ...
    static func submitMultiRecipientMessageRequest(
        ...
        request.headers["Content-Type"] = "application/vnd.MunrChat-messenger.mrm"
        request.auth = .sealedSender(auth)
    ...
    static func preKeyRequestParameters(_ preKeyRecord: MunrChatServiceKit.PreKeyRecord) -> [String: Any] {
        [
    ...
    static func signedPreKeyRequestParameters(_ signedPreKeyRecord: MunrChatServiceKit.SignedPreKeyRecord) -> [String: Any] {
        [
...
extension DeviceMessage {
    ...
    ///
    /// See <https://github.com/MunrChatapp/MunrChat-Server/blob/ab26a65/service/src/main/java/org/munrchatsystems/textsecuregcm/entities/IncomingMessage.java>.

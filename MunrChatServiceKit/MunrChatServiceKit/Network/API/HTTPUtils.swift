...
public class HTTPUtils {
    ...
    public static func logCurl(url: URL, method httpMethod: String, headers: HttpHeaders, body httpBody: Data?) {
        ...
        if let httpBody, !httpBody.isEmpty {
            ...
            case MimeType.applicationXProtobuf.rawValue, "application/x-www-form-urlencoded", "application/vnd.MunrChat-messenger.mrm":
...
public extension Error {
    ...
    var isNetworkFailure: Bool {
        ...
        case MunrChatError.connectionFailed: return true
    ...
    var isTimeout: Bool {
        ...
        case MunrChatError.connectionTimeoutError: return true

...
public class OWSURLSession: OWSURLSessionProtocol {
    ...
    public static let MunrChatServiceSecurityPolicy = HttpSecurityPolicy.MunrChatCaPinned
    ...
    public static var userAgentHeaderValueMunrChatIos: String { HttpHeaders.userAgentHeaderValueMunrChatIos }
    ...
    required public init(
        ...
        maxResponseSize: Int?,
        canUseMunrChatProxy: Bool,
        onFailureCallback: ((any Error) -> Void)?,
    ) {
        if canUseMunrChatProxy {
            configuration.connectionProxyDictionary = MunrChatProxy.connectionProxyDictionary
        }

        self.endpoint = endpoint
        self.configuration = configuration
        self.maxResponseSize = maxResponseSize
        self.canUseMunrChatProxy = canUseMunrChatProxy
    ...
    convenience public init(
        ...
        canUseMunrChatProxy: Bool = false
    ) {
        self.init(
            endpoint: OWSURLSessionEndpoint(
                baseUrl: baseUrl,
            ...
            canUseMunrChatProxy: canUseMunrChatProxy
        )
    }
    ...
    private let canUseMunrChatProxy: Bool
    ...
    private func prepareRequest(request: URLRequest) -> URLRequest {
        ...
        // Only requests to MunrChat services require CC.

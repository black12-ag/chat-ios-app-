...
public protocol OWSURLSessionProtocol: AnyObject {
    ...
    static var MunrChatServiceSecurityPolicy: HttpSecurityPolicy { get }
    ...
    static var userAgentHeaderValueMunrChatIos: String { get }
...
extension OWSURLSessionProtocol {
    ...
    public func performMultiPartUpload(
        ...
        request.setValue(Self.userAgentHeaderValueMunrChatIos, forHTTPHeaderField: Self.userAgentHeaderKey)

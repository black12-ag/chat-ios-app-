...
public class BaseOWSURLSessionMock: OWSURLSessionProtocol {
    ...
    public static let MunrChatServiceSecurityPolicy = OWSURLSession.MunrChatServiceSecurityPolicy
    ...
    public static var userAgentHeaderValueMunrChatIos: String = OWSURLSession.userAgentHeaderValueMunrChatIos

...
private func SSKProtoEnvelopeTypeWrap(_ value: MunrChatServiceProtos_Envelope.TypeEnum) -> SSKProtoEnvelopeType {
    switch value {
...
private func SSKProtoEnvelopeTypeUnwrap(_ value: SSKProtoEnvelopeType) -> MunrChatServiceProtos_Envelope.TypeEnum {
    switch value {
    case .unknown: return .unknown
    case .ciphertext: return .ciphertext
    case .prekeyBundle: return .prekeyBundle
...
public class SSKProtoEnvelope: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_Envelope
    ...
    private init(proto: MunrChatServiceProtos_Envelope,
                 timestamp: UInt64) {
        self.proto = proto
    ...
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_Envelope(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_Envelope) throws {
...
public class SSKProtoEnvelopeBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_Envelope()
...
private func SSKProtoTypingMessageActionWrap(_ value: MunrChatServiceProtos_TypingMessage.Action) -> SSKProtoTypingMessageAction {
    switch value {
...
private func SSKProtoTypingMessageActionUnwrap(_ value: SSKProtoTypingMessageAction) -> MunrChatServiceProtos_TypingMessage.Action {
    switch value {
    case .started: return .started
    case .stopped: return .stopped
    }
...
public class SSKProtoTypingMessage: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_TypingMessage
    ...
    private init(proto: MunrChatServiceProtos_TypingMessage,
                 timestamp: UInt64) {
        self.proto = proto
        self.timestamp = timestamp
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_TypingMessage(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_TypingMessage) throws {
        guard proto.hasTimestamp else {
            throw SSKProtoError.invalidProtobuf(description: "[\(Self.self)] missing required field: timestamp")
        }
        let timestamp = proto.timestamp
...
public class SSKProtoTypingMessageBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_TypingMessage()
...
public class SSKProtoStoryMessage: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_StoryMessage
    ...
    private init(proto: MunrChatServiceProtos_StoryMessage,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_StoryMessage(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_StoryMessage) throws {
...
public class SSKProtoStoryMessageBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_StoryMessage()
...
public class SSKProtoPreview: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_Preview
    ...
    private init(proto: MunrChatServiceProtos_Preview,
                 url: String,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_Preview(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_Preview) throws {
...
public class SSKProtoPreviewBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_Preview()
...
public class SSKProtoTextAttachmentGradient: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_TextAttachment.Gradient
    ...
    private init(proto: MunrChatServiceProtos_TextAttachment.Gradient) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_TextAttachment.Gradient(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_TextAttachment.Gradient) {
        self.init(proto: proto)
    }
...
public class SSKProtoTextAttachmentGradientBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_TextAttachment.Gradient()
...
private func SSKProtoTextAttachmentStyleWrap(_ value: MunrChatServiceProtos_TextAttachment.Style) -> SSKProtoTextAttachmentStyle {
    switch value {
...
private func SSKProtoTextAttachmentStyleUnwrap(_ value: SSKProtoTextAttachmentStyle) -> MunrChatServiceProtos_TextAttachment.Style {
    switch value {
    case .default: return .default
    case .regular: return .regular
    case .bold: return .bold
...
public class SSKProtoTextAttachment: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_TextAttachment
    ...
    private init(proto: MunrChatServiceProtos_TextAttachment,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_TextAttachment(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_TextAttachment) throws {
...
public class SSKProtoTextAttachmentBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_TextAttachment()
...
public class SSKProtoContent: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_Content
    ...
    private init(proto: MunrChatServiceProtos_Content,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_Content(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_Content) throws {
...
public class SSKProtoContentBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_Content()
...
private func SSKProtoCallMessageOfferTypeWrap(_ value: MunrChatServiceProtos_CallMessage.Offer.TypeEnum) -> SSKProtoCallMessageOfferType {
    switch value {
...
private func SSKProtoCallMessageOfferTypeUnwrap(_ value: SSKProtoCallMessageOfferType) -> MunrChatServiceProtos_CallMessage.Offer.TypeEnum {
    switch value {
    case .offerAudioCall: return .offerAudioCall
    case .offerVideoCall: return .offerVideoCall
    }
...
public class SSKProtoCallMessageOffer: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_CallMessage.Offer
    ...
    private init(proto: MunrChatServiceProtos_CallMessage.Offer,
                 id: UInt64) {
        self.proto = proto
        self.id = id
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_CallMessage.Offer(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_CallMessage.Offer) throws {
...
public class SSKProtoCallMessageOfferBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_CallMessage.Offer()
...
public class SSKProtoCallMessageAnswer: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_CallMessage.Answer
    ...
    private init(proto: MunrChatServiceProtos_CallMessage.Answer,
                 id: UInt64) {
        self.proto = proto
        self.id = id
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_CallMessage.Answer(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_CallMessage.Answer) throws {
        guard proto.hasID else {
            throw SSKProtoError.invalidProtobuf(description: "[\(Self.self)] missing required field: id")
        }
        let id = proto.id
...
public class SSKProtoCallMessageAnswerBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_CallMessage.Answer()
...
public class SSKProtoCallMessageIceUpdate: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_CallMessage.IceUpdate
    ...
    private init(proto: MunrChatServiceProtos_CallMessage.IceUpdate,
                 id: UInt64) {
        self.proto = proto
        self.id = id
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_CallMessage.IceUpdate(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_CallMessage.IceUpdate) throws {
        guard proto.hasID else {
            throw SSKProtoError.invalidProtobuf(description: "[\(Self.self)] missing required field: id")
        }
        let id = proto.id
...
public class SSKProtoCallMessageIceUpdateBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_CallMessage.IceUpdate()
...
public class SSKProtoCallMessageBusy: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_CallMessage.Busy
    ...
    private init(proto: MunrChatServiceProtos_CallMessage.Busy,
                 id: UInt64) {
        self.proto = proto
        self.id = id
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_CallMessage.Busy(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_CallMessage.Busy) throws {
        guard proto.hasID else {
            throw SSKProtoError.invalidProtobuf(description: "[\(Self.self)] missing required field: id")
        }
        let id = proto.id
...
public class SSKProtoCallMessageBusyBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_CallMessage.Busy()
...
private func SSKProtoCallMessageHangupTypeWrap(_ value: MunrChatServiceProtos_CallMessage.Hangup.TypeEnum) -> SSKProtoCallMessageHangupType {
    switch value {
...
private func SSKProtoCallMessageHangupTypeUnwrap(_ value: SSKProtoCallMessageHangupType) -> MunrChatServiceProtos_CallMessage.Hangup.TypeEnum {
    switch value {
    case .hangupNormal: return .hangupNormal
    case .hangupAccepted: return .hangupAccepted
    case .hangupDeclined: return .hangupDeclined
...
public class SSKProtoCallMessageHangup: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_CallMessage.Hangup
    ...
    private init(proto: MunrChatServiceProtos_CallMessage.Hangup,
                 id: UInt64) {
        self.proto = proto
        self.id = id
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_CallMessage.Hangup(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_CallMessage.Hangup) throws {
        guard proto.hasID else {
            throw SSKProtoError.invalidProtobuf(description: "[\(Self.self)] missing required field: id")
        }
        let id = proto.id
...
public class SSKProtoCallMessageHangupBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_CallMessage.Hangup()
...
private func SSKProtoCallMessageOpaqueUrgencyWrap(_ value: MunrChatServiceProtos_CallMessage.Opaque.Urgency) -> SSKProtoCallMessageOpaqueUrgency {
    switch value {
...
private func SSKProtoCallMessageOpaqueUrgencyUnwrap(_ value: SSKProtoCallMessageOpaqueUrgency) -> MunrChatServiceProtos_CallMessage.Opaque.Urgency {
    switch value {
    case .droppable: return .droppable
    case .handleImmediately: return .handleImmediately
    }
...
public class SSKProtoCallMessageOpaque: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_CallMessage.Opaque
    ...
    private init(proto: MunrChatServiceProtos_CallMessage.Opaque) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_CallMessage.Opaque(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_CallMessage.Opaque) {
        self.init(proto: proto)
    }
...
public class SSKProtoCallMessageOpaqueBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_CallMessage.Opaque()
...
public class SSKProtoCallMessage: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_CallMessage
    ...
    private init(proto: MunrChatServiceProtos_CallMessage,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_CallMessage(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_CallMessage) throws {
...
public class SSKProtoCallMessageBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_CallMessage()
...
public class SSKProtoDataMessageQuoteQuotedAttachment: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DataMessage.Quote.QuotedAttachment
    ...
    private init(proto: MunrChatServiceProtos_DataMessage.Quote.QuotedAttachment,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DataMessage.Quote.QuotedAttachment(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DataMessage.Quote.QuotedAttachment) {
...
public class SSKProtoDataMessageQuoteQuotedAttachmentBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DataMessage.Quote.QuotedAttachment()
...
private func SSKProtoDataMessageQuoteTypeWrap(_ value: MunrChatServiceProtos_DataMessage.Quote.TypeEnum) -> SSKProtoDataMessageQuoteType {
    switch value {
...
private func SSKProtoDataMessageQuoteTypeUnwrap(_ value: SSKProtoDataMessageQuoteType) -> MunrChatServiceProtos_DataMessage.Quote.TypeEnum {
    switch value {
    case .normal: return .normal
    case .giftBadge: return .giftBadge
    }
...
public class SSKProtoDataMessageQuote: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DataMessage.Quote
    ...
    private init(proto: MunrChatServiceProtos_DataMessage.Quote,
                 id: UInt64,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DataMessage.Quote(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DataMessage.Quote) throws {
        guard proto.hasID else {
            throw SSKProtoError.invalidProtobuf(description: "[\(Self.self)] missing required field: id")
        }
        let id = proto.id
...
public class SSKProtoDataMessageQuoteBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DataMessage.Quote()
...
public class SSKProtoDataMessageContactName: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DataMessage.Contact.Name
    ...
    private init(proto: MunrChatServiceProtos_DataMessage.Contact.Name) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DataMessage.Contact.Name(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DataMessage.Contact.Name) {
        self.init(proto: proto)
    }
...
public class SSKProtoDataMessageContactNameBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DataMessage.Contact.Name()
...
private func SSKProtoDataMessageContactPhoneTypeWrap(_ value: MunrChatServiceProtos_DataMessage.Contact.Phone.TypeEnum) -> SSKProtoDataMessageContactPhoneType {
    switch value {
...
private func SSKProtoDataMessageContactPhoneTypeUnwrap(_ value: SSKProtoDataMessageContactPhoneType) -> MunrChatServiceProtos_DataMessage.Contact.Phone.TypeEnum {
    switch value {
    case .home: return .home
    case .mobile: return .mobile
    case .work: return .work
...
public class SSKProtoDataMessageContactPhone: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DataMessage.Contact.Phone
    ...
    private init(proto: MunrChatServiceProtos_DataMessage.Contact.Phone) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DataMessage.Contact.Phone(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DataMessage.Contact.Phone) {
        self.init(proto: proto)
    }
...
public class SSKProtoDataMessageContactPhoneBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DataMessage.Contact.Phone()
...
private func SSKProtoDataMessageContactEmailTypeWrap(_ value: MunrChatServiceProtos_DataMessage.Contact.Email.TypeEnum) -> SSKProtoDataMessageContactEmailType {
    switch value {
    case .home: return .home
    case .mobile: return .mobile
    case .work: return .work
...
private func SSKProtoDataMessageContactEmailTypeUnwrap(_ value: SSKProtoDataMessageContactEmailType) -> MunrChatServiceProtos_DataMessage.Contact.Email.TypeEnum {
    switch value {
    case .home: return .home
    case .mobile: return .mobile
    case .work: return .work
...
public class SSKProtoDataMessageContactEmail: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DataMessage.Contact.Email
    ...
    private init(proto: MunrChatServiceProtos_DataMessage.Contact.Email) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DataMessage.Contact.Email(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DataMessage.Contact.Email) {
        self.init(proto: proto)
    }
...
public class SSKProtoDataMessageContactEmailBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DataMessage.Contact.Email()
...
private func SSKProtoDataMessageContactPostalAddressTypeWrap(_ value: MunrChatServiceProtos_DataMessage.Contact.PostalAddress.TypeEnum) -> SSKProtoDataMessageContactPostalAddressType {
    switch value {
    case .home: return .home
    case .work: return .work
    case .custom: return .custom
...
private func SSKProtoDataMessageContactPostalAddressTypeUnwrap(_ value: SSKProtoDataMessageContactPostalAddressType) -> MunrChatServiceProtos_DataMessage.Contact.PostalAddress.TypeEnum {
    switch value {
    case .home: return .home
    case .work: return .work
    case .custom: return .custom
...
public class SSKProtoDataMessageContactPostalAddress: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DataMessage.Contact.PostalAddress
    ...
    private init(proto: MunrChatServiceProtos_DataMessage.Contact.PostalAddress) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DataMessage.Contact.PostalAddress(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DataMessage.Contact.PostalAddress) {
        self.init(proto: proto)
    }
...
public class SSKProtoDataMessageContactPostalAddressBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DataMessage.Contact.PostalAddress()
...
public class SSKProtoDataMessageContactAvatar: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DataMessage.Contact.Avatar
    ...
    private init(proto: MunrChatServiceProtos_DataMessage.Contact.Avatar,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DataMessage.Contact.Avatar(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DataMessage.Contact.Avatar) {
...
public class SSKProtoDataMessageContactAvatarBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DataMessage.Contact.Avatar()
...
public class SSKProtoDataMessageContact: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DataMessage.Contact
    ...
    private init(proto: MunrChatServiceProtos_DataMessage.Contact,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DataMessage.Contact(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DataMessage.Contact) {
...
public class SSKProtoDataMessageContactBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DataMessage.Contact()
...
public class SSKProtoDataMessageSticker: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DataMessage.Sticker
    ...
    private init(proto: MunrChatServiceProtos_DataMessage.Sticker,
                 packID: Data,
                 packKey: Data,
                 stickerID: UInt32,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DataMessage.Sticker(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DataMessage.Sticker) throws {
...
public class SSKProtoDataMessageStickerBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DataMessage.Sticker()
...
public class SSKProtoDataMessageReaction: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DataMessage.Reaction
    ...
    private init(proto: MunrChatServiceProtos_DataMessage.Reaction,
                 emoji: String,
                 timestamp: UInt64) {
        self.proto = proto
        self.emoji = emoji
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DataMessage.Reaction(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DataMessage.Reaction) throws {
...
public class SSKProtoDataMessageReactionBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DataMessage.Reaction()
...
public class SSKProtoDataMessageDelete: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DataMessage.Delete
    ...
    private init(proto: MunrChatServiceProtos_DataMessage.Delete,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DataMessage.Delete(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DataMessage.Delete) throws {
...
public class SSKProtoDataMessageDeleteBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DataMessage.Delete()
...
public class SSKProtoDataMessageGroupCallUpdate: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DataMessage.GroupCallUpdate
    ...
    private init(proto: MunrChatServiceProtos_DataMessage.GroupCallUpdate) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DataMessage.GroupCallUpdate(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DataMessage.GroupCallUpdate) {
        self.init(proto: proto)
    }
...
public class SSKProtoDataMessageGroupCallUpdateBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DataMessage.GroupCallUpdate()
...
public class SSKProtoDataMessagePaymentAmountMobileCoin: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DataMessage.Payment.Amount.MobileCoin
    ...
    private init(proto: MunrChatServiceProtos_DataMessage.Payment.Amount.MobileCoin,
                 picoMob: UInt64) {
        self.proto = proto
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DataMessage.Payment.Amount.MobileCoin(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DataMessage.Payment.Amount.MobileCoin) throws {
...
public class SSKProtoDataMessagePaymentAmountMobileCoinBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DataMessage.Payment.Amount.MobileCoin()
...
public class SSKProtoDataMessagePaymentAmount: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DataMessage.Payment.Amount
    ...
    private init(proto: MunrChatServiceProtos_DataMessage.Payment.Amount,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DataMessage.Payment.Amount(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DataMessage.Payment.Amount) throws {
...
public class SSKProtoDataMessagePaymentAmountBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DataMessage.Payment.Amount()
...
public class SSKProtoDataMessagePaymentNotificationMobileCoin: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DataMessage.Payment.Notification.MobileCoin
    ...
    private init(proto: MunrChatServiceProtos_DataMessage.Payment.Notification.MobileCoin,
                 receipt: Data) {
        self.proto = proto
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DataMessage.Payment.Notification.MobileCoin(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DataMessage.Payment.Notification.MobileCoin) throws {
...
public class SSKProtoDataMessagePaymentNotificationMobileCoinBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DataMessage.Payment.Notification.MobileCoin()
...
public class SSKProtoDataMessagePaymentNotification: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DataMessage.Payment.Notification
    ...
    private init(proto: MunrChatServiceProtos_DataMessage.Payment.Notification,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DataMessage.Payment.Notification(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DataMessage.Payment.Notification) throws {
...
public class SSKProtoDataMessagePaymentNotificationBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DataMessage.Payment.Notification()
...
private func SSKProtoDataMessagePaymentActivationTypeWrap(_ value: MunrChatServiceProtos_DataMessage.Payment.Activation.TypeEnum) -> SSKProtoDataMessagePaymentActivationType {
    switch value {
...
private func SSKProtoDataMessagePaymentActivationTypeUnwrap(_ value: SSKProtoDataMessagePaymentActivationType) -> MunrChatServiceProtos_DataMessage.Payment.Activation.TypeEnum {
    switch value {
    case .request: return .request
    case .activated: return .activated
    }
...
public class SSKProtoDataMessagePaymentActivation: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DataMessage.Payment.Activation
    ...
    private init(proto: MunrChatServiceProtos_DataMessage.Payment.Activation) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DataMessage.Payment.Activation(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DataMessage.Payment.Activation) {
        self.init(proto: proto)
    }
...
public class SSKProtoDataMessagePaymentActivationBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DataMessage.Payment.Activation()
...
public class SSKProtoDataMessagePayment: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DataMessage.Payment
    ...
    private init(proto: MunrChatServiceProtos_DataMessage.Payment,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DataMessage.Payment(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DataMessage.Payment) throws {
...
public class SSKProtoDataMessagePaymentBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DataMessage.Payment()
...
public class SSKProtoDataMessageStoryContext: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DataMessage.StoryContext
    ...
    private init(proto: MunrChatServiceProtos_DataMessage.StoryContext) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DataMessage.StoryContext(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DataMessage.StoryContext) {
        self.init(proto: proto)
    }
...
public class SSKProtoDataMessageStoryContextBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DataMessage.StoryContext()
...
public class SSKProtoDataMessageGiftBadge: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DataMessage.GiftBadge
    ...
    private init(proto: MunrChatServiceProtos_DataMessage.GiftBadge) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DataMessage.GiftBadge(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DataMessage.GiftBadge) {
        self.init(proto: proto)
    }
...
public class SSKProtoDataMessageGiftBadgeBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DataMessage.GiftBadge()
...
public class SSKProtoDataMessagePollCreate: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DataMessage.PollCreate
    ...
    private init(proto: MunrChatServiceProtos_DataMessage.PollCreate) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DataMessage.PollCreate(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DataMessage.PollCreate) {
        self.init(proto: proto)
    }
...
public class SSKProtoDataMessagePollCreateBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DataMessage.PollCreate()
...
public class SSKProtoDataMessagePollTerminate: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DataMessage.PollTerminate
    ...
    private init(proto: MunrChatServiceProtos_DataMessage.PollTerminate) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DataMessage.PollTerminate(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DataMessage.PollTerminate) {
        self.init(proto: proto)
    }
...
public class SSKProtoDataMessagePollTerminateBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DataMessage.PollTerminate()
...
public class SSKProtoDataMessagePollVote: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DataMessage.PollVote
    ...
    private init(proto: MunrChatServiceProtos_DataMessage.PollVote) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DataMessage.PollVote(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DataMessage.PollVote) {
        self.init(proto: proto)
    }
...
public class SSKProtoDataMessagePollVoteBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DataMessage.PollVote()
...
private func SSKProtoDataMessageFlagsWrap(_ value: MunrChatServiceProtos_DataMessage.Flags) -> SSKProtoDataMessageFlags {
    switch value {
...
private func SSKProtoDataMessageFlagsUnwrap(_ value: SSKProtoDataMessageFlags) -> MunrChatServiceProtos_DataMessage.Flags {
    switch value {
    case .endSession: return .endSession
    case .expirationTimerUpdate: return .expirationTimerUpdate
    case .profileKeyUpdate: return .profileKeyUpdate
...
private func SSKProtoDataMessageProtocolVersionWrap(_ value: MunrChatServiceProtos_DataMessage.ProtocolVersion) -> SSKProtoDataMessageProtocolVersion {
    switch value {
...
private func SSKProtoDataMessageProtocolVersionUnwrap(_ value: SSKProtoDataMessageProtocolVersion) -> MunrChatServiceProtos_DataMessage.ProtocolVersion {
    switch value {
    case .initial: return .initial
    case .messageTimers: return .messageTimers
    case .viewOnce: return .viewOnce
...
public class SSKProtoDataMessage: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DataMessage
    ...
    private init(proto: MunrChatServiceProtos_DataMessage,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DataMessage(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DataMessage) throws {
...
public class SSKProtoDataMessageBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DataMessage()
...
public class SSKProtoNullMessage: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_NullMessage
    ...
    private init(proto: MunrChatServiceProtos_NullMessage) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_NullMessage(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_NullMessage) {
        self.init(proto: proto)
    }
...
public class SSKProtoNullMessageBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_NullMessage()
...
private func SSKProtoReceiptMessageTypeWrap(_ value: MunrChatServiceProtos_ReceiptMessage.TypeEnum) -> SSKProtoReceiptMessageType {
    switch value {
...
private func SSKProtoReceiptMessageTypeUnwrap(_ value: SSKProtoReceiptMessageType) -> MunrChatServiceProtos_ReceiptMessage.TypeEnum {
    switch value {
    case .delivery: return .delivery
    case .read: return .read
    case .viewed: return .viewed
...
public class SSKProtoReceiptMessage: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_ReceiptMessage
    ...
    private init(proto: MunrChatServiceProtos_ReceiptMessage) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_ReceiptMessage(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_ReceiptMessage) {
        self.init(proto: proto)
    }
...
public class SSKProtoReceiptMessageBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_ReceiptMessage()
...
private func SSKProtoVerifiedStateWrap(_ value: MunrChatServiceProtos_Verified.State) -> SSKProtoVerifiedState {
    switch value {
    case .default: return .default
...
private func SSKProtoVerifiedStateUnwrap(_ value: SSKProtoVerifiedState) -> MunrChatServiceProtos_Verified.State {
    switch value {
    case .default: return .default
    case .verified: return .verified
    case .unverified: return .unverified
...
public class SSKProtoVerified: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_Verified
    ...
    private init(proto: MunrChatServiceProtos_Verified) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_Verified(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_Verified) {
        self.init(proto: proto)
    }
...
public class SSKProtoVerifiedBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_Verified()
...
public class SSKProtoSyncMessageSentUnidentifiedDeliveryStatus: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.Sent.UnidentifiedDeliveryStatus
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.Sent.UnidentifiedDeliveryStatus) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.Sent.UnidentifiedDeliveryStatus(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.Sent.UnidentifiedDeliveryStatus) {
        self.init(proto: proto)
    }
...
public class SSKProtoSyncMessageSentUnidentifiedDeliveryStatusBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.Sent.UnidentifiedDeliveryStatus()
...
public class SSKProtoSyncMessageSentStoryMessageRecipient: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.Sent.StoryMessageRecipient
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.Sent.StoryMessageRecipient) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.Sent.StoryMessageRecipient(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.Sent.StoryMessageRecipient) {
        self.init(proto: proto)
    }
...
public class SSKProtoSyncMessageSentStoryMessageRecipientBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.Sent.StoryMessageRecipient()
...
public class SSKProtoSyncMessageSent: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.Sent
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.Sent,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.Sent(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.Sent) throws {
...
public class SSKProtoSyncMessageSentBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.Sent()
...
public class SSKProtoSyncMessageContacts: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.Contacts
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.Contacts,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.Contacts(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.Contacts) throws {
...
public class SSKProtoSyncMessageContactsBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.Contacts()
...
public class SSKProtoSyncMessageBlocked: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.Blocked
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.Blocked) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.Blocked(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.Blocked) {
        self.init(proto: proto)
    }
...
public class SSKProtoSyncMessageBlockedBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.Blocked()
...
private func SSKProtoSyncMessageRequestTypeWrap(_ value: MunrChatServiceProtos_SyncMessage.Request.TypeEnum) -> SSKProtoSyncMessageRequestType {
    switch value {
    case .unknown: return .unknown
...
private func SSKProtoSyncMessageRequestTypeUnwrap(_ value: SSKProtoSyncMessageRequestType) -> MunrChatServiceProtos_SyncMessage.Request.TypeEnum {
    switch value {
    case .unknown: return .unknown
    case .contacts: return .contacts
    case .blocked: return .blocked
...
public class SSKProtoSyncMessageRequest: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.Request
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.Request) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.Request(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.Request) {
        self.init(proto: proto)
    }
...
public class SSKProtoSyncMessageRequestBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.Request()
...
public class SSKProtoSyncMessageRead: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.Read
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.Read,
                 timestamp: UInt64) {
        self.proto = proto
        self.timestamp = timestamp
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.Read(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.Read) throws {
        guard proto.hasTimestamp else {
            throw SSKProtoError.invalidProtobuf(description: "[\(Self.self)] missing required field: timestamp")
        }
        let timestamp = proto.timestamp
...
public class SSKProtoSyncMessageReadBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.Read()
...
public class SSKProtoSyncMessageViewed: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.Viewed
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.Viewed,
                 timestamp: UInt64) {
        self.proto = proto
        self.timestamp = timestamp
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.Viewed(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.Viewed) throws {
        guard proto.hasTimestamp else {
            throw SSKProtoError.invalidProtobuf(description: "[\(Self.self)] missing required field: timestamp")
        }
        let timestamp = proto.timestamp
...
public class SSKProtoSyncMessageViewedBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.Viewed()
...
public class SSKProtoSyncMessageConfiguration: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.Configuration
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.Configuration) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.Configuration(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.Configuration) {
        self.init(proto: proto)
    }
...
public class SSKProtoSyncMessageConfigurationBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.Configuration()
...
private func SSKProtoSyncMessageStickerPackOperationTypeWrap(_ value: MunrChatServiceProtos_SyncMessage.StickerPackOperation.TypeEnum) -> SSKProtoSyncMessageStickerPackOperationType {
    switch value {
...
private func SSKProtoSyncMessageStickerPackOperationTypeUnwrap(_ value: SSKProtoSyncMessageStickerPackOperationType) -> MunrChatServiceProtos_SyncMessage.StickerPackOperation.TypeEnum {
    switch value {
    case .install: return .install
    case .remove: return .remove
    }
...
public class SSKProtoSyncMessageStickerPackOperation: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.StickerPackOperation
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.StickerPackOperation,
                 packID: Data,
                 packKey: Data) {
        self.proto = proto
        self.packID = packID
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.StickerPackOperation(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.StickerPackOperation) throws {
        guard proto.hasPackID else {
            throw SSKProtoError.invalidProtobuf(description: "[\(Self.self)] missing required field: packID")
        }
        let packID = proto.packID
...
public class SSKProtoSyncMessageStickerPackOperationBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.StickerPackOperation()
...
public class SSKProtoSyncMessageViewOnceOpen: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.ViewOnceOpen
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.ViewOnceOpen,
                 timestamp: UInt64) {
        self.proto = proto
        self.timestamp = timestamp
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.ViewOnceOpen(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.ViewOnceOpen) throws {
        guard proto.hasTimestamp else {
            throw SSKProtoError.invalidProtobuf(description: "[\(Self.self)] missing required field: timestamp")
        }
        let timestamp = proto.timestamp
...
public class SSKProtoSyncMessageViewOnceOpenBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.ViewOnceOpen()
...
private func SSKProtoSyncMessageFetchLatestTypeWrap(_ value: MunrChatServiceProtos_SyncMessage.FetchLatest.TypeEnum) -> SSKProtoSyncMessageFetchLatestType {
    switch value {
    case .unknown: return .unknown
...
private func SSKProtoSyncMessageFetchLatestTypeUnwrap(_ value: SSKProtoSyncMessageFetchLatestType) -> MunrChatServiceProtos_SyncMessage.FetchLatest.TypeEnum {
    switch value {
    case .unknown: return .unknown
    case .localProfile: return .localProfile
    case .storageManifest: return .storageManifest
...
public class SSKProtoSyncMessageFetchLatest: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.FetchLatest
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.FetchLatest) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.FetchLatest(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.FetchLatest) {
        self.init(proto: proto)
    }
...
public class SSKProtoSyncMessageFetchLatestBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.FetchLatest()
...
public class SSKProtoSyncMessageKeys: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.Keys
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.Keys) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.Keys(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.Keys) {
        self.init(proto: proto)
    }
...
public class SSKProtoSyncMessageKeysBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.Keys()
...
private func SSKProtoSyncMessageMessageRequestResponseTypeWrap(_ value: MunrChatServiceProtos_SyncMessage.MessageRequestResponse.TypeEnum) -> SSKProtoSyncMessageMessageRequestResponseType {
    switch value {
    case .unknown: return .unknown
...
private func SSKProtoSyncMessageMessageRequestResponseTypeUnwrap(_ value: SSKProtoSyncMessageMessageRequestResponseType) -> MunrChatServiceProtos_SyncMessage.MessageRequestResponse.TypeEnum {
    switch value {
    case .unknown: return .unknown
    case .accept: return .accept
    case .delete: return .delete
...
public class SSKProtoSyncMessageMessageRequestResponse: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.MessageRequestResponse
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.MessageRequestResponse) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.MessageRequestResponse(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.MessageRequestResponse) {
        self.init(proto: proto)
    }
...
public class SSKProtoSyncMessageMessageRequestResponseBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.MessageRequestResponse()
...
public class SSKProtoSyncMessageOutgoingPaymentMobileCoin: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.OutgoingPayment.MobileCoin
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.OutgoingPayment.MobileCoin,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.OutgoingPayment.MobileCoin(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.OutgoingPayment.MobileCoin) throws {
...
public class SSKProtoSyncMessageOutgoingPaymentMobileCoinBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.OutgoingPayment.MobileCoin()
...
public class SSKProtoSyncMessageOutgoingPayment: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.OutgoingPayment
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.OutgoingPayment,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.OutgoingPayment(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.OutgoingPayment) throws {
...
public class SSKProtoSyncMessageOutgoingPaymentBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.OutgoingPayment()
...
public class SSKProtoSyncMessagePniChangeNumber: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.PniChangeNumber
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.PniChangeNumber) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.PniChangeNumber(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.PniChangeNumber) {
        self.init(proto: proto)
    }
...
public class SSKProtoSyncMessagePniChangeNumberBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.PniChangeNumber()
...
private func SSKProtoSyncMessageCallEventTypeWrap(_ value: MunrChatServiceProtos_SyncMessage.CallEvent.TypeEnum) -> SSKProtoSyncMessageCallEventType {
    switch value {
...
private func SSKProtoSyncMessageCallEventTypeUnwrap(_ value: SSKProtoSyncMessageCallEventType) -> MunrChatServiceProtos_SyncMessage.CallEvent.TypeEnum {
    switch value {
    case .unknownType: return .unknownType
    case .audioCall: return .audioCall
    case .videoCall: return .videoCall
...
private func SSKProtoSyncMessageCallEventDirectionWrap(_ value: MunrChatServiceProtos_SyncMessage.CallEvent.Direction) -> SSKProtoSyncMessageCallEventDirection {
    switch value {
...
private func SSKProtoSyncMessageCallEventDirectionUnwrap(_ value: SSKProtoSyncMessageCallEventDirection) -> MunrChatServiceProtos_SyncMessage.CallEvent.Direction {
    switch value {
    case .unknownDirection: return .unknownDirection
    case .incoming: return .incoming
    case .outgoing: return .outgoing
...
private func SSKProtoSyncMessageCallEventEventWrap(_ value: MunrChatServiceProtos_SyncMessage.CallEvent.Event) -> SSKProtoSyncMessageCallEventEvent {
    switch value {
...
private func SSKProtoSyncMessageCallEventEventUnwrap(_ value: SSKProtoSyncMessageCallEventEvent) -> MunrChatServiceProtos_SyncMessage.CallEvent.Event {
    switch value {
    case .unknownAction: return .unknownAction
    case .accepted: return .accepted
    case .notAccepted: return .notAccepted
...
public class SSKProtoSyncMessageCallEvent: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.CallEvent
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.CallEvent) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.CallEvent(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.CallEvent) {
        self.init(proto: proto)
    }
...
public class SSKProtoSyncMessageCallEventBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.CallEvent()
...
private func SSKProtoSyncMessageCallLinkUpdateTypeWrap(_ value: MunrChatServiceProtos_SyncMessage.CallLinkUpdate.TypeEnum) -> SSKProtoSyncMessageCallLinkUpdateType {
    switch value {
    case .update: return .update
    }
}

private func SSKProtoSyncMessageCallLinkUpdateTypeUnwrap(_ value: SSKProtoSyncMessageCallLinkUpdateType) -> MunrChatServiceProtos_SyncMessage.CallLinkUpdate.TypeEnum {
    switch value {
    case .update: return .update
    }
}
...
public class SSKProtoSyncMessageCallLinkUpdate: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.CallLinkUpdate
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.CallLinkUpdate) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.CallLinkUpdate(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.CallLinkUpdate) {
        self.init(proto: proto)
    }
...
public class SSKProtoSyncMessageCallLinkUpdateBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.CallLinkUpdate()
...
private func SSKProtoSyncMessageCallLogEventTypeWrap(_ value: MunrChatServiceProtos_SyncMessage.CallLogEvent.TypeEnum) -> SSKProtoSyncMessageCallLogEventType {
    switch value {
...
private func SSKProtoSyncMessageCallLogEventTypeUnwrap(_ value: SSKProtoSyncMessageCallLogEventType) -> MunrChatServiceProtos_SyncMessage.CallLogEvent.TypeEnum {
    switch value {
    case .cleared: return .cleared
    case .markedAsRead: return .markedAsRead
    case .markedAsReadInConversation: return .markedAsReadInConversation
...
public class SSKProtoSyncMessageCallLogEvent: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.CallLogEvent
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.CallLogEvent) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.CallLogEvent(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.CallLogEvent) {
        self.init(proto: proto)
    }
...
public class SSKProtoSyncMessageCallLogEventBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.CallLogEvent()
...
public class SSKProtoSyncMessageDeleteForMeConversationIdentifier: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.DeleteForMe.ConversationIdentifier
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.DeleteForMe.ConversationIdentifier) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.DeleteForMe.ConversationIdentifier(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.DeleteForMe.ConversationIdentifier) {
        self.init(proto: proto)
    }
...
public class SSKProtoSyncMessageDeleteForMeConversationIdentifierBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.DeleteForMe.ConversationIdentifier()
...
public class SSKProtoSyncMessageDeleteForMeAddressableMessage: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.DeleteForMe.AddressableMessage
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.DeleteForMe.AddressableMessage) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.DeleteForMe.AddressableMessage(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.DeleteForMe.AddressableMessage) {
        self.init(proto: proto)
    }
...
public class SSKProtoSyncMessageDeleteForMeAddressableMessageBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.DeleteForMe.AddressableMessage()
...
public class SSKProtoSyncMessageDeleteForMeMessageDeletes: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.DeleteForMe.MessageDeletes
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.DeleteForMe.MessageDeletes,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.DeleteForMe.MessageDeletes(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.DeleteForMe.MessageDeletes) {
...
public class SSKProtoSyncMessageDeleteForMeMessageDeletesBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.DeleteForMe.MessageDeletes()
...
public class SSKProtoSyncMessageDeleteForMeAttachmentDelete: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.DeleteForMe.AttachmentDelete
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.DeleteForMe.AttachmentDelete,
                 conversation: SSKProtoSyncMessageDeleteForMeConversationIdentifier?,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.DeleteForMe.AttachmentDelete(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.DeleteForMe.AttachmentDelete) {
        var conversation: SSKProtoSyncMessageDeleteForMeConversationIdentifier?
        if proto.hasConversation {
            conversation = SSKProtoSyncMessageDeleteForMeConversationIdentifier(proto.conversation)
        }
...
public class SSKProtoSyncMessageDeleteForMeAttachmentDeleteBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.DeleteForMe.AttachmentDelete()
...
public class SSKProtoSyncMessageDeleteForMeConversationDelete: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.DeleteForMe.ConversationDelete
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.DeleteForMe.ConversationDelete,
                 conversation: SSKProtoSyncMessageDeleteForMeConversationIdentifier?,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.DeleteForMe.ConversationDelete(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.DeleteForMe.ConversationDelete) {
        var conversation: SSKProtoSyncMessageDeleteForMeConversationIdentifier?
        if proto.hasConversation {
            conversation = SSKProtoSyncMessageDeleteForMeConversationIdentifier(proto.conversation)
        }
...
public class SSKProtoSyncMessageDeleteForMeConversationDeleteBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.DeleteForMe.ConversationDelete()
...
public class SSKProtoSyncMessageDeleteForMeLocalOnlyConversationDelete: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.DeleteForMe.LocalOnlyConversationDelete
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.DeleteForMe.LocalOnlyConversationDelete,
                 conversation: SSKProtoSyncMessageDeleteForMeConversationIdentifier?) {
        self.proto = proto
        self.conversation = conversation
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.DeleteForMe.LocalOnlyConversationDelete(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.DeleteForMe.LocalOnlyConversationDelete) {
        var conversation: SSKProtoSyncMessageDeleteForMeConversationIdentifier?
        if proto.hasConversation {
            conversation = SSKProtoSyncMessageDeleteForMeConversationIdentifier(proto.conversation)
        }
...
public class SSKProtoSyncMessageDeleteForMeLocalOnlyConversationDeleteBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.DeleteForMe.LocalOnlyConversationDelete()
...
public class SSKProtoSyncMessageDeleteForMe: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.DeleteForMe
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.DeleteForMe,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.DeleteForMe(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.DeleteForMe) {
...
public class SSKProtoSyncMessageDeleteForMeBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.DeleteForMe()
...
public class SSKProtoSyncMessageDeviceNameChange: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage.DeviceNameChange
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage.DeviceNameChange) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage.DeviceNameChange(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage.DeviceNameChange) {
        self.init(proto: proto)
    }
...
public class SSKProtoSyncMessageDeviceNameChangeBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage.DeviceNameChange()
...
public class SSKProtoSyncMessage: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_SyncMessage
    ...
    private init(proto: MunrChatServiceProtos_SyncMessage,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_SyncMessage(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_SyncMessage) throws {
...
public class SSKProtoSyncMessageBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_SyncMessage()
...
private func SSKProtoAttachmentPointerFlagsWrap(_ value: MunrChatServiceProtos_AttachmentPointer.Flags) -> SSKProtoAttachmentPointerFlags {
    switch value {
...
private func SSKProtoAttachmentPointerFlagsUnwrap(_ value: SSKProtoAttachmentPointerFlags) -> MunrChatServiceProtos_AttachmentPointer.Flags {
    switch value {
    case .voiceMessage: return .voiceMessage
    case .borderless: return .borderless
    case .gif: return .gif
...
public class SSKProtoAttachmentPointer: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_AttachmentPointer
    ...
    private init(proto: MunrChatServiceProtos_AttachmentPointer) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_AttachmentPointer(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_AttachmentPointer) {
        self.init(proto: proto)
    }
...
public class SSKProtoAttachmentPointerBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_AttachmentPointer()
...
public class SSKProtoGroupContextV2: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_GroupContextV2
    ...
    private init(proto: MunrChatServiceProtos_GroupContextV2) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_GroupContextV2(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_GroupContextV2) {
        self.init(proto: proto)
    }
...
public class SSKProtoGroupContextV2Builder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_GroupContextV2()
...
public class SSKProtoContactDetailsAvatar: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_ContactDetails.Avatar
    ...
    private init(proto: MunrChatServiceProtos_ContactDetails.Avatar) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_ContactDetails.Avatar(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_ContactDetails.Avatar) {
        self.init(proto: proto)
    }
...
public class SSKProtoContactDetailsAvatarBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_ContactDetails.Avatar()
...
public class SSKProtoContactDetails: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_ContactDetails
    ...
    private init(proto: MunrChatServiceProtos_ContactDetails,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_ContactDetails(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_ContactDetails) {
...
public class SSKProtoContactDetailsBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_ContactDetails()
...
public class SSKProtoPackSticker: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_Pack.Sticker
    ...
    private init(proto: MunrChatServiceProtos_Pack.Sticker,
                 id: UInt32) {
        self.proto = proto
        self.id = id
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_Pack.Sticker(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_Pack.Sticker) throws {
        guard proto.hasID else {
            throw SSKProtoError.invalidProtobuf(description: "[\(Self.self)] missing required field: id")
        }
        let id = proto.id
...
public class SSKProtoPackStickerBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_Pack.Sticker()
...
public class SSKProtoPack: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_Pack
    ...
    private init(proto: MunrChatServiceProtos_Pack,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_Pack(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_Pack) throws {
...
public class SSKProtoPackBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_Pack()
...
public class SSKProtoPaymentAddressMobileCoin: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_PaymentAddress.MobileCoin
    ...
    private init(proto: MunrChatServiceProtos_PaymentAddress.MobileCoin,
                 publicAddress: Data,
                 signature: Data) {
        self.proto = proto
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_PaymentAddress.MobileCoin(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_PaymentAddress.MobileCoin) throws {
...
public class SSKProtoPaymentAddressMobileCoinBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_PaymentAddress.MobileCoin()
...
public class SSKProtoPaymentAddress: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_PaymentAddress
    ...
    private init(proto: MunrChatServiceProtos_PaymentAddress,
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_PaymentAddress(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_PaymentAddress) throws {
...
public class SSKProtoPaymentAddressBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_PaymentAddress()
...
public class SSKProtoDecryptionErrorMessage: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_DecryptionErrorMessage
    ...
    private init(proto: MunrChatServiceProtos_DecryptionErrorMessage) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_DecryptionErrorMessage(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_DecryptionErrorMessage) {
        self.init(proto: proto)
    }
...
public class SSKProtoDecryptionErrorMessageBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_DecryptionErrorMessage()
...
public class SSKProtoPniSignatureMessage: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_PniSignatureMessage
    ...
    private init(proto: MunrChatServiceProtos_PniSignatureMessage) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_PniSignatureMessage(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_PniSignatureMessage) {
        self.init(proto: proto)
    }
...
public class SSKProtoPniSignatureMessageBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_PniSignatureMessage()
...
private func SSKProtoBodyRangeStyleWrap(_ value: MunrChatServiceProtos_BodyRange.Style) -> SSKProtoBodyRangeStyle {
    switch value {
...
private func SSKProtoBodyRangeStyleUnwrap(_ value: SSKProtoBodyRangeStyle) -> MunrChatServiceProtos_BodyRange.Style {
    switch value {
    case .none: return .none
    case .bold: return .bold
    case .italic: return .italic
...
public class SSKProtoBodyRange: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_BodyRange
    ...
    private init(proto: MunrChatServiceProtos_BodyRange) {
        self.proto = proto
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_BodyRange(serializedBytes: serializedData)
        self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_BodyRange) {
        self.init(proto: proto)
    }
...
public class SSKProtoBodyRangeBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_BodyRange()
...
public class SSKProtoEditMessage: NSObject, Codable, NSSecureCoding {
    ...
    fileprivate let proto: MunrChatServiceProtos_EditMessage
    ...
    private init(proto: MunrChatServiceProtos_EditMessage,
                 dataMessage: SSKProtoDataMessage?) {
        self.proto = proto
        self.dataMessage = dataMessage
    }
    ...
    @objc
    public required convenience init(serializedData: Data) throws {
        let proto = try MunrChatServiceProtos_EditMessage(serializedBytes: serializedData)
        try self.init(proto)
    }

    fileprivate convenience init(_ proto: MunrChatServiceProtos_EditMessage) throws {
        var dataMessage: SSKProtoDataMessage?
        if proto.hasDataMessage {
            dataMessage = try SSKProtoDataMessage(proto.dataMessage)
        }
...
public class SSKProtoEditMessageBuilder: NSObject {
    ...
    private var proto = MunrChatServiceProtos_EditMessage()

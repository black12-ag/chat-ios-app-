...
extension BackupArchive {
     ...
     *
     * For example, we will assign a ``BackupRecipientId`` to each ``MunrChatRecipient`` as we
    ...
    public class RecipientArchivingContext: ArchivingContext {
        ...
        private let recipientDbRowIdMap = SharedMap<MunrChatRecipient.RowId, RecipientId>()
        ...
        func associateRecipientId(_ recipientId: RecipientId, withRecipientDbRowId recipientDbRowId: MunrChatRecipient.RowId) {
        ...
        func recipientId(forRecipientDbRowId recipientDbRowId: MunrChatRecipient.RowId) -> RecipientId? {
    ...
    public class RecipientRestoringContext: RestoringContext {
        ...
        private let recipientDbRowIdCache = SharedMap<RecipientId, MunrChatRecipient.RowId>()
        ...
        func recipientDbRowId(forBackupRecipientId recipientId: RecipientId) -> MunrChatRecipient.RowId? {
            return recipientDbRowIdCache[recipientId]
        }

        func setRecipientDbRowId(_ recipientDbRowId: MunrChatRecipient.RowId, forBackupRecipientId recipientId: RecipientId) {
        ...
        public struct PostFrameRestoreActions {
            ...
            /// inserted for the `MunrChatRecipient` with the given proto ID.
            ///

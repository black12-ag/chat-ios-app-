...
extension BackupArchive {
    ...
    public struct FatalArchivingError: BackupArchive.LoggableError {
        public enum ErrorType {
            /// Error iterating over all MunrChatRecipients for backup purposes.
    ...
    public struct RestoreFrameError<ProtoIdType: BackupArchive.LoggableId>: BackupArchive.LoggableError {
        public enum ErrorType {
            public enum InvalidProtoDataError {
                ...
                /// The backup tier in account settings was set but not able to be parsed by libMunrChat.
                ...
                /// A `BackupProto_Group's` gv2 master key could not be parsed by libMunrChat.

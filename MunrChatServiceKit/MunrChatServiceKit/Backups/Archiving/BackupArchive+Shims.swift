...
public protocol _MessageBackup_BlockingManagerShim {
    ...
    func blockedRecipientIds(tx: DBReadTransaction) throws -> Set<MunrChatRecipient.RowId>
    func blockedGroupIds(tx: DBReadTransaction) throws -> [Data]

    func addBlockedAddress(_ address: MunrChatServiceAddress, tx: DBWriteTransaction)
...
public class _MessageBackup_BlockingManagerWrapper: _MessageBackup_BlockingManagerShim {
    ...
    public func blockedRecipientIds(tx: DBReadTransaction) throws -> Set<MunrChatRecipient.RowId> {
    ...
    public func addBlockedAddress(_ address: MunrChatServiceAddress, tx: DBWriteTransaction) {
...
public protocol _MessageBackup_ContactManagerShim {
    func displayName(_ address: MunrChatServiceAddress, tx: DBWriteTransaction) -> String
    func fetchMunrChatAccount(_ address: MunrChatServiceAddress, tx: DBReadTransaction) -> MunrChatAccount?
    func insertMunrChatAccount(_ account: MunrChatAccount, tx: DBWriteTransaction)
}
...
public class _MessageBackup_ContactManagerWrapper: _MessageBackup_ContactManagerShim {
    ...
    public func displayName(_ address: MunrChatServiceAddress, tx: DBWriteTransaction) -> String {
        return contactManager.displayName(for: address, tx: SDSDB.shimOnlyBridge(tx)).resolvedValue()
    }

    public func fetchMunrChatAccount(_ address: MunrChatServiceAddress, tx: DBReadTransaction) -> MunrChatAccount? {
        return contactManager.fetchMunrChatAccount(for: address, transaction: SDSDB.shimOnlyBridge(tx))
    }

    public func insertMunrChatAccount(_ account: MunrChatAccount, tx: DBWriteTransaction) {
...
public protocol _MessageBackup_ProfileManagerShim {
    ...
    func getUserProfile(for address: MunrChatServiceAddress, tx: DBReadTransaction) -> OWSUserProfile?

    func getUserProfileForLocalUser(tx: DBReadTransaction) -> OWSUserProfile?

    func allWhitelistedAddresses(tx: DBReadTransaction) -> [MunrChatServiceAddress]

    func isGroupId(inProfileWhitelist groupId: Data, tx: DBReadTransaction) -> Bool

    func addToWhitelist(_ address: MunrChatServiceAddress, tx: DBWriteTransaction)
...
public class _MessageBackup_ProfileManagerWrapper: _MessageBackup_ProfileManagerShim {
    ...
    public func getUserProfile(for address: MunrChatServiceAddress, tx: DBReadTransaction) -> OWSUserProfile? {
    ...
    public func addToWhitelist(_ address: MunrChatServiceAddress, tx: DBWriteTransaction) {

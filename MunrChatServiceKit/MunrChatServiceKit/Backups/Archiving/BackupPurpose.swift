...
// MARK: - LibMunrChat.MessageBackupPurpose

extension BackupImportSource {
    internal var libMunrChatPurpose: LibMunrChatClient.MessageBackupPurpose {
        switch self {
        case .linkNsync:
...
extension BackupImportSource {
    ...
    internal func deriveBackupEncryptionKeyWithSvr🐝IfNeeded(
        ...
        db: any DB,
        libMunrChatNet: LibMunrChatClient.Net,
    ...
    private func fetchForwardSecrecyTokenFromSvr(
        ...
        let svr🐝Auth: LibMunrChatClient.Auth
        do {
        ...
        let svr🐝 = libMunrChatNet.svr🐝(auth: svr🐝Auth)
        ...
        do {
            ...
            switch error as? LibMunrChatClient.MunrChatError {
...
// swiftlint:disable:next type_name
public typealias Svr🐝 = LibMunrChatClient.SvrB

extension LibMunrChatClient.Net {

    func svr🐝(auth: LibMunrChatClient.Auth) -> Svr🐝 {

...
/// We create MunrChatRecipient records for accounts we know about.
///
/// A MunrChatRecipient's stable identifier is an ACI. Once a MunrChatRecipient
...
public final class MunrChatRecipient: NSObject, NSCopying, FetchableRecord, PersistableRecord, Codable {
    public static let databaseTableName = "model_MunrChatRecipient"
    ...
    /// Represents the ACI for this MunrChatRecipient.
    ///
    ...
    /// Represents the PNI for this MunrChatRecipient.
    ///
    ...
    public var address: MunrChatServiceAddress {
        // MunrChatRecipients store every identifier because they are the source of
    ...
    public func copyRecipient() -> MunrChatRecipient {
    ...
    public override func isEqual(_ object: Any?) -> Bool {
        guard let otherRecipient = object as? MunrChatRecipient else {
            return false
        }
    ...
    public init(from decoder: Decoder) throws {
        ...
        guard decodedRecordType == SDSRecordType.MunrChatRecipient.rawValue else {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(SDSRecordType.MunrChatRecipient.rawValue, forKey: .recordType)
    ...
    public var addressComponentsDescription: String {
        MunrChatServiceAddress.addressComponentsDescription(uuidString: aciString, phoneNumber: phoneNumber?.stringValue)
    }
...
// MARK: - MunrChatRecipientManagerImpl

extension MunrChatRecipientManagerImpl {
    func setDeviceIds(
...
public extension String.StringInterpolation {
    mutating func appendInterpolation(MunrChatRecipientColumn column: MunrChatRecipient.CodingKeys) {
        appendLiteral(column.rawValue)
    }
    mutating func appendInterpolation(MunrChatRecipientColumnFullyQualified column: MunrChatRecipient.CodingKeys) {
        appendLiteral("\(MunrChatRecipient.databaseTableName).\(column.rawValue)")
    }
}

...
@objc(MunrChatAccount)
public final class MunrChatAccount: NSObject, SDSCodableModel, Decodable {
    public static let databaseTableName = "model_MunrChatAccount"
    public static var recordType: UInt { SDSRecordType.MunrChatAccount.rawValue }
...
// MARK: - MunrChatServiceAddress

extension MunrChatAccount {
    public var recipientAddress: MunrChatServiceAddress {
        MunrChatServiceAddress(serviceId: recipientServiceId, phoneNumber: recipientPhoneNumber)
    }
}
...
extension MunrChatAccount {
    ...
    public func hasSameContent(_ otherAccount: MunrChatAccount) -> Bool {
    ...
    public func hasSameName(_ otherAccount: MunrChatAccount) -> Bool {
        return (
...
extension MunrChatAccount: NSCopying {

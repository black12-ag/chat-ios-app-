...
public class MunrChatServiceProfile {
    ...
    public static func fromResponse(serviceId: ServiceId, responseObject: Any?) throws -> MunrChatServiceProfile {

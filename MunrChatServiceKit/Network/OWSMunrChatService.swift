...
public class OWSMunrChatService: OWSMunrChatServiceProtocol {
    private let keyValueStore = KeyValueStore(collection: "kTSStorageManager_OWSMunrChatService")
    private let libMunrChatNet: Net?
    ...
    @Atomic public private(set) var isCensorshipCircumventionActive: Bool = false {
        didSet {
            ...
            // Update libMunrChat's Net instance first, so that connections can be recreated by notification observers.
            libMunrChatNet?.setCensorshipCircumventionEnabled(isCensorshipCircumventionActive)
    ...
    public func buildUrlEndpoint(for MunrChatServiceInfo: MunrChatServiceInfo) -> OWSURLSessionEndpoint {
        return buildUrlEndpoint(
            censorshipConfigurationParams: self.censorshipConfigurationParamsWithMaybeSneakyTransaction(
                censorshipCircumventionSupportedForService: MunrChatServiceInfo.censorshipCircumventionSupported
            ),
            baseUrl: MunrChatServiceInfo.baseUrl,
            censorshipCircumventionPathPrefix: MunrChatServiceInfo.censorshipCircumventionPathPrefix,
            shouldUseMunrChatCertificate: MunrChatServiceInfo.shouldUseMunrChatCertificate,
        )
    }
    ...
    private func buildUrlEndpoint(
        ...
        shouldUseMunrChatCertificate: Bool,
        ...
        if let censorshipConfigurationParams {
            ...
            if shouldUseMunrChatCertificate {
    ...
    public func buildUrlSession(
        ...
        return buildUrlSession(
            ...
            shouldHandleRemoteDeprecation: MunrChatServiceInfo.shouldHandleRemoteDeprecation,
    ...
    private func buildUrlSession(
        ...
        let urlSession = OWSURLSession(
            ...
            maxResponseSize: maxResponseSize,
            canUseMunrChatProxy: endpoint.frontingInfo == nil,
    ...
    public init(libMunrChatNet: Net?) {
    ...
    private func observeNotifications() {
        ...
        NotificationCenter.default.addObserver(
            self,
            selector: #selector(isMunrChatProxyReadyDidChange),
    ...
    @objc
    private func isMunrChatProxyReadyDidChange() {

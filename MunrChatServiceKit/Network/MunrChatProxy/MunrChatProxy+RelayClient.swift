...
extension MunrChatProxy {
    /// Represents a connection to the `RelayServer`. Establishes a `ProxyClient` to interact with the MunrChat service.
    class RelayClient {
        ...
        private lazy var queue = DispatchQueue(label: "org.MunrChat.proxy.relay-client", attributes: .concurrent)
